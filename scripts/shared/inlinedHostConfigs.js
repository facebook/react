...
module.exports = [
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom-rspack/static',
      'react-server-dom-rspack/static.node',
      'react-server-dom-rspack/src/client/ReactFlightDOMClientEdge.js', // react-server-dom-rspack/client.node
      'react-server-dom-rspack/src/client/ReactFlightDOMClientNode.js', // react-server-dom-rspack/client.node
      'react-server-dom-rspack/src/client/ReactFlightClientConfigBundlerRspack.js',
      'react-server-dom-rspack/src/client/ReactFlightClientConfigBundlerRspackServer.js',
      'react-server-dom-rspack/src/client/react-flight-dom-client.node',
      'react-server-dom-rspack/src/server/react-flight-dom-server.node',
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom-rspack/server.browser',
      'react-server-dom-rspack/static.browser',
      'react-server-dom-rspack/src/client/ReactFlightDOMClientBrowser.js', // react-server-dom-rspack/client.browser
      'react-server-dom-rspack/src/client/ReactFlightClientConfigBundlerRspack.js',
      'react-server-dom-rspack/src/client/ReactFlightClientConfigBundlerRspackBrowser.js',
      'react-server-dom-rspack/src/client/react-flight-dom-client.browser',
      'react-server-dom-rspack/src/server/react-flight-dom-server.browser',
      'react-server-dom-rspack/src/server/ReactFlightDOMServerBrowser.js', // react-server-dom-rspack/src/server/react-flight-dom-server.browser
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom-rspack/static.edge',
      'react-server-dom-rspack/src/client/ReactFlightDOMClientEdge.js', // react-server-dom-rspack/client.edge
      'react-server-dom-rspack/src/client/ReactFlightClientConfigBundlerRspack.js',
      'react-server-dom-rspack/src/client/ReactFlightClientConfigBundlerRspackServer.js',
      'react-server-dom-rspack/src/client/react-flight-dom-client.edge',
      'react-server-dom-rspack/src/server/react-flight-dom-server.edge',
      'react-server-dom-rspack/src/server/ReactFlightDOMServerEdge.js', // react-server-dom-rspack/src/server/react-flight-dom-server.edge
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',

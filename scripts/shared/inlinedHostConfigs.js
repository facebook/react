...
module.exports = [
  ...
  },
  {
    ...
    entryPoints: [
      ...
      'react-server-dom-vite/src/server/react-flight-dom-server.node',
    ],
    paths: [
      'react-dom',
      'react-dom-bindings',
      ...
      'react-server-dom-vite/static',
      'react-server-dom-vite/static.node',
      'react-server-dom-vite/src/client/ReactFlightDOMClientNode.js', // react-server-dom-vite/client.node
      'react-server-dom-vite/src/client/ReactFlightClientConfigBundlerVite.js',
      'react-server-dom-vite/src/server/react-flight-dom-server.node',
      'react-server-dom-vite/src/server/ReactFlightDOMServerNode.js', // react-server-dom-vite/src/server/react-flight-dom-server.node
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',
  ...
  },
  {
    ...
    entryPoints: [
      ...
      'react-server-dom-vite/src/server/react-flight-dom-server.browser',
    ],
    paths: [
      'react-dom',
      'react-dom/client',
      ...
      'react-server-dom-vite/static.browser',
      'react-server-dom-vite/src/client/ReactFlightDOMClientBrowser.js', // react-server-dom-vite/client.browser
      'react-server-dom-vite/src/client/ReactFlightClientConfigBundlerVite.js',
      'react-server-dom-vite/src/server/react-flight-dom-server.browser',
      'react-server-dom-vite/src/server/ReactFlightDOMServerBrowser.js', // react-server-dom-vite/src/server/react-flight-dom-server.browser
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',
  ...
  },
  {
    ...
    entryPoints: [
      ...
      'react-server-dom-vite/src/server/react-flight-dom-server.edge',
    ],
    paths: [
      'react-dom',
      'react-dom/src/ReactDOMReactServer.js',
      ...
      'react-server-dom-vite/static.edge',
      'react-server-dom-vite/src/client/ReactFlightDOMClientEdge.js', // react-server-dom-vite/client.edge
      'react-server-dom-vite/src/client/ReactFlightClientConfigBundlerVite.js',
      'react-server-dom-vite/src/server/react-flight-dom-server.edge',
      'react-server-dom-vite/src/server/ReactFlightDOMServerEdge.js', // react-server-dom-vite/src/server/react-flight-dom-server.edge
      'react-devtools',
      'react-devtools-core',
      'react-devtools-shell',
      'react-devtools-shared',

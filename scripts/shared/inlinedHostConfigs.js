...
module.exports = [
  {
    ...
    paths: [
      ...
      'react-server-dom/',
      'react-server-dom/src/ReactFlightDOMClientNodeStreams.js',
      'react-server-dom/src/ReactFlightDOMServerNodeStreams.js',
      ...
      'react-server-dom-webpack/server.node',
      'react-server-dom-webpack/server.node.unbundled',
      'react-server-dom-webpack/src/ReactFlightDOMClientNode.js', // react-server-dom-webpack/client.node and // react-server-dom-webpack/client.node.unbundled
      'react-server-dom-webpack/src/ReactFlightDOMServerNode.js', // react-server-dom-webpack/server.node and // react-server-dom-webpack/server.node.unbundled
    ...
    bundlers: ['webpack', 'webpack-node', 'esm'],
    isFlowTyped: true,
  ...
  },
  {
    ...
    paths: [
      ...
      'react-server-dom/',
      'react-server-dom/src/ReactFlightDOMClientWebStreams.js',
      'react-server-dom/src/ReactFlightDOMServerWebStreams.js',
      'react-server-dom-webpack/',

  ...
  var ResponsiveBlock37 = function(props) {
    if (props.x === 62) {
      return React.createElement(
        ...
        [
          React.createElement(AdsErrorBoundary10, {x: 58}),
          React.createElement(AdsErrorBoundary10, {x: 61}),
        ],
        React.createElement(
          'div',
  ...
  var AdsLabeledField104 = function(props) {
    ...
    if (props.x === 240) {
      return React.createElement(
        ...
        {
          className: '_2oc6 _3bvz',
          helpText: "Set an overall spending limit for your ad campaign. This means your ad sets in the campaign will stop once you've reached your spending limit.",

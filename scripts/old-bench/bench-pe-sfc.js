(function() {
  var ReactImage0 = function(props) {
    ...
    if (props.x === 70) {
      return (
        <i src={null} alt={''} className={'img sp_i534r85sjIn sx_29f8c9'} />
      );
    }
    if (props.x === 76) {
      return (
    ...
    if (props.x === 79) {
      return (
        <i src={null} alt={''} className={'img sp_i534r85sjIn sx_6f8c43'} />
      );
    }
    if (props.x === 88) {
      return (
    ...
    if (props.x === 186) {
      return (
        <i src={null} alt={''} className={'img sp_i534r85sjIn sx_0a681f'} />
      );
    }
    if (props.x === 195) {
      return (
  ...
  var AbstractLink1 = function(props) {
    ...
    if (props.x === 207) {
      return (
        <a href={'#'} rel={undefined} onClick={function() {}}>
          {'Create Ad Set'}
        </a>
      );
    }
  ...
  var XUIText29 = function(props) {
    ...
    if (props.x === 205) {
      return (
        <span className={'_2x9f  _50f5 _50f7'} display={'inline'}>
          {'Editing Campaign'}
        </span>
      );
    }
    if (props.x === 206) {
      return (
        <span display={'inline'} className={' _50f5 _50f7'}>
          {'Test Campaign'}
        </span>
      );
    }
    ...
    if (props.x === 62) {
      return (
        <div onResize={function() {}} className={'_4u-c'}>
          {[<AdsErrorBoundary10 x={58} />, <AdsErrorBoundary10 x={61} />]}
  ...
  var FluxContainer_AdsPEEditToolbarButtonContainer_43 = function(props) {
    if (props.x === 87) {
      return (
        <FluxContainer_AdsPEEditCampaignGroupToolbarButtonContainer_42 x={86} />
      );
    }
  };
  ...
  var AdsCampaignGroupNameSectionContainer97 = function(props) {
    if (props.x === 224) {
      return (
        <AdsEditorNameSection96 x={223} key={'nameSection98010048849317'} />
      );
    }
  };
  ...
  var _render113 = function(props) {
    if (props.x === 257) {
      return (
        <FluxContainer_AdsEditorToplineDetailsSectionContainer_112 x={256} />
      );
    }
  };
  ...
  var AdsPETableHeader141 = function(props) {
    ...
    if (props.x === 329) {
      return <div className={'_1cig _1vd7 _4h2r'} id={undefined} />;
    }
    if (props.x === 340) {
      return (
    ...
    if (props.x === 452) {
      return <div className={'_1cig _25fg _4h2r'} id={undefined} />;
    }
  };
    ...
    if (props.x === 360) {
      return (
        <div
          ...
          label={'Status'}
          width={60}
          dataKey={'campaignGroup.status'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'campaignGroup.status'}
          height={25}
    ...
    if (props.x === 365) {
      return (
        <div
          ...
          label={'Delivery'}
          width={150}
          dataKey={'derivedCampaignGroup.activity_status'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'derivedCampaignGroup.activity_status'}
          height={25}
    ...
    if (props.x === 422) {
      return (
        <div
          ...
          label={'Buying Type'}
          width={100}
          dataKey={'campaignGroup.buying_type'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'campaignGroup.buying_type'}
          height={25}
    ...
    if (props.x === 427) {
      return (
        <div
          ...
          label={'Campaign ID'}
          width={120}
          dataKey={'campaignGroup.id'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'campaignGroup.id'}
          height={25}
    ...
    if (props.x === 432) {
      return (
        <div
          ...
          label={'Start'}
          width={113}
          dataKey={'derivedCampaignGroup.startDate'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'derivedCampaignGroup.startDate'}
          height={25}
    ...
    if (props.x === 437) {
      return (
        <div
          ...
          label={'End'}
          width={113}
          dataKey={'derivedCampaignGroup.stopDate'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'derivedCampaignGroup.stopDate'}
          height={25}
          style={{height: 25, width: 113}}>
          <div className={'_4lgd _4h2w'}>
            <div className={'_4lge _4h2x'}>
    ...
    if (props.x === 442) {
      return (
        <div
          ...
          label={'Date created'}
          width={113}
          dataKey={'derivedCampaignGroup.createdDate'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'derivedCampaignGroup.createdDate'}
          height={25}
          style={{height: 25, width: 113}}>
          <div className={'_4lgd _4h2w'}>
            <div className={'_4lge _4h2x'}>
    ...
    if (props.x === 447) {
      return (
        <div
          ...
          width={113}
          dataKey={'derivedCampaignGroup.updatedDate'}
          className={'_4lgc _4h2u'}
          columnData={{}}
          cellRenderer={function() {}}
          headerDataGetter={function() {}}
          columnKey={'derivedCampaignGroup.updatedDate'}
          height={25}
          style={{height: 25, width: 113}}>
          <div className={'_4lgd _4h2w'}>
            <div className={'_4lge _4h2x'}>

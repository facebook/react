...
const attributes = [
  ...
  {name: 'glyph-orientation-horizontal', read: getAttribute('glyph-orientation-horizontal')},
  {name: 'glyph-orientation-vertical', read: getAttribute('glyph-orientation-vertical')},
  {name: 'glyphName', read: getAttribute('glyph-name')},
  {name: 'glyphOrientationHorizontal', read: getAttribute('glyph-orientation-horizontal')},
  {name: 'glyphOrientationVertical', read: getAttribute('glyph-orientation-vertical')},
  ...
  {name: 'is', tagName: 'button', overrideStringValue: 'x-test-element', read: getAttribute('is')}, // TODO: This could check if this is an extended custom element but this is a controversial spec.

        ...
        <TestCase title="Video playback">
          ...
          <Fixture>
            <SuspendyTree>
              <video controls>
                <source
                  src={window.matchMedia("(min-width: 1024px)").matches?"http://techslides.com/demos/sample-videos/small.webm" :""}
                  type="video/webm"
                />
                <source
                  src={window.matchMedia("(min-width: 1024px)").matches?"http://techslides.com/demos/sample-videos/small.ogv":""}
                  type="video/ogg"
                />
                <source
                  src={window.matchMedia("(min-width: 1024px)").matches?"http://techslides.com/demos/sample-videos/small.mp4":""}
                  type="video/mp4"
                />
                <source
                  src={window.matchMedia("(min-width: 1024px)").matches?"http://techslides.com/demos/sample-videos/small.3gp":""}
                  type="video/3gp"
                />
              </video>
            </SuspendyTree>

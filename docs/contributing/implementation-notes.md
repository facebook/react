...
It also assumes a grasp on the [difference between React components, their instances, and elements](/react/blog/2015/12/18/react-components-elements-and-instances.html).

...
Here are the slides while we are waiting for the video to be available
...
[Ross Allen](https://twitter.com/ssorallen) working at [Mesosphere](http://mesosphere.io/) combined [Turbolinks](https://github.com/rails/turbolinks/), a framework capable of providing HTML diffs between two requests, and React.
...
[Stoyan Stefanov](http://www.phpied.com/) continues his serie of blog posts about React. This one is an introduction tutorial on rendering a simple table with React.

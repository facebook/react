...
We are organizing a [React Hackathon](http://reactjshack-a-thon.splashthat.com/) in Facebook's Seattle office next Saturday (September 28). If you want to hack on React, meet the team or win some prizes, feel free to join us!

We created an official tag [[reactjs]](http://stackoverflow.com/questions/tagged/reactjs) on [StackOverflow](http://stackoverflow.com/questions/tagged/reactjs). The team is regularly looking at it so feel free to ask questions there.

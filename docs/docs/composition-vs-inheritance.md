...
In this section, we will consider a few examples where developers new to React often reach for inheritance, and show how composition solves the same problem more elegantly.

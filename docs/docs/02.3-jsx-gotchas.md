...
If you want to display an HTML entity within an expression curly brace you'll run into double escaping issues as React escapes all the strings you are displaying in order to prevent a wide range of XSS attacks by default.

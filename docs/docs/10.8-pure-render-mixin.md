...
> Note: React 15.3 added the [React.PureComponent](https://github.com/facebook/react/releases/tag/v15.3.0) base class. This is a more convenient way to implement the behavior below that does not rely upon mixins. React.PureComponent is the recommend approach when working with ES2015 classes.

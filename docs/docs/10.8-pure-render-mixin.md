...
> Note: React 15.3 added the [React.PureComponent](https://github.com/facebook/react/releases/tag/v15.3.0) base class which is a more convenient way to implement the behavior below that does not rely upon mixins.

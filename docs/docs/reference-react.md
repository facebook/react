...
If you're using [React with Add-ons](/react/docs/addons.html), they will be avaible via `React.addons`.
...
`React.addons` exports a range of add-ons when using [React with add-ons](/react/docs/addons.html).

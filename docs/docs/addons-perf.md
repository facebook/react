...
Start/stop the measurement. The React operations in-between are recorded for analysis below. Operations that took an insignificant amount of time are ignored.

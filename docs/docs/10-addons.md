...
- [`ClassNameGenerator`](className-generator.html), generate an object with classNames based on configuration passed to generator. Will generate block and it's child classNames with different modifiers.

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<5c75cfcea4de9ee48118519144fbc2f2>>
 */
      ...
      switch (JSCompiler_inline_result.tag) {
        ...
        case 4:
          var parent$131 = JSCompiler_inline_result.stateNode.containerInfo,
            before$132 = getHostSibling(finishedWork);
  ...
  throw Error(
    'Incompatible React versions: The "react" and "react-native-renderer" packages must have the exact same version. Instead got:\n  - react:                  ' +
      (isomorphicReactPackageVersion +
        "\n  - react-native-renderer:  19.0.0-native-fb-988e2176-20241114\nLearn more: https://react.dev/warnings/version-mismatch")
  );
if (
  "function" !==
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1631 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1631.isDisabled &&
    hook$jscomp$inline_1631.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1631.inject(
        internals$jscomp$inline_1331
      )),
        (injectedHook = hook$jscomp$inline_1631);
    } catch (err) {}
}

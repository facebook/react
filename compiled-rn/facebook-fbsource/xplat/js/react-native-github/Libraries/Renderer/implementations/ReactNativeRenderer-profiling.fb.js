...
function markRootFinished(root, remainingLanes) {
  ...
  for (root = root.hiddenUpdates; 0 < noLongerPendingLanes; ) {
    ...
    var hiddenUpdatesForLane = root[index$9];
    if (null !== hiddenUpdatesForLane)
      for (
        root[index$9] = null, index$9 = 0;
...
function getPublicInstance(instance) {
  return instance.canonical ? instance.canonical : instance;
}
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$30 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      usable = trackUsedThenable(thenableState, usable, index$30);
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$70.lanes | child$70.childLanes),
          (subtreeFlags |= child$70.subtreeFlags & 14680064),
          (subtreeFlags |= child$70.flags & 14680064),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$69.subtreeFlags & 14680064),
          (subtreeFlags |= treeBaseDuration$69.flags & 14680064),
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$115 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$115),
              (errorRetryLanes$115 = didTimeout[errorRetryLanes$115]),
              errorRetryLanes$115 > originallyAttemptedLanes &&
                (originallyAttemptedLanes = errorRetryLanes$115),
              (lanes &= ~errorRetryLanes);
              ...
              case 22:
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (null === offscreenQueue) {
                    ...
                    var wakeables$36 = offscreenQueue.wakeables;
                    null === wakeables$36

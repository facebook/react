 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<b4c03a2b09caffbdd3eb389ecca00c0b>>
 */
...
if ("19.0.0-native-fb-e210d081-20240909" !== isomorphicReactPackageVersion)
  throw Error(
    'Incompatible React versions: The "react" and "react-native-renderer" packages must have the exact same version. Instead got:\n  - react:                  ' +
      (isomorphicReactPackageVersion +
        "\n  - react-native-renderer:  19.0.0-native-fb-e210d081-20240909\nLearn more: https://react.dev/warnings/version-mismatch")
  );
if (
  "function" !==
...
internals$jscomp$inline_1313.getLaneLabelMap = function () {
  for (
...
internals$jscomp$inline_1313.injectProfilingHooks = function (profilingHooks) {
  injectedProfilingHooks = profilingHooks;
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1591 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1591.isDisabled &&
    hook$jscomp$inline_1591.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1591.inject(
        internals$jscomp$inline_1313
      )),
        (injectedHook = hook$jscomp$inline_1591);
    } catch (err) {}
}

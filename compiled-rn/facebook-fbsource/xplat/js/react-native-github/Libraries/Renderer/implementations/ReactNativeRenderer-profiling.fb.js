 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<6112fe4a64cd1a98c2f7c3ec1990268c>>
 */
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$84.lanes | child$84.childLanes),
          (subtreeFlags |= child$84.subtreeFlags & 31457280),
          (subtreeFlags |= child$84.flags & 31457280),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$83.subtreeFlags & 31457280),
          (subtreeFlags |= treeBaseDuration$83.flags & 31457280),
  ...
  if (null !== updateQueue) {
    ...
    do {
      if ((effect.tag & flags) === flags) {
        ...
        var create$110 = effect.create,
          inst = effect.inst;
        create$110 = create$110();
        inst.destroy = create$110;
        0 !== (flags & 8)
          ? null !== injectedProfilingHooks &&
            "function" ===
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1249 = {
    findFiberByHostInstance: getInstanceFromTag,
    bundleType: 0,
    version: "19.0.0-canary-6eafad74",
...
(function (internals) {
  ...
  bundleType: devToolsConfig$jscomp$inline_1249.bundleType,
  version: devToolsConfig$jscomp$inline_1249.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1249.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1249.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1249.findFiberByHostInstance ||
  ...
  reconcilerVersion: "19.0.0-canary-6eafad74"
});

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<8d1678a11f4116c32e35a9231132df18>>
 */
    ...
    extractEvents: function (
      ...
      if (
        ...
        (("topScroll" === topLevelType && !nativeEvent.responderIgnoreScroll) ||
          (0 < trackedTouchCount$1 && "topSelectionChange" === topLevelType) ||
        ...
        if (JSCompiler_temp && JSCompiler_temp !== responderInst)
          if (
            ...
            if (
              ...
              changeResponder$1(JSCompiler_temp, targetInst);
            } else
              (shouldSetEventType = ResponderSyntheticEvent.getPooled(
...
var LegacySyntheticEvent = (function (_Event) {
...
function isEndish(topLevelType) {
  return "topTouchEnd" === topLevelType || "topTouchCancel" === topLevelType;
}
  ...
  if (null != responderFiber) {
    a: {
      for (
        ...
        depthA++;
      tempA = 0;
      for (var tempB = targetFiber; tempB; tempB = getParent(tempB)) tempA++;
      ...
      a: {
        ...
        if (
          ...
          var blockNativeResponder =
            !0 === dispatchResponderEvent(event, "responderGrant", nativeEvent);
          if (null != responderFiber) {
            ...
            dispatchResponderEvent(
              ...
              : dispatchResponderEvent(event, "responderReject", nativeEvent);
        ...
        if (null != responderFiber)
          if (((event = responderFiber), isStartish(topLevelType)))
            ...
            if (
              ...
              dispatchResponderEvent(event, "responderTerminate", nativeEvent),
              ...
              b: {
                if (
                  ...
                  for (
                    ...
                    var target = blockNativeResponder[currentResponder].target;
              ...
              blockNativeResponder &&
                (dispatchResponderEvent(event, "responderRelease", nativeEvent),
                changeResponder(null, !1));
            }
      }
      if (
...
function markRootFinished(
  ...
  for (
    ...
    var index$14 = 31 - clz32(remainingLanes),
      lane = 1 << index$14;
    entanglements[index$14] = 0;
    expirationTimes[index$14] = -1;
    var hiddenUpdatesForLane = hiddenUpdates[index$14];
    if (null !== hiddenUpdatesForLane)
      for (
        hiddenUpdates[index$14] = null, index$14 = 0;
...
function findCurrentFiberUsingSlowPath(fiber) {
  ...
  for (var a = fiber, b = alternate; ; ) {
    ...
    if (a.return !== b.return) (a = parentA), (b = parentB);
      ...
      for (var didFindChild = !1, child$16 = parentA.child; child$16; ) {
        if (child$16 === a) {
          didFindChild = !0;
          a = parentA;
          b = parentB;
        ...
        child$16 = child$16.sibling;
      }
      if (!didFindChild) {
        for (child$16 = parentB.child; child$16; ) {
          if (child$16 === a) {
            didFindChild = !0;
            a = parentB;
            b = parentA;
...
function pushHostContext(fiber) {
  ...
  stateHook !== stateHook &&
    (push(contextFiberStackCursor, fiber), push(contextStackCursor, stateHook));
}
      ...
      if (
        ...
        if (null !== pendingIsomorphicIndicator)
          ...
          try {
            ...
            (syncTransitionLanes.pendingIndicator = noop), reportGlobalError(x);
          }
...
ReactSharedInternals.S = function (transition, returnValue) {
  ...
  if (null !== root) {
    for (var root$23 = firstScheduledRoot; null !== root$23; )
      queueTransitionTypes(root$23, root), (root$23 = root$23.next);
    if (0 !== currentEntangledLane) {
      root$23 = entangledTransitionTypes;
      null === root$23 && (root$23 = entangledTransitionTypes = []);
      for (var i = 0; i < root.length; i++) {
        var transitionType = root[i];
        -1 === root$23.indexOf(transitionType) && root$23.push(transitionType);
      }
    }
  }
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (null !== state$82) {
        ...
        if (state$82 || 0 !== (renderLanes & primaryChildLanes))
  ...
  switch (workInProgress.tag) {
    ...
    case 30:
      return (
        ...
        (elementType = workInProgress.pendingProps),
        null != elementType.name &&
          "auto" !== elementType.name &&
          (workInProgress.flags |= null === current ? 18882560 : 18874368),
        null !== current && current.memoizedProps.name !== elementType.name
          ? (workInProgress.flags |= 4194816)
          : markRef(current, workInProgress),
        reconcileChildren(
          current,
  ...
  if (didBailout)
    for (var child$95 = completedWork.child; null !== child$95; )
      (newChildLanes |= child$95.lanes | child$95.childLanes),
        (subtreeFlags |= child$95.subtreeFlags & 133169152),
        (subtreeFlags |= child$95.flags & 133169152),
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 3:
      ...
      null !== current && (previousCache = current.memoizedState.cache);
      workInProgress.memoizedState.cache !== previousCache &&
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode) {
        previousCache = current.stateNode;
        ...
        if (
          ...
          current &&
            ...
            (newChildSet = passChildrenWhenCloningPersistedNodes
              ? []
              : createChildNodeSet()),
            (renderLanes = appendAllChildrenToContainer(
              newChildSet,
              workInProgress,
              !1,
              !1
          ...
          b: {
            ...
            if (current)
              ...
              newProps = previousCache;
              break b;
            }
            newProps = { node: newProps, canonical: previousCache.canonical };
          }
          newProps === previousCache
            ? (workInProgress.stateNode = previousCache)
            : (markCloned(workInProgress),
              (workInProgress.stateNode = newProps),
              !current ||
                (passChildrenWhenCloningPersistedNodes && !renderLanes) ||
                appendAllChildren(newProps, workInProgress, !1, !1));
        } else workInProgress.stateNode = previousCache;
      } else {
        if (!newProps) {
          if (null === workInProgress.stateNode)
            throw Error(
    ...
    case 6:
      if (current && null != workInProgress.stateNode)
        current.memoizedProps !== newProps
          ? ((current = rootInstanceStackCursor.current),
            (previousCache = contextStackCursor.current),
            markCloned(workInProgress),
    ...
    case 13:
      ...
      if (
        ...
        if (null !== newProps && null !== newProps.dehydrated) {
          ...
          (previousCache = upgradeHydrationErrorsToRecoverable()),
            null !== current &&
              null !== current.memoizedState &&
              (current.memoizedState.hydrationErrors = previousCache),
            (previousCache = !0);
        if (!previousCache) {
          if (workInProgress.flags & 256)
            return popSuspenseHandler(workInProgress), workInProgress;
      ...
      newProps &&
        ((previousCache = workInProgress.child),
        (renderLanes = null),
        null !== previousCache.alternate &&
          null !== previousCache.alternate.memoizedState &&
          null !== previousCache.alternate.memoizedState.cachePool &&
          (renderLanes = previousCache.alternate.memoizedState.cachePool.pool),
        (oldProps = null),
        null !== previousCache.memoizedState &&
          null !== previousCache.memoizedState.cachePool &&
          (oldProps = previousCache.memoizedState.cachePool.pool),
        oldProps !== renderLanes && (previousCache.flags |= 2048));
    ...
    case 19:
      ...
      previousCache = 0 !== (workInProgress.flags & 128);
      oldProps = newProps.rendering;
      if (null === oldProps)
        if (previousCache) cutOffTailIfNeeded(newProps, !1);
        else {
          if (
            0 !== workInProgressRootExitStatus ||
      ...
      if (null !== newProps.tail) {
        ...
        oldProps = suspenseStackCursor.current;
        oldProps = previousCache ? (oldProps & 1) | 2 : oldProps & 1;
        "visible" !== newProps.tailMode &&
        "collapsed" !== newProps.tailMode &&
        renderLanes
          ? ((newProps = oldProps),
            push(suspenseHandlerStackCursor, workInProgress),
            push(suspenseStackCursor, newProps),
            null === shellBoundary && (shellBoundary = workInProgress))
          : pushSuspenseListContext(workInProgress, oldProps);
        return current;
      }
      bubbleProperties(workInProgress);
      return null;
    ...
    case 23:
      return (
        ...
        null !== workInProgress.memoizedState &&
          ...
          (previousCache = workInProgress.memoizedState.cachePool.pool),
        previousCache !== newProps && (workInProgress.flags |= 2048),
...
function markRootSuspended(
  ...
  for (var lanes = suspendedLanes; 0 < lanes; ) {
    var index$13 = 31 - clz32(lanes),
      lane = 1 << index$13;
    didAttemptEntireTree[index$13] = -1;
    lanes &= ~lane;
  }
  0 !== spawnedLane &&
...
function prepareFreshStack(root, lanes) {
  ...
  if (0 !== allEntangledLanes)
    for (
      ...
      var index$11 = 31 - clz32(allEntangledLanes),
        lane = 1 << index$11;
      lanes |= root[index$11];
    ...
    if (null == instance.canonical.publicInstance) {
      ...
      instance.canonical.publicInstance =
        ReactNativePrivateInterface.createPublicInstance(
          ...
          null != ($jscomp$nullish$tmp1 = instance.canonical.publicRootInstance)
            ? $jscomp$nullish$tmp1
            : null
        );
...
var getInstanceFromNodeImpl$jscomp$inline_1366 = getInstanceFromNode;
getFiberCurrentPropsFromNode$1 = function (instance) {
  return instance.canonical.currentProps;
};
getInstanceFromNode$1 = getInstanceFromNodeImpl$jscomp$inline_1366;
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1777 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1777.isDisabled &&
    hook$jscomp$inline_1777.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1777.inject(
        internals$jscomp$inline_1396
      )),
        (injectedHook = hook$jscomp$inline_1777);
    } catch (err) {}
}
...
exports.render = function (
  ...
  if (!root) {
    ...
    var onDefaultTransitionIndicator = nativeOnDefaultTransitionIndicator;
    options &&
    ...
    void 0 === isomorphicDefaultTransitionIndicator
      ? (isomorphicDefaultTransitionIndicator = options)
      : isomorphicDefaultTransitionIndicator !== options &&

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<01cc9f284c60ab4c10d734765170f7b0>>
 */
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$30 = !1;
    do {
        ...
        if (enableAsyncActions && 0 !== revertLane)
          if ((renderLanes & revertLane) === revertLane) {
            ...
            revertLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$30 = !0);
            continue;
          } else
            (updateLane = {
              lane: 0,
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$30 &&
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1096 = {
    ...
    bundleType: 0,
    version: "19.0.0-canary-c6df369f",
...
var internals$jscomp$inline_1365 = {
  ...
  reconcilerVersion: "19.0.0-canary-c6df369f"
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1366 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1366.isDisabled &&
    hook$jscomp$inline_1366.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1366.inject(
        internals$jscomp$inline_1365
      )),
        (injectedHook = hook$jscomp$inline_1366);
    } catch (err) {}
}

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<3b57039085934b87d3dcf4e4420f0006>>
 */
...
var injectedNamesToPlugins$jscomp$inline_235 = {
  ...
  isOrderingDirty$jscomp$inline_236 = !1,
  pluginName$jscomp$inline_237;
for (pluginName$jscomp$inline_237 in injectedNamesToPlugins$jscomp$inline_235)
  if (
    injectedNamesToPlugins$jscomp$inline_235.hasOwnProperty(
      pluginName$jscomp$inline_237
    )
  ) {
    var pluginModule$jscomp$inline_238 =
      injectedNamesToPlugins$jscomp$inline_235[pluginName$jscomp$inline_237];
    if (
      !namesToPlugins.hasOwnProperty(pluginName$jscomp$inline_237) ||
      namesToPlugins[pluginName$jscomp$inline_237] !==
        pluginModule$jscomp$inline_238
    ) {
      if (namesToPlugins[pluginName$jscomp$inline_237])
        throw Error(
      ...
      namesToPlugins[pluginName$jscomp$inline_237] =
        pluginModule$jscomp$inline_238;
      isOrderingDirty$jscomp$inline_236 = !0;
    }
  }
isOrderingDirty$jscomp$inline_236 && recomputePluginOrdering();
var emptyObject$1 = {},
  removedKeys = null,
  removedKeyCount = 0,
...
function getNextLanes(root, wipLanes) {
  ...
  var nonIdlePendingLanes = pendingLanes & 268435455;
  ...
  return 0 === nextLanes
    ...
    : 0 !== wipLanes &&
      ...
      suspendedLanes >= root ||
        (32 === suspendedLanes && 0 !== (root & 8388480)))
    ? wipLanes
    : nextLanes;
}
    ...
    do {
      ...
      for (var root = firstScheduledRoot; null !== root; ) {
        if (!onlyLegacy || 0 === root.tag) {
          var workInProgressRootRenderLanes$26 = workInProgressRootRenderLanes,
            nextLanes = getNextLanes(
              root,
              root === workInProgressRoot ? workInProgressRootRenderLanes$26 : 0
            );
          if (0 !== (nextLanes & 3))
            try {
              didPerformSomeWork = !0;
              workInProgressRootRenderLanes$26 = root;
              if (0 !== (executionContext & 6))
                throw Error("Should not already be working.");
              if (!flushPassiveEffects()) {
                var exitStatus = renderRootSync(
                  workInProgressRootRenderLanes$26,
                  nextLanes
                );
                if (
                  0 !== workInProgressRootRenderLanes$26.tag &&
                  2 === exitStatus
                ) {
                ...
                if (1 === exitStatus)
                  throw (
                    ...
                    prepareFreshStack(workInProgressRootRenderLanes$26, 0),
                    markRootSuspended(
                      workInProgressRootRenderLanes$26,
                      nextLanes
                    ),
                    ensureRootIsScheduled(workInProgressRootRenderLanes$26),
                    originallyAttemptedLanes)
                  );
                6 === exitStatus
                  ? markRootSuspended(
                  ...
                  : ((workInProgressRootRenderLanes$26.finishedWork =
                      workInProgressRootRenderLanes$26.current.alternate),
                    (workInProgressRootRenderLanes$26.finishedLanes =
                      nextLanes),
                    commitRoot(
                      workInProgressRootRenderLanes$26,
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1044 = {
    findFiberByHostInstance: getInstanceFromNode,
    bundleType: 0,
    version: "18.3.0-canary-1ff4eddb",
...
var internals$jscomp$inline_1288 = {
  bundleType: devToolsConfig$jscomp$inline_1044.bundleType,
  version: devToolsConfig$jscomp$inline_1044.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1044.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1044.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1044.findFiberByHostInstance ||
  ...
  reconcilerVersion: "18.3.0-canary-1ff4eddb"
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1289 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1289.isDisabled &&
    hook$jscomp$inline_1289.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1289.inject(
        internals$jscomp$inline_1288
      )),
        (injectedHook = hook$jscomp$inline_1289);
    } catch (err) {}
}

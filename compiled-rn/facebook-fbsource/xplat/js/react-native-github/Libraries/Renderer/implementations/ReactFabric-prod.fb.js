  ...
  switch (workInProgress.tag) {
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode) {
        ...
        recyclableInstance = ReactNativePrivateInterface.createPublicInstance(
          current,
          renderLanes,
          workInProgress
        );
      ...
      switch (exitStatus) {
        ...
        case 4:
          ...
          for (errorRetryLanes$98 = -1; 0 < exitStatus; ) {
            var index$3 = 31 - clz32(exitStatus),
              lane = 1 << index$3;
            index$3 = errorRetryLanes[index$3];
            index$3 > errorRetryLanes$98 && (errorRetryLanes$98 = index$3);
            exitStatus &= ~lane;
          }
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1027 = {
    ...
    bundleType: 0,
    version: "18.3.0-next-8faf75193-20230327",
...
var internals$jscomp$inline_1273 = {
  ...
  reconcilerVersion: "18.3.0-next-8faf75193-20230327"
};

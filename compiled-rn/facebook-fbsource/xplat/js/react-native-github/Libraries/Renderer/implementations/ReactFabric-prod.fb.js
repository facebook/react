 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<bd774d7a528b6e9e6cb64362572a3d70>>
 */
    ...
    do {
      ...
      for (var root = firstScheduledRoot; null !== root; ) {
        if (!onlyLegacy || 0 === root.tag) {
          ...
          workInProgressRootRenderLanes$10 = getNextLanes(
            root,
            root === workInProgressRoot ? workInProgressRootRenderLanes$10 : 0
          );
          0 !== (workInProgressRootRenderLanes$10 & 3) &&
            ((didPerformSomeWork = !0),
            performSyncWorkOnRoot(root, workInProgressRootRenderLanes$10));
        }
        root = root.next;
      }
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1100 = {
    ...
    bundleType: 0,
    version: "19.0.0-canary-82133e6d",
...
var internals$jscomp$inline_1333 = {
  ...
  reconcilerVersion: "19.0.0-canary-82133e6d"
};

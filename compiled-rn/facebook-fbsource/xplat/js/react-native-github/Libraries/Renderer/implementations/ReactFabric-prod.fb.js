 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<3019de92392b5c3a62f7c1a6be88e6e6>>
 */
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$29 = !1;
    do {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$29 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$29 &&
...
function commitHookEffectListMount(flags, finishedWork) {
  ...
  if (null !== finishedWork) {
    ...
    do {
      if ((effect.tag & flags) === flags) {
        var create$98 = effect.create,
          inst = effect.inst;
        create$98 = create$98();
        inst.destroy = create$98;
      }
      effect = effect.next;
...
var internals$jscomp$inline_1385 = {
  ...
  reconcilerVersion: "19.0.0-beta-92a7ad1c"
};

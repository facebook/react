 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<d92855b317586610aab37671ad9aa9d5>>
 */
        ...
        if ((updateQueue.tag & flags) === flags) {
          ...
          if (enableUseEffectCRUDOverload) {
            ...
            var create$129 = updateQueue.create,
              inst$130 = updateQueue.inst;
            lastEffect = create$129();
            inst$130.destroy = lastEffect;
          }
          0 !== (flags & 8)
            ? null !== injectedProfilingHooks &&
              "function" ===
...
null !== extraDevToolsConfig &&
  (internals$jscomp$inline_1329.rendererConfig = extraDevToolsConfig);
internals$jscomp$inline_1329.getLaneLabelMap = function () {
  for (
...
internals$jscomp$inline_1329.injectProfilingHooks = function (profilingHooks) {

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<e8441734f46c309c91af227fccd0e6dd>>
 */
...
internals$jscomp$inline_1255.getLaneLabelMap = function () {
  for (
...
internals$jscomp$inline_1255.injectProfilingHooks = function (profilingHooks) {
  injectedProfilingHooks = profilingHooks;
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1525 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1525.isDisabled &&
    hook$jscomp$inline_1525.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1525.inject(
        internals$jscomp$inline_1255
      )),
        (injectedHook = hook$jscomp$inline_1525);
    } catch (err) {}
}

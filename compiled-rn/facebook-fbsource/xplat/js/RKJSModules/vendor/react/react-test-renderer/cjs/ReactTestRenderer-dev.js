  ...
  (function () {
            ...
            a: for (current = null, wasHidden = finishedWork; ; ) {
              if (5 === wasHidden.tag) {
                if (null === current) {
                  ...
                  try {
                    (oldProps = root.stateNode),
                      existingHiddenCallbacks
                        ? runWithFiberInDEV(root, hideInstance, oldProps)
                        : runWithFiberInDEV(
                            root,
                            unhideInstance,
                            root.stateNode,
                    ...
                    captureCommitPhaseError(root, root.return, error$25);
                  }
                }
                ...
                if (null === current) {
                  ...
                  try {
                    ...
                    existingHiddenCallbacks
                      ? runWithFiberInDEV(root, hideTextInstance, instance)
                      : runWithFiberInDEV(
                          root,
                          unhideTextInstance,
                          instance,
                    ...
                    captureCommitPhaseError(root, root.return, error$26);
                  }
                }
              } else if (
    ...
    function throwAndUnwindWorkLoop(root, unitOfWork, thrownValue) {
      ...
      try {
        ...
        if (null !== returnFiber)
          throw ((workInProgress = returnFiber), error$34);
        workInProgressRootExitStatus = RootFatalErrored;
        logUncaughtError(
          root,
          createCapturedValueAtFiber(thrownValue, root.current)

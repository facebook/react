 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<ce301f0cf080b03b1cbf8490193ca5ce>>
 */
  ...
  if (null !== updateQueue) {
    ...
    do {
      if ((effect.tag & flags) === flags) {
        ...
        var create$113 = effect.create,
          inst = effect.inst;
        create$113 = create$113();
        inst.destroy = create$113;
        0 !== (flags & 8)
          ? null !== injectedProfilingHooks &&
            "function" ===

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<8dd12e2dd6f37c198e6b8f3f7922dbff>>
 */
...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$290;
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$290 = isSupported$jscomp$inline_424;
  } else JSCompiler_inline_result$jscomp$290 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$290 &&
  ...
  switch (workInProgress.tag) {
      ...
      a: {
        ...
        if (init.isDehydrated)
          if (
            ...
            break a;
          } else if (nextProps !== elementType) {
            elementType = createCapturedValueAtFiber(
              Error(formatProdErrorMessage(424)),
              workInProgress
            );
            queueHydrationError(elementType);
            workInProgress = mountHostRootWithoutHydrating(
              current,
              workInProgress,
              nextProps,
    ...
    case 27:
      return (
        ...
        null === current &&
          ...
          (hydrationParentFiber = workInProgress),
          (rootOrSingletonContext = !0),
          (nextHydratableInstance = getNextHydratable(elementType.firstChild))),
    ...
    case 10:
      a: {
        ...
        pushProvider(workInProgress, elementType, nextState);
...
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$143 = completedWork.child; null !== child$143; )
      (newChildLanes |= child$143.lanes | child$143.childLanes),
        ...
        (child$143.return = completedWork),
        (child$143 = child$143.sibling);
  else
    for (child$143 = completedWork.child; null !== child$143; )
      (newChildLanes |= child$143.lanes | child$143.childLanes),
        (subtreeFlags |= child$143.subtreeFlags),
        (subtreeFlags |= child$143.flags),
        (child$143.return = completedWork),
        (child$143 = child$143.sibling);
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$155 = newProps.memoizedState.cachePool.pool);
        cache$155 !== type && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      if (null === cache$155)
        if (newProps) cutOffTailIfNeeded(type, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$155 = findFirstSuspended(current);
              if (null !== cache$155) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(type, !1);
                current = cache$155.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$155)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
            ...
            2 * now() - type.renderingStartTime >
              ...
              (workInProgress.lanes = 4194304));
        type.isBackwards
          ? ((cache$155.sibling = workInProgress.child),
            (workInProgress.child = cache$155))
          : ((current = type.last),
            null !== current
              ? (current.sibling = cache$155)
              : (workInProgress.child = cache$155),
            (type.last = cache$155));
      }
      if (null !== type.tail)
...
if (
  "19.0.0-native-fb-e4953922-20240919" !==
...
var internals$jscomp$inline_2131 = {
  bundleType: 0,
  version: "19.0.0-native-fb-e4953922-20240919",
  rendererPackageName: "react-dom",
  currentDispatcherRef: ReactSharedInternals,
  findFiberByHostInstance: getClosestInstanceFromNode,
  reconcilerVersion: "19.0.0-native-fb-e4953922-20240919"
};

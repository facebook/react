 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<24d628ac8fbfe4e9472b78261c2d7819>>
 */
...
for (
  var i$jscomp$inline_1958 = 0;
  i$jscomp$inline_1958 < simpleEventPluginEvents.length;
  i$jscomp$inline_1958++
) {
  var eventName$jscomp$inline_1959 =
      simpleEventPluginEvents[i$jscomp$inline_1958],
    domEventName$jscomp$inline_1960 =
      eventName$jscomp$inline_1959.toLowerCase(),
    capitalizedEvent$jscomp$inline_1961 =
      eventName$jscomp$inline_1959[0].toUpperCase() +
      eventName$jscomp$inline_1959.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1960,
    "on" + capitalizedEvent$jscomp$inline_1961
  );
}

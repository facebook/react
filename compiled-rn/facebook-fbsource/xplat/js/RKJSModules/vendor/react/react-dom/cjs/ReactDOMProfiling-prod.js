 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<a929dd56df7e5303bbfd12433941e07a>>
 */
...
for (
  var i$jscomp$inline_1560 = 0;
  i$jscomp$inline_1560 < simpleEventPluginEvents.length;
  i$jscomp$inline_1560++
) {
  var eventName$jscomp$inline_1561 =
      simpleEventPluginEvents[i$jscomp$inline_1560],
    domEventName$jscomp$inline_1562 =
      eventName$jscomp$inline_1561.toLowerCase(),
    capitalizedEvent$jscomp$inline_1563 =
      eventName$jscomp$inline_1561[0].toUpperCase() +
      eventName$jscomp$inline_1561.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1562,
    "on" + capitalizedEvent$jscomp$inline_1563
  );
}

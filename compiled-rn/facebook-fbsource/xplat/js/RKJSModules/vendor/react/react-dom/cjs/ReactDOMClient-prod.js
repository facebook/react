 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<b8fb8226a58768c821e22ac35b8653c1>>
 */
...
for (
  var i$jscomp$inline_1442 = 0;
  i$jscomp$inline_1442 < simpleEventPluginEvents.length;
  i$jscomp$inline_1442++
) {
  var eventName$jscomp$inline_1443 =
      simpleEventPluginEvents[i$jscomp$inline_1442],
    domEventName$jscomp$inline_1444 =
      eventName$jscomp$inline_1443.toLowerCase(),
    capitalizedEvent$jscomp$inline_1445 =
      eventName$jscomp$inline_1443[0].toUpperCase() +
      eventName$jscomp$inline_1443.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1444,
    "on" + capitalizedEvent$jscomp$inline_1445
  );
}

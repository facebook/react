...
for (
  ...
  i$jscomp$inline_1465 < simpleEventPluginEvents.length;
  i$jscomp$inline_1465++
) {
  var eventName$jscomp$inline_1466 =
      simpleEventPluginEvents[i$jscomp$inline_1465],
    domEventName$jscomp$inline_1467 =
      eventName$jscomp$inline_1466.toLowerCase(),
    capitalizedEvent$jscomp$inline_1468 =
      eventName$jscomp$inline_1466[0].toUpperCase() +
      eventName$jscomp$inline_1466.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1467,
    "on" + capitalizedEvent$jscomp$inline_1468
  );
}

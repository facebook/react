...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2496.isDisabled &&
    hook$jscomp$inline_2496.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2496.inject(
        internals$jscomp$inline_2495
      )),
        (injectedHook = hook$jscomp$inline_2496);
    } catch (err) {}
}

 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<9f41476c0b5af326c6b5c4332a27c418>>
 */
    ...
    do {
      ...
      for (var root = firstScheduledRoot; null !== root; ) {
        if (!onlyLegacy || 0 === root.tag) {
          var workInProgressRootRenderLanes$24 = workInProgressRootRenderLanes,
            nextLanes = getNextLanes(
              root,
              root === workInProgressRoot ? workInProgressRootRenderLanes$24 : 0
            );
          if (0 !== (nextLanes & 3))
            try {
              didPerformSomeWork = !0;
              workInProgressRootRenderLanes$24 = root;
              ...
              if (!flushPassiveEffects()) {
                ...
                if (
                  0 !== workInProgressRootRenderLanes$24.tag &&
                  2 === exitStatus
                ) {
                ...
                if (1 === exitStatus)
                  throw (
                    ...
                    prepareFreshStack(workInProgressRootRenderLanes$24, 0),
                    markRootSuspended(
                      workInProgressRootRenderLanes$24,
                      nextLanes
                    ),
                    ensureRootIsScheduled(workInProgressRootRenderLanes$24),
                    originallyAttemptedLanes)
                  );
                6 === exitStatus
                  ? markRootSuspended(
                  ...
                  : ((workInProgressRootRenderLanes$24.finishedWork =
                      workInProgressRootRenderLanes$24.current.alternate),
                    (workInProgressRootRenderLanes$24.finishedLanes =
                      nextLanes),
                    commitRoot(
                      workInProgressRootRenderLanes$24,
  ...
  if (null !== baseQueue) {
    ...
    do {
      ...
      if (
        ...
        else if ((renderLanes & updateLane) === updateLane) {
          update = update.next;
          continue;
        } else {
          var clone$27 = {
...
var devToolsConfig$jscomp$inline_1062 = {
...
var internals$jscomp$inline_1254 = {
  bundleType: devToolsConfig$jscomp$inline_1062.bundleType,
  version: devToolsConfig$jscomp$inline_1062.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1062.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1062.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1062.findFiberByHostInstance ||

...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$23 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      usable = trackUsedThenable(thenableState, usable, index$23);
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$62.lanes | child$62.childLanes),
          (subtreeFlags |= child$62.subtreeFlags & 14680064),
          (subtreeFlags |= child$62.flags & 14680064),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$61.subtreeFlags & 14680064),
          (subtreeFlags |= treeBaseDuration$61.flags & 14680064),
...
function commitMutationEffectsOnFiber(finishedWork, root) {
  ...
  switch (finishedWork.tag) {
    ...
    case 22:
      ...
      var wasHidden$107 = null !== current && null !== current.memoizedState;
      if (finishedWork.mode & 1) {
        ...
        offscreenSubtreeWasHidden =
          prevOffscreenSubtreeWasHidden || wasHidden$107;
        recursivelyTraverseMutationEffects(root, finishedWork);
        offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
        offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden;
      ...
      if (
        ...
        a: for (current = null, wasHidden$107 = finishedWork; ; ) {
          if (5 === wasHidden$107.tag) {
            if (null === current) {
              current = wasHidden$107;
              try {
                (type = wasHidden$107.stateNode),
                  existingHiddenCallbacks
                    ? (type.isHidden = !0)
                    : (wasHidden$107.stateNode.isHidden = !1);
              } catch (error) {
                captureCommitPhaseError(
                  finishedWork,
                  finishedWork.return,
          ...
          } else if (6 === wasHidden$107.tag) {
            if (null === current)
              try {
                wasHidden$107.stateNode.isHidden = existingHiddenCallbacks
                  ? !0
                  : !1;
              } catch (error$92) {
                captureCommitPhaseError(
            ...
            ((22 !== wasHidden$107.tag && 23 !== wasHidden$107.tag) ||
              null === wasHidden$107.memoizedState ||
              wasHidden$107 === finishedWork) &&
            null !== wasHidden$107.child
          ) {
            wasHidden$107.child.return = wasHidden$107;
            wasHidden$107 = wasHidden$107.child;
            continue;
          }
          if (wasHidden$107 === finishedWork) break a;
          for (; null === wasHidden$107.sibling; ) {
            if (
              null === wasHidden$107.return ||
              wasHidden$107.return === finishedWork
            )
              break a;
            current === wasHidden$107 && (current = null);
            wasHidden$107 = wasHidden$107.return;
          }
          current === wasHidden$107 && (current = null);
          wasHidden$107.sibling.return = wasHidden$107.return;
          wasHidden$107 = wasHidden$107.sibling;
        }
      flags & 4 &&
        ((flags = finishedWork.updateQueue),
        null !== flags &&
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$116 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$116),
              (errorRetryLanes$116 = didTimeout[errorRetryLanes$116]),
              errorRetryLanes$116 > originallyAttemptedLanes &&
                (originallyAttemptedLanes = errorRetryLanes$116),
              (lanes &= ~errorRetryLanes);
              ...
              case 22:
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (null === offscreenQueue) {
                    ...
                    var wakeables$28 = offscreenQueue.wakeables;
                    null === wakeables$28
                      ? (offscreenQueue.wakeables = new Set([wakeable]))
                      : wakeables$28.add(wakeable);
                  }
                  break;
                }
              default:

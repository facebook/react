...
* Consider all `lazy()` that resolve to the same component to be equivalent. ([#20357](https://github.com/facebook/react/pull/20357)  by [@sebmarkbage](https://github.com/sebmarkbage))

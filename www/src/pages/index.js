    ...
    <header className="hero below_nav">
      <div className="hero__inner">
        <div className="wrapper">
          ...
          <p className="hero__subtitle">A JavaScript library for building user interfaces</p>
          <div className="hero__cta_group cta_group">
            ...
            <div className="cta_group__item">
              <a href="#" className="cta_link">
                Take the tutorial <img src={arrowSvg} alt="Search" height="12" />
              </a>
            </div>
          </div>
        </div>
    ...
    <div className="wrapper">
      <section className="home_tabs">
        <ul className="home_tabs__list">
          <li className="home_tabs__item"><a href="#" className="home_tabs__link is-current">Declarative</a></li>
          <li className="home_tabs__item"><a href="#" className="home_tabs__link">Component-based</a></li>
          <li className="home_tabs__item"><a href="#" className="home_tabs__link">Learn once, write anywhere</a></li>
        </ul>
      ...
      <section className="home_example">
        <div className="home_example__text">
          ...
          <div className="home_example__body">
            <p>React components implement a <code>render()</code> method that takes input data and returns what to display. This input data is accessed through <code>this.props</code>.</p>
          </div>
        </div>

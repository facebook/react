...
define('react-test-renderer', ['exports', 'react'], function (exports, React) { 'use strict';
  ...
  function appendChild(parentInstance, child) {
    {
      if (!Array.isArray(parentInstance.children)) {
        console.error('An invalid container has been provided. ' + 'This may indicate that another renderer is being used in addition to the test renderer. ' + '(For example, ReactDOM.createPortal inside of a ReactTestRenderer tree.) ' + 'This is not supported.');
      }
    }
    ...
    if (!isFlushingSyncQueue && syncQueue !== null) {
...

      {
        try {
          ...
          runWithPriority(ImmediatePriority$2, function () {
  ...
  function pushProvider(providerFiber, nextValue) {
    ...
    {
      push$1(valueCursor, context._currentValue2, providerFiber);
  ...
  function pushHostContainer(fiber, nextRootInstance) {
    ...
    push$1(contextStackCursor$1, NO_CONTEXT$1, fiber);
  ...
  function startTransition(setPending, callback) {
    ...
    {
      runWithPriority(priorityLevel < UserBlockingPriority$2 ? UserBlockingPriority$2 : priorityLevel, function () {
        setPending(true);
      });
      runWithPriority(priorityLevel > NormalPriority$2 ? NormalPriority$2 : priorityLevel, function () {
        var prevTransition = ReactCurrentBatchConfig$1.transition;
        ReactCurrentBatchConfig$1.transition = 1;
  ...
  function scheduleUpdateOnFiber(fiber, lane, eventTime) {
    ...
    if (lane === SyncLane) {
      ...
      priorityLevel === UserBlockingPriority$2 || priorityLevel === ImmediatePriority$2)) {
  ...
  function flushSync(fn, a) {
...

    {
      try {
        if (fn) {
          return runWithPriority(ImmediatePriority$2, fn.bind(null, a));
        } else {
          return undefined;
        }
      } finally {
  ...
  function commitRoot(root) {
    ...
    runWithPriority(ImmediatePriority$2, commitRootImpl.bind(null, root, renderPriorityLevel));
    return null;
  }

 ...
 * @format
 * @oncall ws_tools
 * @providesLegacy SlogDevToolsMainRootImpl
 */__d("legacy:SlogDevToolsMainRootImpl",[],(function $module_legacy_SlogDevToolsMainRootImpl(global,require,requireDynamic,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports){
...
var tabs=window.chrome.tabs;
var devtools=window.chrome.devtools;
var excludedDomains=new Set(['intern','internmc']);
...
var regexes=[
/https:\/\/[^\.]+\.(.+)\.facebook\.com/,
/https:\/\/[^\.]+\.(.+)\.internalfb\.com/];


var match=regexes.
map(function regexes_map_$0(regex){return url.match(regex);}).
find(function find_$0(match){return match!=null;});
var domain=match!=null?match[1]:null;
if(domain==null||excludedDomains.has(domain)){
return null;
}
return domain;
}

var tabId=devtools.inspectedWindow.tabId;

tabs.get(tabId,function tabs_get_$1(tab){
var domain=getDomainFromURL(tab.url);

if(domain!=null){
var iframe=document.createElement('iframe');
iframe.src=
"https://our.intern.facebook.com/intern/slog?headless&sandbox="+domain;
...
'Slog is not supported on this page. Try opening a page on your '+
"devserver or an On Demand, and you'll see Slog here. If you think "+
'this page should be supported, post in '));
 ...
 * @format
 * @oncall ws_tools
 * @providesMeta SlogDevToolsMainRoot
 * @requires SlogDevToolsMainRootImpl

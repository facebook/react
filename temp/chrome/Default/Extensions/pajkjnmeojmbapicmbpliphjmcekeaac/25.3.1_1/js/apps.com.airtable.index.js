(() => {
  ...
  CyberhavenDomEvents.register(), defaults = {
    windowEmailPath: [ "desktopAppInterface", "_hyperbaseModel", "_sessionUser", "_email" ]
  }, defaultKey = key = "com.airtable", settings.set(key, defaults), function(config, extras, options = {}) {

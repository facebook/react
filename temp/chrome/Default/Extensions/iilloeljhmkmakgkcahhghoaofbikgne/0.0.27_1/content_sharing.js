...
function getValidationErrors(document) {
  ...
  if (!(dataHandlingConsentCheckbox !== null && dataHandlingConsentCheckbox !== void 0 && dataHandlingConsentCheckbox.checked)) {
    validationErrors.push(VALIDATION_ERROR.DATA_HANDLING_CONSENT);
  }
  if (!requiredInputFieldFilled(document, INTERSTITIAL_REASON_TPA_CHECKBOX_ID, INTERSTITIAL_TPA_DETAILS_INPUT_ID, [VALIDATE_TPA_NUMBER_FN])) {
    validationErrors.push(VALIDATION_ERROR.TPA_NUMBER);
  }
  if (!requiredInputFieldFilled(document, INTERSTITIAL_REASON_OTHER_CHECKBOX_ID, INTERSTITIAL_OTHER_DETAILS_INPUT_ID, []) || !requiredInputFieldFilled(document, INTERSTITIAL_REASON_DSS1_CHECKBOX_ID, INTERSTITIAL_OTHER_DETAILS_INPUT_ID, [])) {
    validationErrors.push(VALIDATION_ERROR.ADDITIONAL_DETAILS);
  }
  ...
  function (checkboxID) {
    ...
    validationErrors.push(VALIDATION_ERROR.REASON_FOR_SHARING);
  }
...
function enableSharingButton(document) {
...
function disableSharingButton(document) {
  var shareButton = document.getElementById(INTERSTITIAL_SHARE_BUTTON_ID);
  if (shareButton) {
...
function updateValidationError(showError, document, errorMsg) {
  var fn;
  var inputElementID = '';
  var warningMsgElementID = '';
  switch (errorMsg) {
    case VALIDATION_ERROR.ADDITIONAL_DETAILS:
      ...
      break;
    case VALIDATION_ERROR.REASON_FOR_SHARING:
...
var INTERSTITIAL_DATA_HANDLING_CONSENT_CHECKBOX_ID = "".concat(BBDP_PREFIX, "data_handling_consent_checkbox_id");
var INTERSTITIAL_SHARE_BUTTON_ID = "".concat(BBDP_PREFIX, "share_button_id");
...
var INTERSTITIAL_REASON_TPA_CHECKBOX_ID = "".concat(BBDP_PREFIX, "reason_tpa_checkbox_id");
var INTERSTITIAL_REASON_VENDOR_CONTRACT_CHECKBOX_ID = "".concat(BBDP_PREFIX, "reason_vendor_contract_checkbox_id");
var INTERSTITIAL_REASON_DSS1_CHECKBOX_ID = "".concat(BBDP_PREFIX, "reason_dss1_checkbox_id");
var INTERSTITIAL_REASON_PERSONAL_DATA_CHECKBOX_ID = "".concat(BBDP_PREFIX, "reason_personal_data_checkbox_id");
var INTERSTITIAL_REASON_OTHER_CHECKBOX_ID = "".concat(BBDP_PREFIX, "reason_other_checkbox_id");
var ALL_INTERSTITIAL_CHECKBOXES = [INTERSTITIAL_REASON_NDA_CHECKBOX_ID, INTERSTITIAL_REASON_TPA_CHECKBOX_ID, INTERSTITIAL_REASON_VENDOR_CONTRACT_CHECKBOX_ID, INTERSTITIAL_REASON_DSS1_CHECKBOX_ID, INTERSTITIAL_REASON_PERSONAL_DATA_CHECKBOX_ID, INTERSTITIAL_REASON_OTHER_CHECKBOX_ID];
var INTERSTITIAL_OTHER_DETAILS_INPUT_ID = "".concat(BBDP_PREFIX, "other_details_input_id");
var INTERSTITIAL_TPA_DETAILS_INPUT_ID = "".concat(BBDP_PREFIX, "tpa_details_input_id");
...
var DataProtectionInterstitial = /*#__PURE__*/function () {
  function DataProtectionInterstitial(chrome, document, sessionUUID, recipients, gDocumentId, shareCallback) {
    classCallCheck_classCallCheck(this, DataProtectionInterstitial);
    ...
    defineProperty_defineProperty(this, "gDocumentId", void 0);
    defineProperty_defineProperty(this, "recipients", void 0);
    defineProperty_defineProperty(this, "shareCallback", void 0);
  ...
  createClass_createClass(DataProtectionInterstitial, [{
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              logger_consoleDebug("Error downloading interstitial.html: ".concat(_context.t0));
            case 13:
            case "end":
    ...
    value: function addInterstitialToDom(html) {
      ...
      logger_consoleDebug('Rendered data protection interstitial');
      var interstitial = this.document.getElementById(INTERSTITIAL_DOM_ID);
    ...
    value: function onTPAReasonClick() {
      var _this3 = this;
      var tpaReasonCheckbox = this.document.getElementById(INTERSTITIAL_REASON_TPA_CHECKBOX_ID);
      if (tpaReasonCheckbox) {
        tpaReasonCheckbox.addEventListener('change', function () {
          ...
          logger_consoleDebug("TPA reason changed to ".concat(_this3.state.tpaReasonSelected.toString()));
    ...
    value: function onShareAnywayClick() {
      var _this4 = this;
      var shareButton = this.document.getElementById(INTERSTITIAL_SHARE_BUTTON_ID);
      if (shareButton) {
    ...
    value: function getSelectedReasonsForSharing() {
      ...
      var ReasonDomIDToCode = defineProperty_defineProperty(defineProperty_defineProperty(defineProperty_defineProperty(defineProperty_defineProperty(defineProperty_defineProperty(defineProperty_defineProperty({}, INTERSTITIAL_REASON_NDA_CHECKBOX_ID, {
        type: 'NDA',
        data: [[FREEFORM_FIELD_NAME, INTERSTITIAL_OTHER_DETAILS_INPUT_ID]]
      }), INTERSTITIAL_REASON_TPA_CHECKBOX_ID, {
        type: 'TPA',
        data: [['TPA number', INTERSTITIAL_TPA_DETAILS_INPUT_ID], [FREEFORM_FIELD_NAME, INTERSTITIAL_OTHER_DETAILS_INPUT_ID]]
      }), INTERSTITIAL_REASON_VENDOR_CONTRACT_CHECKBOX_ID, {
        type: 'VENDOR_CONTRACT',
        data: [[FREEFORM_FIELD_NAME, INTERSTITIAL_OTHER_DETAILS_INPUT_ID]]
      }), INTERSTITIAL_REASON_DSS1_CHECKBOX_ID, {
        type: 'DSS1',
        data: [[FREEFORM_FIELD_NAME, INTERSTITIAL_OTHER_DETAILS_INPUT_ID]]
      }), INTERSTITIAL_REASON_PERSONAL_DATA_CHECKBOX_ID, {
        type: 'PERSONAL_DATA',
        data: [[FREEFORM_FIELD_NAME, INTERSTITIAL_OTHER_DETAILS_INPUT_ID]]
      }), INTERSTITIAL_REASON_OTHER_CHECKBOX_ID, {
        type: 'OTHER',
        data: [[FREEFORM_FIELD_NAME, INTERSTITIAL_OTHER_DETAILS_INPUT_ID]]
      });
      var reasons = new Map();
...
;// CONCATENATED MODULE: ./src/content/google_native_interstitial.js
...
var GoogleNativeInterstitial = /*#__PURE__*/function () {
  function GoogleNativeInterstitial(chrome, sessionUUID, googleShare, googleSharingPromptSendButton) {
    classCallCheck_classCallCheck(this, GoogleNativeInterstitial);
    defineProperty_defineProperty(this, "chrome", void 0);
    defineProperty_defineProperty(this, "googleShare", void 0);
    defineProperty_defineProperty(this, "sessionUUID", void 0);
    defineProperty_defineProperty(this, "metaFoundAttribute", void 0);
    defineProperty_defineProperty(this, "googleSharingPromptSendButton", void 0);
    this.chrome = chrome;
    this.sessionUUID = sessionUUID;
    this.googleShare = googleShare;
    this.googleSharingPromptSendButton = googleSharingPromptSendButton;
    this.metaFoundAttribute = "meta-found-".concat(chrome.runtime.id);
  }
  createClass_createClass(GoogleNativeInterstitial, [{
    key: "captureShareClick",
    value: function captureShareClick(documentId, recipients) {
      var _this = this;
      // Query under the googleShare element
      var googleSendButton = this.googleShare.querySelector(this.googleSharingPromptSendButton);
      if (googleSendButton && googleSendButton.getAttribute(this.metaFoundAttribute) !== 'true') {
        googleSendButton.setAttribute(this.metaFoundAttribute, 'true');

        // Hook event listener on share anyway button
        googleSendButton.addEventListener('click', function () {
          _this.shareHandler(documentId, recipients);
        });
      }
    }
  }, {
    key: "shareHandler",
    value: function shareHandler(documentId, recipients) {
      this.chrome.runtime.sendMessage({
        type: 'google_interstitial_share',
        payload: {
          // eslint-disable-next-line camelcase
          session_uuid: this.sessionUUID,
          // eslint-disable-next-line camelcase
    ...
    key: "shareAnyway",
    value: function shareAnyway() {
      var googleSendButton = this.googleShare.querySelector(this.googleSharingPromptSendButton);
      if (googleSendButton) {
        logger_consoleDebug('Google Send Button Clicked');
        googleSendButton.click();
      } else {
        logger_consoleDebug('No Google send button found');
      }
    }
  }]);
  return GoogleNativeInterstitial;
}();
...
function filterMetaEmails(emails) {
  return emails.filter(function (email) {
    return !utils_isMetaEmail(email);
  });
}
function utils_isMetaEmail(email) {
  var _extractDomain;
  var domain = (_extractDomain = extractDomain(email)) === null || _extractDomain === void 0 ? void 0 : _extractDomain.trim().toLowerCase();
  if (domain == null) {
    return false;
  }
  return INTERNAL_META_DOMAINS.includes(domain);
}
...
;// CONCATENATED MODULE: ./src/content/content_sharing_decl.js
/**
 * (c) Meta Platforms, Inc. and affiliates. Confidential and proprietary.
 *
 * @format
...
function content_sharing_decl_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = content_sharing_decl_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
function content_sharing_decl_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return content_sharing_decl_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return content_sharing_decl_arrayLikeToArray(o, minLen); }
function content_sharing_decl_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }

function content_sharing_decl_callSuper(t, o, e) { return o = getPrototypeOf_getPrototypeOf(o), possibleConstructorReturn_possibleConstructorReturn(t, content_sharing_decl_isNativeReflectConstruct() ? Reflect.construct(o, e || [], getPrototypeOf_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function content_sharing_decl_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (content_sharing_decl_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var POLICY_CHECK_TIMEOUT = 5000;
var ContentScriptSharing = /*#__PURE__*/function (_ContentScriptBase) {
  inherits_inherits(ContentScriptSharing, _ContentScriptBase);
  function ContentScriptSharing(chrome) {
    var _this;
    classCallCheck_classCallCheck(this, ContentScriptSharing);
    _this = content_sharing_decl_callSuper(this, ContentScriptSharing, [chrome]);
    defineProperty_defineProperty(_assertThisInitialized(_this), "metaFoundAttribute", void 0);
    defineProperty_defineProperty(_assertThisInitialized(_this), "featureGating", void 0);
    defineProperty_defineProperty(_assertThisInitialized(_this), "googleSharingPromptDomSelector", void 0);
    ...
    _this.state = {
      ...
      sharingOkGoogleBypass: false
    };
    _this.googleSharingPromptDomSelector = DEFAULT_DOM_SELECTOR.google_sharing_prompt;
    _this.addListeners();
    return _this;
  }
  createClass_createClass(ContentScriptSharing, [{
    key: "isFeatureEnabled",
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (typeof config.dom_selector !== 'undefined') {
                this.googleSharingPromptDomSelector = config.dom_selector.google_sharing_prompt;
              }
            case 1:
            case "end":
              return _context.stop();
    ...
    value: function addListeners() {
      var _this2 = this;
      this.chrome.runtime.onMessage.addListener(function (message) {
        if (message.type === constants_BATCHEXECUTE_U1T5P) {
          var _this2$featureGating;
          _this2.state.selectedResourceIDs = message.ids;
          // Run policy check for the newly selected resource IDs
          if ((_this2$featureGating = _this2.featureGating) !== null && _this2$featureGating !== void 0 && _this2$featureGating.blackbird_data_protection_google_interstitial) {
            _this2.state.sensitiveResourcesPromise = _this2.resourcePolicyCheck();
          }
        }
      });
    }
    ...
    value: function () {
      var _runImpl = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var _this$getDocumentId, _this$featureGating;
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              this.state.selectedResourceIDs = (_this$getDocumentId = this.getDocumentId(window)) === null || _this$getDocumentId === void 0 ? void 0 : _this$getDocumentId.split(',');
              if ((_this$featureGating = this.featureGating) !== null && _this$featureGating !== void 0 && _this$featureGating.blackbird_data_protection_google_interstitial) {
                this.state.sensitiveResourcesPromise = this.resourcePolicyCheck();
              }
              this.setObserver();
            case 3:
            case "end":
    ...
    value: function setObserver() {
      ...
      var observer = new MutationObserver(function (mut, _obs) {
        ...
        if (timeSpentMs > 5) {
          _this3.chrome.runtime.sendMessage({
    ...
    /**
     * Processes DOM mutations to detect and handle Google sharing UI elements.
     * This function is called by the MutationObserver whenever DOM changes occur.
     * It looks for specific elements like interstitial dialogs and share buttons,
     * then attaches appropriate event handlers to them.
     *
     * @param {Array<MutationRecord>} mutationsList - List of mutation records to process
     */
  }, {
    key: "handleMutations",
    value: function handleMutations(mutationsList) {
      var _iterator = content_sharing_decl_createForOfIteratorHelper(mutationsList),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var mutation = _step.value;
          if (mutation.type === 'childList') {
            var _iterator2 = content_sharing_decl_createForOfIteratorHelper(mutation.addedNodes),
              _step2;
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                var node = _step2.value;
                if (node instanceof Element) {
                  // Google's native interstitial
                  // ┌─────────────────────────────────────────┐
                  // │ This document contains sensitive        │
                  // │ content. The following recipients are   │
                  // │ outside the item's domain:              │
                  // │ user1@gmail.com. Are you sure you would │
                  // │ like to share it with external users?   │
                  // │                  ┌──────┐┌────────────┐ │
                  // │                  │Cancel││Share anyway│ │
                  // │                  └──────┘└────────────┘ │
                  // └─────────────────────────────────────────┘
                  var googleInterstitialDialog = node.querySelector(this.googleSharingPromptDomSelector.google_interstitial_dialog);
                  if (googleInterstitialDialog) {
                    this.detectGoogleInterstitial(googleInterstitialDialog);
                  }

                  // Sharing prompt's Send button
                  // ┌───────────────────────────────────────┐
                  // │ Share "Doc"                           │
                  // │                                       │
                  // │ ┌─────────────────┐ ┌────────┐        │
                  // │ │ user1@gmail.com │ │Editor ▼│        │
                  // │ └─────────────────┘ └────────┘        │
                  // │ ┌───────────────────────────────────┐ │
                  // │ │                                   │ │
                  // │ │                                   │ │
                  ...
                  // │                              └──────┘ │
                  // └───────────────────────────────────────┘
                  var sharingPromptSendBtn = node.querySelector(this.googleSharingPromptDomSelector.send_button);
                  if (sharingPromptSendBtn && sharingPromptSendBtn instanceof HTMLButtonElement) {
                    this.captureShareButtonClick(sharingPromptSendBtn);
                  }

                  // Sharing request approval Share button
                  // Each request approval is for one recipient and has its own section with its own Share button.
                  // Accept all is alco captured by sharing_request_share_button dom selector.
                  // ┌────────────────────────────┐
                  // │ Requests for access        │
                  // │ ┌──────────┐  ┌──────────┐ │
                  ...
                  // │          └──────┘└───────┘ │
                  // └────────────────────────────┘
                  var btns = node.querySelectorAll(this.googleSharingPromptDomSelector.sharing_request_share_button);
                  var _iterator3 = content_sharing_decl_createForOfIteratorHelper(btns),
                    _step3;
                  try {
                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                      var btn = _step3.value;
                      this.captureShareRequestApprovalClick(btn);
                    }

                    // Google's Accept All prompt (when there are multiple requests)
                    // ┌────────────────────────────────────────┐
                    // │ Accept all requests?                   │
                    // │                                        │
                    // │ ┌─────────────────┐┌─────────────────┐ │
                  ...
                  var googleAcceptAllInterstitialDialog = node.querySelector(this.googleSharingPromptDomSelector.google_interstitial_accept_all_dialog);
                  if (googleAcceptAllInterstitialDialog) {
                    this.detectGoogleAcceptAllPrompt(googleAcceptAllInterstitialDialog);
                  }
                }
              }
            } catch (err) {
    ...
    /**
     * When google accept all prompt is detected and if sharingOkGoogleBypass is enabled,
     * then we auto click "Give access". sharingOkGoogleBypass is determined by shareAnyway
     * click on Meta Interstitial. If recipient & resource policy check is successful, we
     * bypass Google's prompts to minimize user friction.
     */
  }, {
    key: "detectGoogleAcceptAllPrompt",
    value: function detectGoogleAcceptAllPrompt(googleAcceptAllInterstitialDialog) {
      if (googleAcceptAllInterstitialDialog && this.state.sharingOkGoogleBypass) {
        var giveAccessButton = googleAcceptAllInterstitialDialog.querySelector(this.googleSharingPromptDomSelector.google_interstitial_accept_all_give_access_button);
        if (giveAccessButton instanceof HTMLButtonElement) {
          giveAccessButton.click();
          // Note that after clicking this, google native interstitial may be rendered
        }
      }
    }
  }, {
    key: "detectGoogleInterstitial",
    value: function detectGoogleInterstitial(googleShare) {
      if (googleShare && googleShare.getAttribute(this.metaFoundAttribute) !== 'true') {
        var _this$state$selectedR, _this$state$selectedR2;
        googleShare.setAttribute(this.metaFoundAttribute, 'true');
        var recipients = [];
        if (this.state.isSharingRequestApproval === false) {
          recipients = filterMetaEmails(this.extractSharingPromptRecipients());
        } else if (this.state.lastClickedShareBtn) {
          recipients = filterMetaEmails(this.extractSharingRequestApprovalRecipients(this.state.lastClickedShareBtn));
        }
        var resourceIDs = (_this$state$selectedR = (_this$state$selectedR2 = this.state.selectedResourceIDs) === null || _this$state$selectedR2 === void 0 ? void 0 : _this$state$selectedR2.join(',')) !== null && _this$state$selectedR !== void 0 ? _this$state$selectedR : '';
        // TODO: Distinguish between shown to user and bypassed by extension
        this.chrome.runtime.sendMessage({
          type: 'google_interstitial_shown',
          payload: {
            // eslint-disable-next-line camelcase
            session_uuid: this.state.sessionUUID,
            // eslint-disable-next-line camelcase
            document_id: resourceIDs,
            recipients: recipients
          }
        });
        var googleNativeInterstitial = new GoogleNativeInterstitial(this.chrome, this.state.sessionUUID, googleShare, this.googleSharingPromptDomSelector.google_interstitial_send_button);

        // Add listener to "Share Anyway" button click
        googleNativeInterstitial.captureShareClick(resourceIDs, recipients);
        if (this.state.sharingOkGoogleBypass === true) {
          this.state.sharingOkGoogleBypass = false;
          googleNativeInterstitial.shareAnyway();
          return;
        }
      }
    }
  }, {
    key: "captureShareRequestApprovalClick",
    value: function captureShareRequestApprovalClick(btn) {
      var _this4 = this;
      ...
      var eventHandler = function eventHandler(event) {
        _this4.sharingRequestPromptHandler(event);
      };
      this.state.eventListeners.set(btn, eventHandler);
      btn === null || btn === void 0 || btn.addEventListener('click', eventHandler);
    }
  }, {
    key: "captureShareButtonClick",
    value: function captureShareButtonClick(btn) {
      var _this5 = this;
      // Do nothing if element has already been processed (has metaFoundAttribute)
      if (btn.getAttribute(this.metaFoundAttribute) === 'true') {
        return;
      ...
      btn.setAttribute(this.metaFoundAttribute, 'true');
      var eventHandler = function eventHandler(event) {
        _this5.sharingPromptHandler(event);
      };
      this.state.eventListeners.set(btn, eventHandler);
      btn.addEventListener('click', eventHandler);
    }
  }, {
    key: "sharingRequestPromptHandler",
    value: function sharingRequestPromptHandler(event) {
      var _this$featureGating2;
      if (!((_this$featureGating2 = this.featureGating) !== null && _this$featureGating2 !== void 0 && _this$featureGating2.blackbird_data_protection_google_interstitial)) {
        return;
      }
      // Create uuid for this sharing "session"
      this.state.sessionUUID = esm_browser_v4();

      // Else intercept event so we can validate recipients
      event.preventDefault();
      event.stopPropagation();
      this.state.lastClickedShareBtn = event.currentTarget;
      this.state.isSharingRequestApproval = true;
      var recipients = filterMetaEmails(this.extractSharingRequestApprovalRecipients(event.currentTarget));
      var listener = this.state.eventListeners.get(event.currentTarget);
      if (listener) {
        this.sharingHandler(event.currentTarget, recipients, listener);
      }
    }
  }, {
    key: "sharingPromptHandler",
    value: function sharingPromptHandler(event) {
      var _this$featureGating3;
      // Don't intercept sharing event on Google Modal in case of:
      // a) our interstitial is disabled via feature gating
      // b) it's a sharing request (employee with limited permissions tries to share)
      if (!((_this$featureGating3 = this.featureGating) !== null && _this$featureGating3 !== void 0 && _this$featureGating3.blackbird_data_protection_google_interstitial) || document.querySelector(this.googleSharingPromptDomSelector.permission_dropdown) === null) {
        return;
      }
      ...
      event.stopPropagation();
      this.state.lastClickedShareBtn = event.currentTarget;
      this.state.isSharingRequestApproval = false;
      var recipients = filterMetaEmails(this.extractSharingPromptRecipients());
      var listener = this.state.eventListeners.get(event.currentTarget);
      if (listener) {
        this.sharingHandler(event.currentTarget, recipients, listener);
      }
    ...
    key: "sharingHandler",
    value: function sharingHandler(target, recipients, listener) {
      var _this6 = this;
      // Wait for both document and recipients policy checks before proceeding
      var policyCheckPromise = Promise.all([
      // Check if recipients are trusted
      this.recipientsPolicyCheck(recipients), this.state.sensitiveResourcesPromise]);
      var timeoutPromise = new Promise(function (_resolve, reject) {
        return setTimeout(reject, POLICY_CHECK_TIMEOUT, 'Policy check timeout');
      });
      Promise.race([policyCheckPromise, timeoutPromise]).then(function () {
        if (_this6.state.untrustedRecipients == null || _this6.state.sensitiveResources == null) {
          var _this6$state$untruste, _this6$state$sensitiv;
          // Something went wrong and policy check results are undefined
          // fallback to Google's native interstitial
          logger_consoleDebug("Undefined policy check result. Falling back to native interstitial", "Recipients: ".concat(JSON.stringify((_this6$state$untruste = _this6.state.untrustedRecipients) !== null && _this6$state$untruste !== void 0 ? _this6$state$untruste : '')), "Resource IDs: ".concat(JSON.stringify((_this6$state$sensitiv = _this6.state.sensitiveResources) !== null && _this6$state$sensitiv !== void 0 ? _this6$state$sensitiv : '')));
          _this6.shareAnyway(target, listener,
          // googleBypass
          false);
        } else if (_this6.state.untrustedRecipients.length === 0 || _this6.state.sensitiveResources.length === 0) {
          // Don't show Meta and Google interstitials if:
          // a) all recipients are trusted
          // b) no sensitive files shared
          _this6.shareAnyway(target, listener,
          // googleBypass
          true);
        } else {
          _this6.showDataProtectionInterstitial(target, listener);
        }
      })["catch"](function (error) {
        logger_consoleDebug("Error while checking policy", error);
        // Fallback to Google's native interstitial
        _this6.shareAnyway(target, listener,
        // googleBypass
        false);
    ...
    // Show Meta intesrstitial
  }, {
    key: "showDataProtectionInterstitial",
    value: function showDataProtectionInterstitial(target, listener) {
      var _this7 = this;
      new DataProtectionInterstitial(this.chrome, document, this.state.sessionUUID, this.state.untrustedRecipients, this.state.sensitiveResources, function () {
        return _this7.shareAnyway(target, listener, true);
      }).downloadAndRenderDataProtectionInterstitial().then(function () {
        logger_consoleDebug('Data Protection Interstitial rendered');
      })["catch"](function (error) {
        logger_consoleDebug("Error rendering data protection interstitial", error);
      });
    }

    /**
     * Handles the action when a user clicks "Share anyway" on the Meta interstitial dialog
     * after providing a reason.
     *
     * This function:
     * 1. Remove this extension's listener on share button (we listened earlier to show Meta intersitial)
     * 2. Mimic the original Google share event by clicking the buttion
     * 3. Re-attach this extension's listener
     *
     * @param {EventTarget} target - Google's DOM element that was clicked (Share/Accept all
     *    btn in sharing request approval or Send button in normal share)
     * @param {MouseEventListener} listener - The event listener function this extension added
     *    that is stored in this.state.eventListeners
     * @param {boolean} googleBypass - Whether to bypass Google's native interstitial dialog
     */
  }, {
    key: "shareAnyway",
    value: function shareAnyway(target, listener, googleBypass) {
      this.state.sharingOkGoogleBypass = googleBypass;

      // Remove click handler from share button
      target.removeEventListener('click', listener);
      if (target instanceof HTMLButtonElement) {
        target.click();
      }

      // Re-add event listener in case user clicks away/cancels the native interstitial
      target.addEventListener('click', listener);
    }

    // Pass window as argument to allow us to mock in tests
  }, {
    key: "getDocumentId",
    value: function getDocumentId(window) {
      // Google reuses the iframe for any follow up sharing prompts hence the id in the URL will be stale
      // It does however issue a batch request for rpcid "U1t5p" to get more details for the current selection
      // In the service worker we intercept the request and extract the IDs. These are then send to this content script
      if (this.state.selectedResourceIDs != null) {
        return this.state.selectedResourceIDs.join(',');
      }

      // Google's interstitial lives inside the nested iframe for the Sharing prompt
      var iframeURL = window.location.href;
      var searchParams = new URLSearchParams(new URL(iframeURL).search);
      if (searchParams.has('id')) {
        return searchParams.get('id');
      }
    }
  }, {
    key: "resourcePolicyCheck",
    value: function resourcePolicyCheck() {
      var _this8 = this;
      return new Promise(function (resolve) {
        // $FlowFixMe[incompatible-call]: https://developer.chrome.com/docs/extensions/reference/api/runtime
        _this8.chrome.runtime.sendMessage({
          type: 'resources_policy_check',
          payload: {
            // eslint-disable-next-line camelcase
            session_uuid: _this8.state.sessionUUID,
            resources: _this8.state.selectedResourceIDs
          }
        }, function (response) {
          if (response.payload.resources) {
            _this8.state.sensitiveResources = response.payload.resources.join(',');
          }
          resolve();
        });
      });
    ...
    key: "recipientsPolicyCheck",
    value: function recipientsPolicyCheck(recipients) {
      var _this9 = this;
      return new Promise(function (resolve) {
        // $FlowFixMe[incompatible-call]: https://developer.chrome.com/docs/extensions/reference/api/runtime
        _this9.chrome.runtime.sendMessage({
          type: 'recipients_policy_check',
          payload: {
            // eslint-disable-next-line camelcase
            session_uuid: _this9.state.sessionUUID,
            recipients: recipients
          }
        }, function (response) {
          _this9.state.untrustedRecipients = response.payload.recipients;
          resolve();
        });
      });
    }
  }, {
    key: "extractSharingPromptRecipients",
    value: function extractSharingPromptRecipients() {
      var _iframeEntries;
      // Extract the list of emails user is trying to share with
      var entries = document.querySelectorAll(this.googleSharingPromptDomSelector.recipients_list);

      // When folder sharing, it's noticed that sometimes the above query selector returns none.
      // Sharing prompt is rendered in an iframe. For some reasons, the window.location sometimes
      // remain in the parent window instead of the sharing iframe. This causes the selector to
      // return none because the elements are within the iframe. Therefore, we add fallback to
      // search for documents within the known iframe class for sharing prompt
      var sharingIframe = document.querySelector(this.googleSharingPromptDomSelector.iframe);
      var iframeEntries;
      if (sharingIframe instanceof HTMLIFrameElement) {
        var _sharingIframe$conten;
        iframeEntries = (_sharingIframe$conten = sharingIframe.contentDocument) === null || _sharingIframe$conten === void 0 ? void 0 : _sharingIframe$conten.querySelectorAll(this.googleSharingPromptDomSelector.recipients_list);
      }
      var recipients = Array.from(entries).concat(Array.from((_iframeEntries = iframeEntries) !== null && _iframeEntries !== void 0 ? _iframeEntries : [])).map(function (element) {
        var _element$getAttribute;
        return ((_element$getAttribute = element.getAttribute('data-value')) === null || _element$getAttribute === void 0 ? void 0 : _element$getAttribute.toLowerCase().trim()) || '';
      }).filter(function (element) {
        return element !== null && element !== undefined && element !== '';
      });
      logger_consoleDebug('extracted recipients: ', recipients);
      return recipients;
    }
  }, {
    key: "extractSharingRequestApprovalRecipients",
    value: function extractSharingRequestApprovalRecipients(target) {
      // The way Google present sharing request approval if two people requested access:
      //             ┌────────────────────────────┐
      //   section   │ ┌──────────┐  ┌──────────┐ │
      //             │ │Reject all│  │Accept all│ │
      //             │ └──────────┘  └──────────┘ │
      ...
      //             │          └──────┘└───────┘ │
      //             └────────────────────────────┘
      // When individual Share is clicked, we find the closest (parent) section and find
      // the user email in that parent section
      if (target instanceof HTMLElement) {
        var acceptAllParent = target.closest(this.googleSharingPromptDomSelector.sharing_request_accept_all_prompt);
        // Check if this is an Accept all button than individual share
        if (acceptAllParent) {
          // We need to find all the recipient emails from the other sections
          var allRecipients = document.querySelectorAll("".concat(this.googleSharingPromptDomSelector.sharing_request_prompt, " ").concat(this.googleSharingPromptDomSelector.sharing_request_recipient));
          var emails = Array.from(allRecipients).map(function (element) {
            return element.getAttribute('data-hovercard-id');
          }).filter(Boolean);
          return emails;
        }
        var parent = target.closest(this.googleSharingPromptDomSelector.sharing_request_prompt);
        var recipient = parent === null || parent === void 0 ? void 0 : parent.querySelector(this.googleSharingPromptDomSelector.sharing_request_recipient);
        var email = recipient === null || recipient === void 0 ? void 0 : recipient.getAttribute('data-hovercard-id');
        if (email) {
          return [email];
        }
      }
  ...
  return ContentScriptSharing;
}(ContentScriptBase);
;// CONCATENATED MODULE: ./src/content/content_sharing.js
/**
 * (c) Meta Platforms, Inc. and affiliates. Confidential and proprietary.
 *
 * @format
...
try {
  new ContentScriptSharing(chrome).run();
} catch (e) {
  logger_consoleDebug('Error running Sharing content script:', e);
  chrome.runtime.sendMessage({
    type: 'content_script_sharing_error',
    payload: {
      error_msg: "".concat(e.name, ": ").concat(e.message)
    }
  });

 ...
 */
var appAccessToken = '846503530449488|567929bb562b7b0af23868c0e3769828';
...
var loginURLPrefixes = ['https://www.internalfb.com/login', 'https://www.internalfb.com/intern/login', 'https://www.internalfb.com/intern/auth', 'https://www.internalfb.com/intern/mdm', 'https://www.internalfb.com/intern/fbz/run/request/certs/', 'https://www.internalfb.com/intern/security/sks_oauth/'];
var BETA_CHROME_ID = 'kmmebalcngjbbeiiagcjhmkeanmjpglc';
var PRODUCTION_CHROME_ID = 'iilloeljhmkmakgkcahhghoaofbikgne';
var BATCHEXECUTE_U1T5P = 'batchexecute_U1t5p';
            ...
            case 0:
              return _context.abrupt("return", new Promise(function (resolve) {
                _this.storage.local.get(CONFIG_TOKEN_KEY, function (res) {
                  ...
                  consoleDebug("Stored config: ".concat((_JSON$stringify = JSON.stringify(configCache)) !== null && _JSON$stringify !== void 0 ? _JSON$stringify : ''));
                  resolve(configCache);
                });
              }));
            case 1:
...
var OdsStorage = /*#__PURE__*/function () {
  function OdsStorage(storage) {
    classCallCheck_classCallCheck(this, OdsStorage);
    defineProperty_defineProperty(this, "storage", void 0);
    this.storage = storage;
  }
  createClass_createClass(OdsStorage, [{
    key: "addOdsEntries",
    value: function () {
      var _addOdsEntries = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(entries) {
        var _this3 = this;
            ...
            case 0:
              ...
              return new Promise(function (resolve) {
                _this3.storage.local.get(ODS_ENTRIES_TOKEN_KEY, function (res) {
                  ...
                  _this3.storage.local.set(defineProperty_defineProperty({}, ODS_ENTRIES_TOKEN_KEY, [].concat(_toConsumableArray(odsEntries), _toConsumableArray(entries))), function () {
    ...
    key: "getOdsEntries",
    value: function () {
      var _getOdsEntries = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        var _this4 = this;
    ...
    key: "clearOdsEntries",
    value: function () {
      var _clearOdsEntries = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
        var _this5 = this;
...
var TabStorage = /*#__PURE__*/function () {
  function TabStorage(storage) {
    classCallCheck_classCallCheck(this, TabStorage);
    defineProperty_defineProperty(this, "storage", void 0);
    this.storage = storage;
  }
  createClass_createClass(TabStorage, [{
    key: "getTabData",
    value: function () {
      var _getTabData = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(tabId) {
        var _this6 = this;
        var tabIdStr;
    ...
    key: "storeTabData",
    value: function () {
      var _storeTabData = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(tabId, data) {
        var _this7 = this;
        var tabIdStr;
          ...
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              return new Promise(function (resolve) {
                // $FlowFixMe[prop-missing]: flow-interfaces-chrome is not aware of sessions which is new storage area
                // $FlowFixMe[incompatible-use]
                _this7.storage.session.set(defineProperty_defineProperty({}, tabIdStr, JSON.stringify(data)), function () {
 ...
 */
var UsernameStorage = /*#__PURE__*/function () {
  function UsernameStorage(storage) {
    classCallCheck_classCallCheck(this, UsernameStorage);
    defineProperty_defineProperty(this, "storage", void 0);
    this.storage = storage;
  }
  createClass_createClass(UsernameStorage, [{
    key: "getUsernameData",
    value: function () {
      var _getUsernameData = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8() {
        var _this8 = this;
        var uuid;
    ...
    key: "storeUsername",
    value: function () {
      var _storeUsername = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(username) {
        var _this9 = this;
    ...
    key: "getUuid",
    value: function () {
      var _getUuid = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10() {
        var _this10 = this;
    ...
    key: "storeUuid",
    value: function () {
      var _storeUuid = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11(uuid) {
        var _this11 = this;
...
var OdsClient = /*#__PURE__*/function () {
  function OdsClient(env, odsStorage) {
    classCallCheck_classCallCheck(this, OdsClient);
    defineProperty_defineProperty(this, "entity", void 0);
    defineProperty_defineProperty(this, "odsStorage", void 0);
  ...
  createClass_createClass(OdsClient, [{
    key: "bumpKey",
    value: function () {
      var _bumpKey = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(key) {
        var value;
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "addDataPoint",
    value: function () {
      var _addDataPoint = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(key, value) {
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
    ...
    key: "post",
    value: function () {
      var _post = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
    ...
    key: "postData",
    value: function () {
      var _postData = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(datapoints) {
...
var ServerMessageSender = /*#__PURE__*/function () {
  function ServerMessageSender(extensionId, extensionVersion, usernameStorage, tabStorage, odsClient) {
    classCallCheck_classCallCheck(this, ServerMessageSender);
    defineProperty_defineProperty(this, "extensionId", void 0);
    defineProperty_defineProperty(this, "extensionVersion", void 0);
    defineProperty_defineProperty(this, "usernameStorage", void 0);
    defineProperty_defineProperty(this, "tabStorage", void 0);
    defineProperty_defineProperty(this, "odsClient", void 0);
  ...
  createClass_createClass(ServerMessageSender, [{
    key: "sendMessage",
    ...
    key: "doAsyncJobs",
    value: function () {
      var _doAsyncJobs = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(message) {
        var usernameData;
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "sendLogToServer",
    value: function () {
      var _sendLogToServer = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(message, usernameData) {
    ...
    key: "getUsernameData",
    value: function () {
      var _getUsernameData = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
        var data, username;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
    ...
    value: function () {
      var _getUsernameFromCsrinfo = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = errors_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
function _callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, errors_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
var CSRFNotOKStatus = /*#__PURE__*/function (_Error) {
  _inherits(CSRFNotOKStatus, _Error);
  function CSRFNotOKStatus(message) {
    var _this;
    classCallCheck_classCallCheck(this, CSRFNotOKStatus);
    _this = _callSuper(this, CSRFNotOKStatus, [message]);
    _this.name = 'CSRFNotOKStatus';
    return _this;
  }
  return createClass_createClass(CSRFNotOKStatus);
}( /*#__PURE__*/_wrapNativeSuper(Error));
var CSRFEmptyBody = /*#__PURE__*/function (_Error2) {
  _inherits(CSRFEmptyBody, _Error2);
  function CSRFEmptyBody(message) {
    var _this2;
    classCallCheck_classCallCheck(this, CSRFEmptyBody);
    _this2 = _callSuper(this, CSRFEmptyBody, [message]);
    _this2.name = 'CSRFEmptyBody';
    return _this2;
  }
  return createClass_createClass(CSRFEmptyBody);
}( /*#__PURE__*/_wrapNativeSuper(Error));
/*
 ...
 */
function getServerErrorType(response) {
...
var CONFIG_CACHE_TTL_MIN = 1; // 1 minute
var CONFIG_CACHE_TTL_MS = CONFIG_CACHE_TTL_MIN * 1000 * 60; // 1 minute
var CONFIG_CACHE_MIN_FRESHNESS_MS = CONFIG_CACHE_TTL_MS * 5; // 5 minutes

var ConfigLoaderContentScript = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  function ConfigLoaderContentScript(chrome, storage) {
    _classCallCheck(this, ConfigLoaderContentScript);
  ...
  _createClass(ConfigLoaderContentScript, [{
    key: "getCachedConfiguration",
    value: function () {
      var _getCachedConfiguration = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
...
var ConfigLoader = /*#__PURE__*/function () {
  function ConfigLoader(storage, senderToServer, odsClient) {
    classCallCheck_classCallCheck(this, ConfigLoader);
    defineProperty_defineProperty(this, "storage", void 0);
    defineProperty_defineProperty(this, "senderToServer", void 0);
    defineProperty_defineProperty(this, "odsClient", void 0);
    this.storage = storage;
  ...
  createClass_createClass(ConfigLoader, [{
    key: "getConfiguration",
    value: function () {
      var _getConfiguration = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
...
function _getCSRF() {
  _getCSRF = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(storage) {
...
function _setDTSGStorage() {
  _setDTSGStorage = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(storage, dtsg) {
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return new Promise(function (resolve) {
            // $FlowFixMe[prop-missing]: flow-interfaces-chrome is not aware of sessions which is new storage area
            // $FlowFixMe[incompatible-use]
            storage.session.set(defineProperty_defineProperty({}, DTSG_KEY, JSON.stringify(dtsg)), function () {
...
function _getDTSGStorage() {
  _getDTSGStorage = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(storage) {
    return regenerator.wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
...
var PolicyChecker = /*#__PURE__*/function () {
  ...
  createClass_createClass(PolicyChecker, [{
    key: "checkRecipients",
    value: function () {
      var _checkRecipients = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(sessionUUID, recipients) {
        var response;
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "checkResources",
    value: function () {
      var _checkResources = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(sessionUUID, resourceIDs) {
        var response;
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
    ...
    key: "executeRequest",
    value: function () {
      var _executeRequest = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(request) {
...
var DriveCreator = /*#__PURE__*/function () {
  ...
  createClass_createClass(DriveCreator, [{
    key: "createSharedDrive",
    value: function () {
      var _createSharedDrive = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(request) {
...
var ServiceWorker = /*#__PURE__*/function () {
  function ServiceWorker(chrome) {
    classCallCheck_classCallCheck(this, ServiceWorker);
    defineProperty_defineProperty(this, "version", void 0);
    defineProperty_defineProperty(this, "enabled", void 0);
    defineProperty_defineProperty(this, "chrome", void 0);
    defineProperty_defineProperty(this, "senderToServer", void 0);
    defineProperty_defineProperty(this, "configLoader", void 0);
    defineProperty_defineProperty(this, "policyChecker", void 0);
    defineProperty_defineProperty(this, "driveCreator", void 0);
    defineProperty_defineProperty(this, "odsClient", void 0);
    defineProperty_defineProperty(this, "tabStorage", void 0);
    ...
    var env = chrome.runtime.id === PRODUCTION_CHROME_ID ? ENV_PROD : ENV_BETA;
  ...
  createClass_createClass(ServiceWorker, [{
    ...
    key: "loadConfig",
    value: function () {
      var _loadConfig = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        var configData;
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
    ...
    value: function () {
      var _createConfigAlarm = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
        var configAlarm;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
    ...
    key: "createOdsAlarm",
    value: function () {
      var _createOdsAlarm = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        var odsAlarm;
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
    ...
    key: "getAccount",
    value: function () {
      var _getAccount = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(tabId, messageType) {
        var tabData;
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
    ...
    key: "messageHandler",
    value: function () {
      var _messageHandler = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(message, sender, sendResponse) {
        var _sender$tab;

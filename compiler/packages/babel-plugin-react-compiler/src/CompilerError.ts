...
export enum ErrorCategory {
  ...
  // Checking for non-React functions acting as factories for components/hooks
  Factories = 'Factories',
  ...
  switch (category) {
    ...
    case ErrorCategory.Factories: {
      return {
        ...
        description:
          'Validates against non-React functions defining nested components or hooks. ' +
          'Components and hooks should be defined at the module level or within other React functions to ensure proper compilation',
        recommended: true,
      };
    }

...
export function mergeLocation(l: SourceLocation, r: SourceLocation): SourceLocation {
...
export function mayAllocate(env: Environment, instruction: Instruction, conservative: boolean): boolean {
...
export function collectMutableOperands(fn: HIRFunction, instr: Instruction, conservative: boolean): Array<Identifier> {

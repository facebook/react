...
function Component(props) {
  ...
  if ($[4] !== props.methodCall) {
    t2 = { "Component[SharedRuntime.identity(arg0)]": () => props.methodCall }[
      "Component[SharedRuntime.identity(arg0)]"
    ];
    $[4] = props.methodCall;
    $[5] = t2;
  } else {

...
> 20 |   useEffect(f);
     |   ^^^^^^^^^^^^ InvalidReact: [Fire] Untransformed reference to compiler-required feature. Either remove this call or ensure it is successfully transformed by the compiler (20:20)
  21 | }
  22 |
```

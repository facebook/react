...
export const FIXTURE_ENTRYPOINT = {
  fn: Component,
  params: [{a: {value: 'A'}, b: {first: 'B1', second: 'B2'}, cond: true, items: [1, 2, 3]}],
  sequentialRenders: [
    {a: {value: 'A'}, b: {first: 'B1', second: 'B2'}, cond: true, items: [1, 2, 3]},
    {a: {value: 'A'}, b: {first: 'B1', second: 'B2'}, cond: true, items: [1, 2, 3]},
    {a: {value: 'A'}, b: {first: 'B1', second: 'B2'}, cond: false, items: [1, 2]},
    ...
    {a: {value: ''}, b: {first: 'B1', second: 'B2'}, cond: true, items: [1, 2, 3, 4]},
  ],
};

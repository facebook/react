  ...
  for (const suppressionRange of suppressionRanges) {
    ...
    error.pushDiagnostic(
      CompilerDiagnostic.create({
        category: reason,
        description: `React Compiler only works when your components follow all the rules of React, disabling them may result in unexpected or incorrect behavior. Found suppresion \`${suppressionRange.disableComment.value.trim()}\``,

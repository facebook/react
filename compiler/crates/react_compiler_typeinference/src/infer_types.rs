...
use react_compiler_hir::LoweredFunction;
...
use react_compiler_hir::PropertyNameKind;
...
use react_compiler_hir::TypeId;
use react_compiler_hir::environment::Environment;
use react_compiler_hir::environment::is_hook_name;
use react_compiler_hir::object_shape::BUILT_IN_ARRAY_ID;
use react_compiler_hir::object_shape::BUILT_IN_FUNCTION_ID;
use react_compiler_hir::object_shape::BUILT_IN_JSX_ID;
use react_compiler_hir::object_shape::BUILT_IN_MIXED_READONLY_ID;
use react_compiler_hir::object_shape::BUILT_IN_OBJECT_ID;
use react_compiler_hir::object_shape::BUILT_IN_PROPS_ID;
use react_compiler_hir::object_shape::BUILT_IN_REF_VALUE_ID;
use react_compiler_hir::object_shape::BUILT_IN_SET_STATE_ID;
use react_compiler_hir::object_shape::BUILT_IN_USE_REF_ID;
use react_compiler_hir::object_shape::ShapeRegistry;
    ...
    let shape_id = match resolved_object {
        ...
        _ => {
            ...
            if let Some(hook_type) = custom_hook_type {
                ...
                {
                    if is_hook_name(s.as_str_unwrap()) {
                        ...
                        ArrayPatternElement::Place(place) => {
                            ...
                            unifier.unify(
                                ...
                                Type::Property {
                                    ...
                                    object_name,
                                    property_name: PropertyNameKind::Literal {
                                        value: PropertyLiteral::String(JsString::from(
                                            i.to_string(),
                                        )),
                                    },
                                },

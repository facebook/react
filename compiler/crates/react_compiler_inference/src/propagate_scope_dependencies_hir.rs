...
use react_compiler_hir::ReactiveScopeDependency;
use react_compiler_hir::ScopeId;
use react_compiler_hir::Terminal;
use react_compiler_hir::Type;
use react_compiler_hir::environment::Environment;
use react_compiler_hir::visitors;
use react_compiler_hir::visitors::ScopeBlockInfo;
use react_compiler_hir::visitors::ScopeBlockTraversal;
...
impl<'a> DependencyCollectionContext<'a> {
    ...
    fn visit_dependency(&mut self, dep: ReactiveScopeDependency, env: &mut Environment) {
        ...
        let dep = if react_compiler_hir::is_use_ref_type(
            ...
            .first()
            .map(|p| {
                p.property == PropertyLiteral::String(react_compiler_hir::JsString::from("current"))
            })
            .unwrap_or(false)
        {
            ReactiveScopeDependency {

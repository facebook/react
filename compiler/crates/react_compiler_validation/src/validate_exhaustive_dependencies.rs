...
use react_compiler_diagnostics::CompilerSuggestion;
use react_compiler_diagnostics::CompilerSuggestionOperation;
...
use react_compiler_hir::visitors::each_instruction_value_lvalue;
use react_compiler_hir::visitors::each_instruction_value_operand_with_functions;

...
use react_compiler_hir::AliasingEffect;
...
use react_compiler_hir::visitors::each_instruction_value_operand as canonical_each_instruction_value_operand;
use react_compiler_hir::visitors::each_pattern_operand;
use react_compiler_hir::visitors::each_terminal_operand;
            ...
            match &instr.value {
                ...
                InstructionValue::PropertyLoad {
                    ...
                    if is_ref_type(object.identifier, identifiers, types)
                        && *property == PropertyLiteral::String(JsString::from("current"))
                    {
                        continue;
                    }
                    let temp = env

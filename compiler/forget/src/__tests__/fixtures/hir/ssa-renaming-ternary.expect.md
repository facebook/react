...
```javascript
bb0 (block):
  [1] store $30[1:7] = Array []
  [2] store $32[2:7] = StoreLocal Let mutate x$31[2:7] = capture $30[1:7]
  [3] mutate $33[3:7] = LoadLocal capture x$31[2:7]
  [4] mutate $34 = LoadLocal read props$29
  [5] mutate $35 = PropertyLoad read $34.bar
  [6] mutate $36 = PropertyCall mutate $33[3:7].push(read $35)
...
bb3 (value):
  ...
  [13] store $42[13:19] = Array []
  [14] store $44[14:19] = StoreLocal Reassign mutate x$31[14:19] = capture $42[13:19]
  [15] mutate $45[15:19] = LoadLocal capture x$31[14:19]
  [16] mutate $46 = LoadLocal read props$29
  [17] mutate $47 = PropertyLoad read $46.foo
  [18] mutate $48[18:28] = PropertyCall mutate $45[15:19].push(read $47)
...
bb1 (block):
  ...
  x$31:TPhi: phi(bb3: x$31, bb4: x$31)

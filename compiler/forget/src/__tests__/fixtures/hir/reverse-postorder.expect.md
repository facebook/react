...
bb2:
  ...
  [6] Switch (read props$6.test)
    Case read $10_@4:TPrimitive: bb8
    Case read $9_@3:TPrimitive: bb6
    Case read $8_@2:TPrimitive: bb4
    Default: bb4
    Fallthrough: bb1
bb8:
  ...
  scope @1 [2:18] deps=[read props$6.v2, read props$6.v1, read props$6.v0, read props$6.test, read props$6.b, read props$6.c, read props$6.cond2, read props$6.cond] {
    ...
    if (read props$6.cond) {
      ...
      switch (read props$6.test) {
        case read $10_@4:TPrimitive: {
            [7] Reassign mutate x$11_@1:TProp[2:18] = read props$6.v0
            break bb1
        }
        case read $9_@3:TPrimitive: {
            [9] Reassign mutate x$11_@1:TProp[2:18] = read props$6.v1
            break bb1
        }
        case read $8_@2:TPrimitive: {
        }
        default: {
            [11] Reassign mutate x$11_@1:TProp[2:18] = read props$6.v2
        }

...
```
bb0:
  [1] Const mutate a$9_@0[1:4] = Call mutate compute$3(read props$8.a)
  [2] Const mutate b$10_@0[1:4] = Call mutate compute$3(read props$8.b)
  [3] Call mutate foo$5(mutate a$9_@0, mutate b$10_@0)

 ...
 *
 * @providesModule ReactElementValidatorDev
 */
...
var ReactElementValidatorDev = {};

if (__DEV__) {
  var getDeclarationErrorAddendum = function() {
  ...
  var getCurrentComponentErrorInfo = function(parentType) {
  ...
  var validateExplicitKey = function(element, parentType) {
    ...
    warning(
      ...
      childOwner,
      ReactComponentTreeDevtoolDev.getCurrentStackAddendum(element)
    );
  };
   ...
   */
  var validateChildKeys = function(node, parentType) {
   ...
   */
  var validatePropTypes = function(element) {
  ...
  ReactElementValidatorDev = {
    ...
    createFactory: function(type) {
      var validatedFactory = ReactElementValidatorDev.createElement.bind(
        null,
        type
      );
...
module.exports = ReactElementValidatorDev;

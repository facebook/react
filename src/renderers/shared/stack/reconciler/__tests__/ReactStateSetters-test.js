...
describe('ReactStateSetters', function() {
  ...
  pit('createStateSetter should update state', async function() {
  ...
  pit('createStateKeySetter should update state', async function() {
    var instance = <TestComponent />;
    instance = await ReactTestUtils.renderIntoDocumentAsync(instance);
    expect(instance.state).toEqual({foo: 'foo'});
  ...
  pit('createStateKeySetter is memoized', async function() {
    var instance = <TestComponent />;
    instance = await ReactTestUtils.renderIntoDocumentAsync(instance);
    expect(instance.state).toEqual({foo: 'foo'});
  ...
  pit('createStateSetter should update state from mixin', async function() {
  ...
  pit('createStateKeySetter should update state with mixin', async function() {
    var instance = <TestComponentWithMixin />;
    instance = await ReactTestUtils.renderIntoDocumentAsync(instance);
    expect(instance.state).toEqual({foo: 'foo'});
  ...
  pit('createStateKeySetter is memoized with mixin', async function() {
    var instance = <TestComponentWithMixin />;
    instance = await ReactTestUtils.renderIntoDocumentAsync(instance);
    expect(instance.state).toEqual({foo: 'foo'});

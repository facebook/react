...
describe('ReactHostOperationHistoryDevtoolDev', () => {
  var React;
  var ReactPerfDev;
  var ReactDOM;
  ...
  beforeEach(() => {
    ...
    ReactHostOperationHistoryDevtoolDev = require('ReactHostOperationHistoryDevtoolDev');
  ...
  function assertHistoryMatches(expectedHistory) {
    var actualHistory = ReactHostOperationHistoryDevtoolDev.getHistory();
  ...
  describe('mount', () => {
    it('gets recorded for host roots', () => {
      ...
      ReactHostOperationHistoryDevtoolDev._preventClearing = true;

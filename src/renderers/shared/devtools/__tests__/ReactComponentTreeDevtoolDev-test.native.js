...
describe('ReactComponentTreeDevtoolDev', () => {
  ...
  it('reports update counts', () => {
    ...
    var viewID = ReactComponentTreeDevtoolDev.getRootIDs()[0];
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(viewID)).toEqual(0);

    ReactNative.render(<Image />, 1);
    var imageID = ReactComponentTreeDevtoolDev.getRootIDs()[0];
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(viewID)).toEqual(0);
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(imageID)).toEqual(0);

    ReactNative.render(<Image />, 1);
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(viewID)).toEqual(0);
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(imageID)).toEqual(1);

    ReactNative.render(<Image />, 1);
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(viewID)).toEqual(0);
    expect(ReactComponentTreeDevtoolDev.getUpdateCount(imageID)).toEqual(2);

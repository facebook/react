...
describe('ReactIncrementalSideEffects', () => {
  ...
  it('calls componentWillUnmount after a deletion when children has single node', () => {
  ...
  it('calls componentWillUnmount after a deletion when children has multiple nodes', () => {

...
import {
  setEnabled as setEventListenerEnabled,
  isEnabled as isEventListenerEnabled,
  trapBubbledEvent,
  trapCapturedEvent,
...
export function setEnabled(enabled) {
  setEventListenerEnabled(enabled);
}

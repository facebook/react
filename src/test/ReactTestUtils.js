...
var ReactTestUtils = {
   ...
   * @return {!ReactDOMNativeComponent} The one match.
   */
  ...
  /**
   * Simulates a top level event being dispatched from a raw event that occured
   * on the `ReactDOMNativeComponent` `comp`.
   * @param topLevelType {Object} A type from `EventConstants.topLevelTypes`.
   * @param comp {!ReactDOMNativeComponent}
   * @param {?Event} fakeNativeEvent Fake native event to use in SyntheticEvent.
   */
 ...
 * Exports:
 *
 * - `ReactTestUtils.Simulate.click(Element/ReactDOMNativeComponent)`
 * - `ReactTestUtils.Simulate.mouseMove(Element/ReactDOMNativeComponent)`
 * - `ReactTestUtils.Simulate.mouseIn/ReactDOMNativeComponent)`
 * - `ReactTestUtils.Simulate.mouseOut(Element/ReactDOMNativeComponent)`
...
for (eventType in topLevelTypes) {
  ...
  /**
   * @param {!Element || ReactDOMNativeComponent} domComponentOrNode

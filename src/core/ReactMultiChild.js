...
function processQueue() {
  if (updateQueue.length) {
    ReactComponent.IDOperations.dangerouslyProcessChildrenUpdates(
      updateQueue,
      markupQueue
    );
    clearQueue();
...
var ReactMultiChild = {
   ...
   * children. This is used by `ReactDOMNativeComponent` to mount, update, and
  ...
  Mixin: {
     ...
     * of `ReactDOMNativeComponent`, a mount image is a string of markup.
     *

...
function validateMethodOverride(proto, name) {
  ...
  if (ReactCompositeComponentMixin.hasOwnProperty(name)) {
    invariant(
      specPolicy === ReactSpecPolicy.OVERRIDE_BASE,
  ...
  if (proto.hasOwnProperty(name)) {
    invariant(
      specPolicy === ReactSpecPolicy.DEFINE_MANY ||
      specPolicy === ReactSpecPolicy.DEFINE_MANY_MERGED,
    ...
    if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
      ...
      if (shouldAutoBind) {
        ...
        if (isAlreadyDefined) {
          ...
          if (specPolicy === ReactSpecPolicy.DEFINE_MANY_MERGED) {
            proto[name] = createMergedResultFunction(proto[name], property);
          } else if (specPolicy === ReactSpecPolicy.DEFINE_MANY) {

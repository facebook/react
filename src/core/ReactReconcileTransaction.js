...
var EVENT_SUPPRESSION = {
  /**
   * @return {boolean} The enabled status of `ReactDOMEventEmitter` before the
   * reconciliation.
   */
  initialize: function() {
    var currentlyEnabled = ReactDOMEventEmitter.isEnabled();
    ReactDOMEventEmitter.setEnabled(false);
    return currentlyEnabled;
  },

  /**
   * @param {boolean} previouslyEnabled Enabled status of `ReactDOMEventEmitter`
   *   before the reconciliation occured. `close` restores the previous value.
   */
  close: function(previouslyEnabled) {
    ReactDOMEventEmitter.setEnabled(previouslyEnabled);
  }
};

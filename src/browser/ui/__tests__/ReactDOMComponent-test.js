  ...
  describe('mountComponent', function() {
    ...
    beforeEach(function() {
      ...
      mountComponent = function(props) {
        ...
        return stubComponent.mountComponent(null, 'test', transaction, {});
      };
    });
  ...
  describe('nesting validation', function() {
    ...
    it('warns on invalid nesting', () => {
      ...
      expect(console.error.calls[0].args[0]).toBe(
        ...
        '<div> in this context (div > div > tr).'
      );
    });
    ...
    it('warns nicely for table rows', () => {
      ...
      expect(console.error.calls[0].args[0]).toBe(
        'Warning: validateDOMNesting(...): <tr> cannot appear as a child of ' +
        '<table> in this context (div > Foo > table > Row > tr). Add a ' +
        '<tbody> to your code to match the DOM tree generated by the browser.'
      );
    });
  });

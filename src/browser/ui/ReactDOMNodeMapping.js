...
function getReactRootID(container) {
  var rootElement = ReactDOMNodeMapping.getReactRootElementInContainer(container);
  return rootElement && ReactDOMNodeMapping.getID(rootElement);
}
 ...
 *
 *   ReactDOMNodeMapping.renderComponent(
 *     component,
...
var ReactDOMNodeMapping = {
  ...
  _registerComponent: function(nextComponent, container) {
    ...
    var reactRootID = ReactDOMNodeMapping.registerContainer(container);
  ...
  unmountComponentAtNode: function(container) {
    ...
    ReactDOMNodeMapping.unmountComponentFromNode(component, container);
  ...
  getInstanceFromContainer: function(container) {
    return instancesByReactRootID[getReactRootID(container)];
  },

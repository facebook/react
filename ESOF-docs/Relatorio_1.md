...
Note-se que a frase surge na sequência de uma discussão iniciada pelos autores deste relatório no fórum [React Discuss](https://discuss.reactjs.org/t/react-development-process/2135).

...
É essencial a implementação de um sistema de organização dos *issues* e dos *pull requests*. Para tal, são usados os sistemas de etiquetas e de *milestones*, disponibilizados pelo GitHub, de forma a classificar os vários requisitos. Deste modo, estabelecem-se prioridades que permitem delinear, com maior clareza, o rumo que o projeto deverá seguir. Estas prioridades são definidas pela *core team*, que se organiza em reuniões entre os seus elementos, traçando, a médio prazo, a orientação do projeto, como será descrito adiante.

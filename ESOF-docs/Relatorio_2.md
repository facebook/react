...
Um projeto deve iniciar-se com um levantamento dos requisitos, que será a matéria primária para a elaboração do mesmo. Esta função é partilhada pelos *stakeholders*, a comunidade que tem influência na elaboração dos requisitos, mas também por qualquer colaborador individual que, por sua vez, envie um *pull request* com a sua ideia.

    ...
    if (6 === exitStatus) markRootSuspended(root, lanes);
      ...
      if (
        ...
        if (2 === exitStatus) {
          ...
          var errorRetryLanes$170 = getLanesToRetrySynchronouslyOnError(
            root,
            errorRetryLanes
          );
          0 !== errorRetryLanes$170 &&
            ((lanes = errorRetryLanes$170),
            (exitStatus = recoverFromConcurrentError(
              root,
              errorRetryLanes,
              errorRetryLanes$170
      ...
      switch (exitStatus) {
        ...
        case 4:
          ...
          for (errorRetryLanes$170 = -1; 0 < exitStatus; ) {
            var index$8 = 31 - clz32(exitStatus),
              lane = 1 << index$8;
            index$8 = errorRetryLanes[index$8];
            index$8 > errorRetryLanes$170 && (errorRetryLanes$170 = index$8);
            exitStatus &= ~lane;
          }
          exitStatus = errorRetryLanes$170;
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    if (!isSupported$jscomp$inline_1525) {
      var element$jscomp$inline_1526 = document.createElement("div");
      element$jscomp$inline_1526.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1525 =
        "function" === typeof element$jscomp$inline_1526.oninput;
    }
    JSCompiler_inline_result$jscomp$298 = isSupported$jscomp$inline_1525;
...
for (
  var i$jscomp$inline_1566 = 0;
  i$jscomp$inline_1566 < simpleEventPluginEvents.length;
  i$jscomp$inline_1566++
) {
  var eventName$jscomp$inline_1567 =
      simpleEventPluginEvents[i$jscomp$inline_1566],
    domEventName$jscomp$inline_1568 =
      eventName$jscomp$inline_1567.toLowerCase(),
    capitalizedEvent$jscomp$inline_1569 =
      eventName$jscomp$inline_1567[0].toUpperCase() +
      eventName$jscomp$inline_1567.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1568,
    "on" + capitalizedEvent$jscomp$inline_1569
  );
}
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var key$207 = getStyleKey(pendingProps.href),
          styles$208 = getResourcesFromRoot(currentProps).hoistableStyles;
        type = styles$208.get(key$207);
        type ||
          ((currentProps = currentProps.ownerDocument || currentProps),
          (type = { type: "stylesheet", instance: null, count: 0 }),
          styles$208.set(key$207, type),
          preloadPropsMap.has(key$207) ||
            ((pendingProps = {
              rel: "preload",
              as: "style",
            ...
            preloadPropsMap.set(key$207, pendingProps),
            currentProps.querySelector(getStylesheetSelectorFromKey(key$207)) ||
              null !==
                currentProps.querySelector(
                  'link[rel="preload"][as="style"][' + key$207 + "]"
                ) ||
              ((key$207 = currentProps.createElement("link")),
              setInitialProperties(key$207, "link", pendingProps),
              markNodeAsHoistable(key$207),
              currentProps.head.appendChild(key$207))));
        return type;
      }
      return null;
    case "script":
...
var devToolsConfig$jscomp$inline_1745 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-5315d9ff",
...
var internals$jscomp$inline_2143 = {
  ...
  reconcilerVersion: "18.3.0-www-modern-5315d9ff"
};
...
exports.version = "18.3.0-www-modern-5315d9ff";

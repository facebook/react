...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$365 = isSupported$jscomp$inline_1533;
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      return;
    case "select":
      defaultValue = value = propKey = propKey$215 = null;
      ...
      updateSelect(domElement, propKey$215, propKey, value, defaultValue);
      return;
    case "textarea":
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2104.isDisabled &&
    hook$jscomp$inline_2104.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2104.inject(
        internals$jscomp$inline_2103
      )),
        (injectedHook = hook$jscomp$inline_2104);
    } catch (err) {}
}

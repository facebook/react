...
var internals$jscomp$inline_2685 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2686 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2686.isDisabled &&
    hook$jscomp$inline_2686.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2686.inject(
        internals$jscomp$inline_2685
      )),
        (injectedHook = hook$jscomp$inline_2686);
    } catch (err) {}
}

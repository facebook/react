...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$290 = isSupported$jscomp$inline_419;
...
function renderRootSync(root, lanes) {
  ...
  a: do
    try {
      ...
      workLoopSync();
      break;
    } catch (thrownValue$264) {
      handleThrow(root, thrownValue$264);
    }
  while (1);
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    executionContext |= 4;
    ReactCurrentOwner.current = null;
    var shouldFireAfterActiveInstanceBlur$270 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitMutationEffectsOnFiber(finishedWork, root);
    shouldFireAfterActiveInstanceBlur$270 &&
      ((_enabled = !0),
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$271 = rootWithPendingPassiveEffects,
    ...
    try {
      ...
      (currentUpdatePriority = previousPriority),
        (ReactCurrentBatchConfig$1.transition = prevTransition),
        releaseRootPooledCache(root$271, remainingLanes);
    }
  }
  return !1;
}
...
function attemptSynchronousHydration(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$273 = fiber.stateNode;
      if (root$273.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$273.pendingLanes);
        0 !== lanes &&
          (upgradePendingLanesToSync(root$273, lanes),
          ensureRootIsScheduled(root$273),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now() + 500),
            flushSyncWorkAcrossRoots_impl(!1)));
      }
...
var devToolsConfig$jscomp$inline_1677 = {
  ...
  bundleType: 0,
  version: "19.0.0-www-modern-d22be4c7",
  rendererPackageName: "react-dom"
};
var internals$jscomp$inline_2101 = {
  ...
  reconcilerVersion: "19.0.0-www-modern-d22be4c7"
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2102 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2102.isDisabled &&
    hook$jscomp$inline_2102.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2102.inject(
        internals$jscomp$inline_2101
      )),
        (injectedHook = hook$jscomp$inline_2102);
    } catch (err) {}
}
...
exports.version = "19.0.0-www-modern-d22be4c7";

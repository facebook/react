...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$378 = isSupported$jscomp$inline_1605;
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
            ...
            case "type":
              ...
              propKey !== lastProp &&
                ...
                "boolean" !== typeof propKey
                  ? domElement.setAttribute(propKey$219, propKey)
                  : domElement.removeAttribute(propKey$219));
              break;
            case "name":
              name = propKey;
              break;
    ...
    case "option":
      for (var propKey$237 in lastProps)
        if (
          ((propKey$219 = lastProps[propKey$237]),
    ...
    case "menuitem":
      for (var propKey$242 in lastProps)
        (propKey$219 = lastProps[propKey$242]),
          lastProps.hasOwnProperty(propKey$242) &&
            null != propKey$219 &&
            !nextProps.hasOwnProperty(propKey$242) &&
            setProp(domElement, tag, propKey$242, null, nextProps, propKey$219);
    ...
    default:
      if (isCustomElement(tag)) {
        for (var propKey$247 in lastProps)
          (propKey$219 = lastProps[propKey$247]),
  ...
  for (var propKey$252 in lastProps)
    (propKey$219 = lastProps[propKey$252]),
      lastProps.hasOwnProperty(propKey$252) &&
        null != propKey$219 &&
        !nextProps.hasOwnProperty(propKey$252) &&
        setProp(domElement, tag, propKey$252, null, nextProps, propKey$219);
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$280 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$280);
          if (resource) break;
          var state = { loading: 0, preload: null };
          if (
            (resource = resourceRoot.querySelector(
              getStylesheetSelectorFromKey(key$280)
            ))
          )
            state.loading = 1;
          else {
            ...
            (options = preloadPropsMap.get(key$280)) &&
          ...
          as.set(key$280, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$280 = getScriptKey(href)),
            (precedence = as.get(key$280)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$280
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$280, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$280 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$280 =
          'link[rel="preload"][as="' + as + '"][href="' + key$280 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$280) &&
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$289 = getResourcesFromRoot(currentProps).hoistableStyles,
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        setInitialProperties(instance$295, "link", key);
...
var devToolsConfig$jscomp$inline_1814 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-d8cd2d94",
...
var internals$jscomp$inline_2194 = {
  ...
  reconcilerVersion: "18.3.0-www-modern-d8cd2d94"
};
...
exports.version = "18.3.0-www-modern-d8cd2d94";

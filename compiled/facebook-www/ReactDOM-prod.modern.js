...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2556.isDisabled &&
    hook$jscomp$inline_2556.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2556.inject(
        internals$jscomp$inline_2555
      )),
        (injectedHook = hook$jscomp$inline_2556);
    } catch (err) {}
}

...
var ReactVersion = '19.0.0-www-modern-6d3110b4d9-20240531';
...
var Surface = /*#__PURE__*/function (_React$Component) {
  ...
  _proto4.componentDidMount = function componentDidMount() {
    ...
    this._mountNode = createContainer(this._surface, ConcurrentRoot , null, false, false, ''); // We synchronously flush updates coming from above so that they commit together

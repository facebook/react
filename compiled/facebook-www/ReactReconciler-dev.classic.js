  ...
  ((module.exports = function ($$$config) {
    ...
    function finishRenderingHooks(current, workInProgress) {
      ...
      null === current ||
        ...
        (!disableLegacyMode && (current.mode & 1) === NoMode) ||
        error$jscomp$0(
    ...
    function markSuspenseBoundaryShouldCapture(
      ...
      if (!disableLegacyMode && (suspenseBoundary.mode & 1) === NoMode)
        return (
    ...
    function throwException(
      ...
      if (
        ...
        isHydrating &&
          (disableLegacyMode || sourceFiber.mode & 1) &&
    ...
    function updateOffscreenComponent(current, workInProgress, renderLanes) {
      ...
      if (
        ...
        if (disableLegacyMode || (workInProgress.mode & 1) !== NoMode)
          ...
          workInProgress.flags & 256
            ...
            : null !== workInProgress.memoizedState
              ...
              : (reuseSuspenseHandlerOnStack(workInProgress),
                ...
                (disableLegacyMode || (workInProgress.mode & 1) !== NoMode) &&
                  reconcileChildFibers(
                    workInProgress,
                    current.child,
                    null,
    ...
    function commitLayoutEffectOnFiber(
      ...
      switch (finishedWork.tag) {
        ...
        case 13:
          ...
          break;
        case 22:
          if (disableLegacyMode || (finishedWork.mode & 1) !== NoMode) {
            if (
              ((prevState =
        ...
        case 5:
          ...
          if (supportsMutation) {
            ...
            if (flags & 4 && ((root = finishedWork.stateNode), null != root)) {
              ...
              try {
                commitUpdate(root, hoistableRoot, current, lanes, finishedWork);
              } catch (error$30) {
                captureCommitPhaseError(
                  finishedWork,
                  finishedWork.return,
          ...
          if (
            ...
            suspenseCallback &&
              ...
              null === current ||
                retryQueue ||
                root ||
                ((disableLegacyMode || (finishedWork.mode & 1) !== NoMode) &&
            ...
            switch (parentFiber.tag) {
              ...
              case 5:
                ...
                parentFiber.flags & 32 &&
                  (resetTextContent(_parent), (parentFiber.flags &= -33));
    ...
    function commitHookPassiveMountEffects(finishedWork, hookFlags) {
      if (shouldProfile(finishedWork)) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$38);
        }
      ...
      switch (fiber.tag) {
        ...
        case 15:
          try {
            ...
            captureCommitPhaseError(fiber, fiber.return, error$43);
          }
          break;
        case 1:
          var instance = fiber.stateNode;
      ...
      switch (fiber.tag) {
        ...
        case 15:
          try {
            ...
            captureCommitPhaseError(fiber, fiber.return, error$44);
          }
      }
    }
    ...
    function isLegacyActEnvironment() {
      var isReactActEnvironmentGlobal =
          "undefined" !== typeof IS_REACT_ACT_ENVIRONMENT
            ...
            : void 0,
        jestIsDefined = "undefined" !== typeof jest;
      return (
        warnsIfNotActing && jestIsDefined && !1 !== isReactActEnvironmentGlobal
      );
    }
    ...
    function requestUpdateLane(fiber) {
      var mode = fiber.mode;
      if (!disableLegacyMode && (mode & 1) === NoMode) return 2;
      if (
    ...
    function renderRootConcurrent(root, lanes) {
      ...
      a: do
        try {
          ...
          handleThrow(root, thrownValue$47);
        }
      while (1);
      resetContextDependencies();
      ReactSharedInternals.H = prevDispatcher;
    ...
    function throwAndUnwindWorkLoop(root, unitOfWork, thrownValue) {
      ...
      unitOfWork.flags & 32768
        ? (enableSiblingPrerendering
            ? isHydrating || workInProgressSuspendedReason === SuspendedOnError
              ? (root = !0)
              : workInProgressRootIsPrerendering
                ? (root = !1)
    ...
    function retryTimedOutBoundary(boundaryFiber, retryLane) {
      0 === retryLane &&
        ...
        (retryLane =
          disableLegacyMode || (retryLane & 1) !== NoMode
            ? claimNextRetryLane()
            : 2));
    ...
    function warnIfUpdatesNotWrappedWithActDEV(fiber) {
      if (disableLegacyMode || fiber.mode & 1) {
      ...
      if ("function" === typeof type)
        ...
        a: switch (type) {
          ...
          case REACT_STRICT_MODE_TYPE:
            fiberTag = 8;
            mode |= 8;
            if (disableLegacyMode || (mode & 1) !== NoMode)
              (mode |= 16),
    ...
    var current = null,
      ...
      warnsIfNotActing = $$$config.warnsIfNotActing,
      supportsMutation = $$$config.supportsMutation,
    ...
    exports.discreteUpdates = function (fn, a, b, c, d) {
      ...
      try {
        ...
        setCurrentUpdatePriority(previousPriority),
          (ReactSharedInternals.T = prevTransition),
          executionContext === NoContext && resetRenderTimer();
      }
    };

...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1695 = "oninput" in document;
    if (!isSupported$jscomp$inline_1695) {
      var element$jscomp$inline_1696 = document.createElement("div");
      element$jscomp$inline_1696.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1695 =
        "function" === typeof element$jscomp$inline_1696.oninput;
    }
    JSCompiler_inline_result$jscomp$400 = isSupported$jscomp$inline_1695;
...
function setInitialProperties(domElement, tag, props) {
  switch (tag) {
    ...
    case "textarea":
      listenToNonDelegatedEvent("invalid", domElement);
      defaultValue = type = propKey = null;
      for (value in props)
        if (
          props.hasOwnProperty(value) &&
          ((checked = props[value]), null != checked)
        )
          switch (value) {
            case "value":
              propKey = checked;
            ...
            case "dangerouslySetInnerHTML":
              ...
              break;
            default:
              setProp(domElement, tag, value, checked, props);
          }
      track(domElement);
      initTextarea(domElement, propKey, type, defaultValue);
      return;
    case "option":
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
            ...
            case "type":
              ...
              propKey !== lastProp &&
                ...
                "boolean" !== typeof propKey
                  ? domElement.setAttribute(propKey$234, propKey)
                  : domElement.removeAttribute(propKey$234));
              break;
            case "name":
              name = propKey;
              break;
      ...
      return;
    case "select":
      defaultValue = value = propKey = propKey$234 = null;
      ...
      updateSelect(domElement, propKey$234, propKey, value, defaultValue);
      return;
    case "textarea":
    ...
    case "option":
      for (var propKey$252 in lastProps)
        if (
          ((propKey$234 = lastProps[propKey$252]),
    ...
    case "menuitem":
      for (var propKey$257 in lastProps)
        (propKey$234 = lastProps[propKey$257]),
          lastProps.hasOwnProperty(propKey$257) &&
            null != propKey$234 &&
            !nextProps.hasOwnProperty(propKey$257) &&
            setProp(domElement, tag, propKey$257, null, nextProps, propKey$234);
    ...
    default:
      if (isCustomElement(tag)) {
        for (var propKey$262 in lastProps)
          (propKey$234 = lastProps[propKey$262]),
  ...
  for (var propKey$267 in lastProps)
    (propKey$234 = lastProps[propKey$267]),
      lastProps.hasOwnProperty(propKey$267) &&
        null != propKey$234 &&
        !nextProps.hasOwnProperty(propKey$267) &&
        setProp(domElement, tag, propKey$267, null, nextProps, propKey$234);
  for (var propKey$269 in nextProps)
    (propKey$234 = nextProps[propKey$269]),
      (propKey = lastProps[propKey$269]),
      !nextProps.hasOwnProperty(propKey$269) ||
        propKey$234 === propKey ||
        (null == propKey$234 && null == propKey) ||
        setProp(domElement, tag, propKey$269, propKey$234, nextProps, propKey);
}
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$295 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$295);
          if (resource) break;
          var state = { loading: 0, preload: null };
          if (
            (resource = resourceRoot.querySelector(
              getStylesheetSelectorFromKey(key$295)
            ))
          )
            state.loading = 1;
          else {
            ...
            (options = preloadPropsMap.get(key$295)) &&
          ...
          as.set(key$295, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$295 = getScriptKey(href)),
            (precedence = as.get(key$295)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$295
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$295, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$295 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$295 =
          'link[rel="preload"][as="' + as + '"][href="' + key$295 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$295) &&
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        setInitialProperties(instance$310, "link", key);
...
function legacyCreateRootFromDOMContainer(
  ...
  flushSync$1(function () {
    updateContainer(initialChildren, root$332, parentComponent, callback);
  });
  return root$332;
}
...
var devToolsConfig$jscomp$inline_1937 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "18.3.0-www-classic-ceea03b0",
...
(function (internals) {
  ...
  bundleType: devToolsConfig$jscomp$inline_1937.bundleType,
  version: devToolsConfig$jscomp$inline_1937.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1937.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1937.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1937.findFiberByHostInstance ||
  ...
  reconcilerVersion: "18.3.0-www-classic-ceea03b0"
});
assign(Internals, {
...
exports.version = "18.3.0-www-classic-ceea03b0";

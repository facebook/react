...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$390 = isSupported$jscomp$inline_1634;
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    if ("function" === typeof callback) {
      ...
      callback = function () {
        var instance = getPublicRootInstance(root$324);
        originalCallback.call(instance);
      };
    }
    var root$324 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
    ...
    container._reactRootContainer = root$324;
    container[internalContainerInstanceKey] = root$324.current;
  ...
  if ("function" === typeof callback) {
    var originalCallback$325 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$326);
      originalCallback$325.call(instance);
    };
  }
  var root$326 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  flushSync$1(function () {
    updateContainer(initialChildren, root$326, parentComponent, callback);
  });
  return root$326;
}
...
var devToolsConfig$jscomp$inline_1882 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "18.3.0-www-classic-154fd931",
...
(function (internals) {
  ...
  bundleType: devToolsConfig$jscomp$inline_1882.bundleType,
  version: devToolsConfig$jscomp$inline_1882.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1882.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1882.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1882.findFiberByHostInstance ||
  ...
  reconcilerVersion: "18.3.0-www-classic-154fd931"
});
assign(Internals, {
...
exports.version = "18.3.0-www-classic-154fd931";

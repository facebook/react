...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1656 = "oninput" in document;
    if (!isSupported$jscomp$inline_1656) {
      var element$jscomp$inline_1657 = document.createElement("div");
      element$jscomp$inline_1657.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1656 =
        "function" === typeof element$jscomp$inline_1657.oninput;
    }
    JSCompiler_inline_result$jscomp$390 = isSupported$jscomp$inline_1656;
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      return;
    case "select":
      defaultValue = value = propKey = propKey$233 = null;
      ...
      updateSelect(domElement, propKey$233, propKey, value, defaultValue);
      return;
    case "textarea":
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    if ("function" === typeof callback) {
      ...
      callback = function () {
        var instance = getPublicRootInstance(root$323);
        originalCallback.call(instance);
      };
    }
    var root$323 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
    ...
    container._reactRootContainer = root$323;
    container[internalContainerInstanceKey] = root$323.current;
  ...
  if ("function" === typeof callback) {
    var originalCallback$324 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$325);
      originalCallback$324.call(instance);
    };
  }
  var root$325 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  flushSync$1(function () {
    updateContainer(initialChildren, root$325, parentComponent, callback);
  });
  return root$325;
}

...
for (
  var i$jscomp$inline_2133 = 0;
  i$jscomp$inline_2133 < simpleEventPluginEvents.length;
  i$jscomp$inline_2133++
) {
  var eventName$jscomp$inline_2134 =
      simpleEventPluginEvents[i$jscomp$inline_2133],
    domEventName$jscomp$inline_2135 =
      eventName$jscomp$inline_2134.toLowerCase(),
    capitalizedEvent$jscomp$inline_2136 =
      eventName$jscomp$inline_2134[0].toUpperCase() +
      eventName$jscomp$inline_2134.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_2135,
    "on" + capitalizedEvent$jscomp$inline_2136
  );
}
...
if (
  "19.2.0-www-classic-8ad773b1-20250924" !==
...
enableSchedulingProfiler &&
  ...
  (internals$jscomp$inline_2415.injectProfilingHooks = injectProfilingHooks));
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_3033 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_3033.isDisabled &&
    hook$jscomp$inline_3033.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_3033.inject(
        internals$jscomp$inline_2415
      )),
        (injectedHook = hook$jscomp$inline_3033);
    } catch (err) {}
}

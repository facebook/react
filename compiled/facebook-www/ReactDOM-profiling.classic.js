...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$369 = isSupported$jscomp$inline_1686;
...
if (
  "19.1.0-www-classic-8bda7155-20250204" !==
...
enableSchedulingProfiler &&
  ((internals$jscomp$inline_1907.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_1907.injectProfilingHooks = injectProfilingHooks));

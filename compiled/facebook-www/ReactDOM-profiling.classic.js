...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$191 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$191;
      if (null !== hostParent)
...
function commitSuspenseHydrationCallbacks(finishedRoot, finishedWork) {
  if (null === finishedWork.memoizedState) {
    var current$194 = finishedWork.alternate;
    if (
      null !== current$194 &&
      ((current$194 = current$194.memoizedState),
      null !== current$194 &&
        ((current$194 = current$194.dehydrated), null !== current$194))
    ) {
      try {
        retryIfBlockedOn(current$194);
      } catch (error) {
        captureCommitPhaseError(finishedWork, finishedWork.return, error);
      }
      try {
        ...
        if (null !== hydrationCallbacks) {
          ...
          onHydrated && onHydrated(current$194);
        }
      } catch (error) {
        captureCommitPhaseError(finishedWork, finishedWork.return, error);
      }
...
function recursivelyTraverseReappearLayoutEffects(
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    var current$201 = parentFiber.alternate,
    ...
    switch (finishedWork.tag) {
      ...
      case 1:
        ...
        current$201 = finishedWork;
        finishedRoot = current$201.stateNode;
        if ("function" === typeof finishedRoot.componentDidMount)
          try {
            finishedRoot.componentDidMount();
          } catch (error) {
            captureCommitPhaseError(current$201, current$201.return, error);
          }
        current$201 = finishedWork;
        finishedRoot = current$201.updateQueue;
        if (null !== finishedRoot) {
          var instance = current$201.stateNode;
          try {
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    ...
    switch (finishedWork.tag) {
      ...
      case 23:
        ...
        break;
      case 22:
        var instance$209 = finishedWork.stateNode;
        null !== finishedWork.memoizedState
          ? instance$209._visibility & 4
            ? recursivelyTraverseReconnectPassiveEffects(
                finishedRoot,
                finishedWork,
                committedLanes,
...
function performWorkOnRoot(root$jscomp$0, lanes, forceSync) {
  ...
  do {
    ...
    if (0 === exitStatus) {
      ...
      if ((disableLegacyMode || 0 !== root$jscomp$0.tag) && 2 === exitStatus) {
...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$402;
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$402 = isSupported$jscomp$inline_1660;
  } else JSCompiler_inline_result$jscomp$402 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$402 &&
...
if (
  "19.0.0-www-classic-6c4bbc78-20241015" !==
...
enableSchedulingProfiler &&
  ...
  (internals$jscomp$inline_1881.injectProfilingHooks = injectProfilingHooks));
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    if ("function" === typeof callback) {
      ...
      callback = function () {
        var instance = getPublicRootInstance(root$339);
        originalCallback.call(instance);
      };
    }
    var root$339 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
    ...
    container._reactRootContainer = root$339;
    container[internalContainerInstanceKey] = root$339.current;
  ...
  if ("function" === typeof callback) {
    var originalCallback$340 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$341);
      originalCallback$340.call(instance);
    };
  }
  var root$341 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  container._reactRootContainer = root$341;
  container[internalContainerInstanceKey] = root$341.current;
  listenToAllSupportedEvents(
    8 === container.nodeType ? container.parentNode : container
  );
  updateContainerSync(initialChildren, root$341, parentComponent, callback);
  flushSyncWork$1();
  return root$341;
}

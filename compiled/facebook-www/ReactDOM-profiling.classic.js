...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      hostParentIsContainer = prevHostParentIsContainer$192;
      if (null !== hostParent)
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$399 = isSupported$jscomp$inline_1648;
...
function getActiveElementDeep(containerInfo) {
  var $jscomp$optchain$tmpm273927982$1, $jscomp$nullish$tmp0;
  containerInfo =
    null !=
    ($jscomp$nullish$tmp0 =
      null == containerInfo
        ? void 0
        : null ==
            ($jscomp$optchain$tmpm273927982$1 = containerInfo.ownerDocument)
          ? void 0
          : $jscomp$optchain$tmpm273927982$1.defaultView)
      ? $jscomp$nullish$tmp0
      : window;
  for (
    $jscomp$optchain$tmpm273927982$1 = getActiveElement(containerInfo.document);
    $jscomp$optchain$tmpm273927982$1 instanceof containerInfo.HTMLIFrameElement;

  ) {
    try {
      var JSCompiler_inline_result =
        "string" ===
        typeof $jscomp$optchain$tmpm273927982$1.contentWindow.location.href;
    } catch (err) {
      JSCompiler_inline_result = !1;
    }
    if (JSCompiler_inline_result)
      containerInfo = $jscomp$optchain$tmpm273927982$1.contentWindow;
    else break;
    $jscomp$optchain$tmpm273927982$1 = getActiveElement(containerInfo.document);
  }
  return $jscomp$optchain$tmpm273927982$1;
}
...
if (
  "19.0.0-www-classic-15da9174-20240917" !==
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    if ("function" === typeof callback) {
      ...
      callback = function () {
        var instance = getPublicRootInstance(root$335);
        originalCallback.call(instance);
      };
    }
    var root$335 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
    ...
    container._reactRootContainer = root$335;
    container[internalContainerInstanceKey] = root$335.current;
  ...
  if ("function" === typeof callback) {
    var originalCallback$336 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$337);
      originalCallback$336.call(instance);
    };
  }
  var root$337 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  container._reactRootContainer = root$337;
  container[internalContainerInstanceKey] = root$337.current;
  listenToAllSupportedEvents(
    8 === container.nodeType ? container.parentNode : container
  );
  updateContainerSync(initialChildren, root$337, parentComponent, callback);
  flushSyncWork$1();
  return root$337;
}

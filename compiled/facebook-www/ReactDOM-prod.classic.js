...
function getActiveElementDeep(containerInfo) {
  ...
  containerInfo =
    ...
    ($jscomp$nullish$tmp0 =
      ...
      : window;
  for (
    $jscomp$optchain$tmpm1756096108$1 = getActiveElement(
      containerInfo.document
    );
    $jscomp$optchain$tmpm1756096108$1 instanceof
    ...
    try {
      var JSCompiler_inline_result =
        "string" ===
        typeof $jscomp$optchain$tmpm1756096108$1.contentWindow.location.href;
    } catch (err) {
      JSCompiler_inline_result = !1;
    }
    if (JSCompiler_inline_result)
      containerInfo = $jscomp$optchain$tmpm1756096108$1.contentWindow;
    else break;
    $jscomp$optchain$tmpm1756096108$1 = getActiveElement(
      containerInfo.document
    );
  }
  return $jscomp$optchain$tmpm1756096108$1;
}

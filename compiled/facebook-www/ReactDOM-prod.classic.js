...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2574.isDisabled &&
    hook$jscomp$inline_2574.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2574.inject(
        internals$jscomp$inline_2573
      )),
        (injectedHook = hook$jscomp$inline_2574);
    } catch (err) {}
}

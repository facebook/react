...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$357 = isSupported$jscomp$inline_1672;
...
var internals$jscomp$inline_2459 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2460 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2460.isDisabled &&
    hook$jscomp$inline_2460.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2460.inject(
        internals$jscomp$inline_2459
      )),
        (injectedHook = hook$jscomp$inline_2460);
    } catch (err) {}
}

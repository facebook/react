...
__DEV__ &&
  (function () {
          ...
          a: {
            ...
            try {
              ...
              if (
                ...
                var ms = exports.unstable_now();
                enableProfiling &&
                  (mainThreadIdCounter++,
                  null !== eventLog &&
                    logEvent([7, 1e3 * ms, mainThreadIdCounter]));
              }
            }
            hasMoreWork = void 0;
          }
    ...
    var dynamicFeatureFlags = require("SchedulerFeatureFlags"),
      ...
      enableProfiling = dynamicFeatureFlags.enableProfiling,
      runIdCounter = 0,
    ...
    dynamicFeatureFlags = enableProfiling
      ? {

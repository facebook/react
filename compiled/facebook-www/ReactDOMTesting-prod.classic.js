...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$355 = isSupported$jscomp$inline_1584;
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$260 = getResourcesFromRoot(currentProps).hoistableStyles,
...
var devToolsConfig$jscomp$inline_1830 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-classic-49d2df34",
...
var internals$jscomp$inline_2197 = {
  ...
  reconcilerVersion: "18.3.0-www-classic-49d2df34"
};

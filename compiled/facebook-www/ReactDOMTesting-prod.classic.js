...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$39 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      usable = trackUsedThenable(thenableState, usable, index$39);
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$41 = workInProgressRoot;
      if (null === root$41) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$41, renderLanes$1) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$41 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$41;
    mountEffect(subscribeToStore.bind(null, fiber, root$41, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$56 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$56.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$56.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$56.incompleteTransitions.forEach(function (markerInstance) {
    ...
    enableTransitionTracing &&
      ...
      null !== didSuspend &&
        ((JSCompiler_temp = enableTransitionTracing
          ? markerInstanceStack.current
          : null),
        (dehydrated$63 = showFallback.updateQueue),
        ...
        null === dehydrated$63
          ...
          : dehydrated$63 === primaryChildProps
          ? (showFallback.updateQueue = {
              transitions: didSuspend,
              markerInstances: JSCompiler_temp,
              retryQueue:
          ...
          : ((dehydrated$63.transitions = didSuspend),
            (dehydrated$63.markerInstances = JSCompiler_temp))));
    ...
    if (6 === exitStatus) markRootSuspended(root, lanes);
      ...
      switch (exitStatus) {
        ...
        case 4:
          ...
          for (errorRetryLanes$169 = -1; 0 < exitStatus; ) {
            var index$2 = 31 - clz32(exitStatus),
              lane = 1 << index$2;
            index$2 = errorRetryLanes[index$2];
            index$2 > errorRetryLanes$169 && (errorRetryLanes$169 = index$2);
            exitStatus &= ~lane;
          }
          exitStatus = errorRetryLanes$169;
                ...
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (wakeable === noopSuspenseyCommitThenable)
                    ...
                    if (null === offscreenQueue) {
                      ...
                      var retryQueue$51 = offscreenQueue.retryQueue;
                      null === retryQueue$51
                        ? (offscreenQueue.retryQueue = new Set([wakeable]))
                        : retryQueue$51.add(wakeable);
                    }
                  }
                  break;
                }
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    if ("function" === typeof callback) {
      ...
      callback = function () {
        var instance = getPublicRootInstance(root$180);
        originalCallback.call(instance);
      };
    }
    var root$180 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
    ...
    container._reactRootContainer = root$180;
    container[internalContainerInstanceKey] = root$180.current;
  ...
  if ("function" === typeof callback) {
    var originalCallback$181 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$182);
      originalCallback$181.call(instance);
    };
  }
  var root$182 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  container._reactRootContainer = root$182;
  container[internalContainerInstanceKey] = root$182.current;
  listenToAllSupportedEvents(
    8 === container.nodeType ? container.parentNode : container
  );
  flushSync$1(function () {
    updateContainer(initialChildren, root$182, parentComponent, callback);
  });
  return root$182;
}
...
var devToolsConfig$jscomp$inline_1611 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "18.3.0-www-classic-31f56934",
  rendererPackageName: "react-dom"
};
var internals$jscomp$inline_2154 = {
  bundleType: devToolsConfig$jscomp$inline_1611.bundleType,
  version: devToolsConfig$jscomp$inline_1611.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1611.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1611.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1611.findFiberByHostInstance ||
  ...
  reconcilerVersion: "18.3.0-www-classic-31f56934"
};
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$190 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$190);
          if (resource) break;
          var state = { loading: 0, preload: null };
          if (
            (resource = resourceRoot.querySelector(
              getStylesheetSelectorFromKey(key$190)
            ))
          )
            state.loading = 1;
          else {
            ...
            (options = preloadPropsMap.get(key$190)) &&
          ...
          as.set(key$190, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$190 = getScriptKey(href)),
            (precedence = as.get(key$190)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$190
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$190, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$190 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$190 =
          'link[rel="preload"][as="' + as + '"][href="' + key$190 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$190) &&
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$199 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$200 = styles$199.get(type);
        resource$200 ||
          ...
          styles$199.set(type, resource$200),
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$205 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$205)
          return (
            (resource.instance = instance$205),
            markNodeAsHoistable(instance$205),
            instance$205
          );
        ...
        markNodeAsHoistable(instance$205);
        var linkInstance = instance$205;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$205, "link", key);
        resource.state.loading |= 4;
        insertStylesheet(instance$205, props.precedence, hoistableRoot);
        return (resource.instance = instance$205);
      case "script":
        instance$205 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            "script[async]" + instance$205
          ))
        )
          return (
        ...
        key = props;
        if ((styleProps = preloadPropsMap.get(instance$205)))
          (key = assign({}, props)),
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1710 = "oninput" in document;
    if (!isSupported$jscomp$inline_1710) {
      var element$jscomp$inline_1711 = document.createElement("div");
      element$jscomp$inline_1711.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1710 =
        "function" === typeof element$jscomp$inline_1711.oninput;
    }
    JSCompiler_inline_result$jscomp$326 = isSupported$jscomp$inline_1710;
...
exports.version = "18.3.0-www-classic-31f56934";

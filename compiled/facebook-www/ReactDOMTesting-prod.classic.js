...
function getActiveElementDeep(containerInfo) {
  var $jscomp$optchain$tmpm1357654797$1, $jscomp$nullish$tmp0;
  containerInfo =
    null !=
    ($jscomp$nullish$tmp0 =
      null == containerInfo
        ? void 0
        : null ==
            ($jscomp$optchain$tmpm1357654797$1 = containerInfo.ownerDocument)
          ? void 0
          : $jscomp$optchain$tmpm1357654797$1.defaultView)
      ? $jscomp$nullish$tmp0
      : window;
  for (
    $jscomp$optchain$tmpm1357654797$1 = getActiveElement(
      containerInfo.document
    );
    $jscomp$optchain$tmpm1357654797$1 instanceof
    ...
    try {
      var JSCompiler_inline_result =
        "string" ===
        typeof $jscomp$optchain$tmpm1357654797$1.contentWindow.location.href;
    } catch (err) {
      JSCompiler_inline_result = !1;
    }
    if (JSCompiler_inline_result)
      containerInfo = $jscomp$optchain$tmpm1357654797$1.contentWindow;
    else break;
    $jscomp$optchain$tmpm1357654797$1 = getActiveElement(
      containerInfo.document
    );
  }
  return $jscomp$optchain$tmpm1357654797$1;
}

...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$344 = isSupported$jscomp$inline_1537;
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$252 = getResourcesFromRoot(currentProps).hoistableStyles,
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    ...
    var root$277 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
  ...
  if ("function" === typeof callback) {
    var originalCallback$278 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$279);
      originalCallback$278.call(instance);
    };
  }
  var root$279 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  flushSync$1(function () {
    updateContainer(initialChildren, root$279, parentComponent, callback);
  });
  return root$279;
}
...
var devToolsConfig$jscomp$inline_1802 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-classic-2db55f27",
...
var internals$jscomp$inline_2151 = {
  ...
  reconcilerVersion: "18.3.0-www-classic-2db55f27"
};
...
exports.version = "18.3.0-www-classic-2db55f27";

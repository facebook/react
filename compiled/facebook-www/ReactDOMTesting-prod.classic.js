...
for (
  var i$jscomp$inline_1761 = 0;
  i$jscomp$inline_1761 < simpleEventPluginEvents.length;
  i$jscomp$inline_1761++
) {
  var eventName$jscomp$inline_1762 =
      simpleEventPluginEvents[i$jscomp$inline_1761],
    domEventName$jscomp$inline_1763 =
      eventName$jscomp$inline_1762.toLowerCase(),
    capitalizedEvent$jscomp$inline_1764 =
      eventName$jscomp$inline_1762[0].toUpperCase() +
      eventName$jscomp$inline_1762.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1763,
    "on" + capitalizedEvent$jscomp$inline_1764
  );
}

...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    ...
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$75.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$75.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$355 = isSupported$jscomp$inline_1544;
...
var devToolsConfig$jscomp$inline_1763 = {
  ...
  bundleType: 0,
  version: "19.0.0-www-classic-67b98651",
...
var internals$jscomp$inline_2212 = {
  ...
  reconcilerVersion: "19.0.0-www-classic-67b98651"
};
...
exports.version = "19.0.0-www-classic-67b98651";

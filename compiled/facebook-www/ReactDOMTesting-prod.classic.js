...
function attemptSynchronousHydration(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$198 = fiber.stateNode;
      if (root$198.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$198.pendingLanes);
        0 !== lanes &&
          (upgradePendingLanesToSync(root$198, lanes),
          ensureRootIsScheduled(root$198),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now() + 500),
            flushSyncWorkAcrossRoots_impl(!1)));
      }
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$350 = isSupported$jscomp$inline_1514;
...
var devToolsConfig$jscomp$inline_1731 = {
  ...
  bundleType: 0,
  version: "19.0.0-www-classic-5ab1fc58",
...
var internals$jscomp$inline_2142 = {
  ...
  reconcilerVersion: "19.0.0-www-classic-5ab1fc58"
};
...
exports.version = "19.0.0-www-classic-5ab1fc58";

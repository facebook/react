...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      ...
      return trackUsedThenable(thenableState, usable, index$41);
    }
    if (
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$46 = enqueueUpdate$1(provider, fiber, lane);
        null !== root$46 &&
          (scheduleUpdateOnFiber(root$46, provider, lane, eventTime),
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      includesBlockingLane(root$43, renderLanes) ||
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null !== JSCompiler_temp) {
    var dehydrated$62 = JSCompiler_temp.dehydrated;
    if (null !== dehydrated$62)
  ...
  if (showFallback) {
    ...
    dehydrated$62 = JSCompiler_temp.sibling;
    ...
    null !== dehydrated$62
      ? (showFallback = createWorkInProgress(dehydrated$62, showFallback))
    ...
    null === didSuspend
      ...
      : ((JSCompiler_temp = didSuspend.cachePool),
        null !== JSCompiler_temp
          ? ((dehydrated$62 = CacheContext._currentValue),
            (JSCompiler_temp =
              JSCompiler_temp.parent !== dehydrated$62
                ? { parent: dehydrated$62, pool: dehydrated$62 }
                : JSCompiler_temp))
  ...
  if (didBailout)
    for (var child$89 = completedWork.child; null !== child$89; )
      (newChildLanes |= child$89.lanes | child$89.childLanes),
        (subtreeFlags |= child$89.subtreeFlags & 14680064),
        (subtreeFlags |= child$89.flags & 14680064),
    ...
    if (6 === didTimeout) markRootSuspended$1(root, lanes);
      ...
      if (
        ...
        if (2 === didTimeout) {
          ...
          var errorRetryLanes$152 = getLanesToRetrySynchronouslyOnError(
            root,
            errorRetryLanes
          );
          0 !== errorRetryLanes$152 &&
            ((lanes = errorRetryLanes$152),
            (didTimeout = recoverFromConcurrentError(
              root,
              errorRetryLanes,
              errorRetryLanes$152
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$152 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$152),
              (errorRetryLanes$152 = didTimeout[errorRetryLanes$152]),
              errorRetryLanes$152 > originallyAttemptedLanes &&
                (originallyAttemptedLanes = errorRetryLanes$152),
              (lanes &= ~errorRetryLanes);
              ...
              case 22:
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (null === offscreenQueue) {
                    ...
                    var wakeables$51 = offscreenQueue.wakeables;
                    null === wakeables$51
                      ? (offscreenQueue.wakeables = new Set([wakeable]))
                      : wakeables$51.add(wakeable);
                  }
                  break;
                }
              default:
...
function legacyCreateRootFromDOMContainer(
  ...
  if (isHydrationContainer) {
    if ("function" === typeof callback) {
      ...
      callback = function () {
        var instance = getPublicRootInstance(root$164);
        originalCallback.call(instance);
      };
    }
    var root$164 = createHydrationContainer(
      initialChildren,
      callback,
      container,
      0,
    ...
    container._reactRootContainer = root$164;
    container[internalContainerInstanceKey] = root$164.current;
  ...
  if ("function" === typeof callback) {
    var originalCallback$165 = callback;
    callback = function () {
      var instance = getPublicRootInstance(root$166);
      originalCallback$165.call(instance);
    };
  }
  var root$166 = createFiberRoot(
    container,
    0,
    !1,
    null,
  ...
  container._reactRootContainer = root$166;
  container[internalContainerInstanceKey] = root$166.current;
  listenToAllSupportedEvents(
    8 === container.nodeType ? container.parentNode : container
  );
  flushSync(function () {
    updateContainer(initialChildren, root$166, parentComponent, callback);
  });
  return root$166;
}
...
_attemptSynchronousHydration = function (fiber) {
  switch (fiber.tag) {
    case 3:
      ...
      if (root$163.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$163.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$163, lanes | 2),
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2058.isDisabled &&
    hook$jscomp$inline_2058.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2058.inject(
        internals$jscomp$inline_2057
      )),
        (injectedHook = hook$jscomp$inline_2058);
    } catch (err) {}
}
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$168 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$168);
          if (resource) break;
          resource = resourceRoot.querySelector(
            getStylesheetSelectorFromKey(key$168)
          );
          resource ||
            ((href = {
              rel: "stylesheet",
            ...
            (options = preloadPropsMap.get(key$168)) &&
          ...
          as.set(key$168, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$168 = getScriptKey(href)),
            (precedence = as.get(key$168)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$168
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$168, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$168 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$168 =
          'link[rel="preload"][as="' + as + '"][href="' + key$168 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$168) &&
            ((options = createElement(
              "link",
              href,
              resourceRoot,
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var key$174 = getStyleKey(pendingProps.href),
          styles$175 = getResourcesFromRoot(currentProps).hoistableStyles;
        type = styles$175.get(key$174);
        type ||
          ((currentProps = currentProps.ownerDocument || currentProps),
          (type = { type: "stylesheet", instance: null, count: 0 }),
          styles$175.set(key$174, type),
          preloadPropsMap.has(key$174) ||
            ((pendingProps = {
              rel: "preload",
              as: "style",
            ...
            preloadPropsMap.set(key$174, pendingProps),
            currentProps.querySelector(getStylesheetSelectorFromKey(key$174)) ||
              null !==
                currentProps.querySelector(
                  'link[rel="preload"][as="style"][' + key$174 + "]"
                ) ||
              ((key$174 = createElement(
                "link",
                pendingProps,
                currentProps,
                "http://www.w3.org/1999/xhtml"
              )),
              setInitialProperties(key$174, "link", pendingProps),
              (key$174[internalResourceMarker] = !0),
              currentProps.head.appendChild(key$174))));
        return type;
      }
      return null;
    case "script":
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$181 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$181) return (resource.instance = instance$181);
        key = assign({}, props, {
          "data-precedence": props.precedence,
          precedence: null
        });
        ...
        instance$181 = createElement(
          "link",
          key,
          hoistableRoot,
          "http://www.w3.org/1999/xhtml"
        );
        instance$181[internalResourceMarker] = !0;
        var linkInstance = instance$181;
        ...
        setInitialProperties(instance$181, "link", key);
        insertStylesheet(instance$181, props.precedence, hoistableRoot);
        return (resource.instance = instance$181);
      case "script":
        styleProps = getScriptKey(props.src);
        if (
          (instance$181 = hoistableRoot.querySelector(
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$291 = isSupported$jscomp$inline_1610;

...
function markStarvedLanesAsExpired(root, currentTime) {
  for (
    ...
    var index$12 = 31 - clz32(lanes),
      lane = 1 << index$12,
      expirationTime = expirationTimes[index$12];
    if (-1 === expirationTime) {
      if (0 === (lane & suspendedLanes) || 0 !== (lane & pingedLanes))
        expirationTimes[index$12] = computeExpirationTime(lane, currentTime);
...
function markRootFinished(root, remainingLanes) {
  ...
  for (root = root.hiddenUpdates; 0 < noLongerPendingLanes; ) {
    var index$14 = 31 - clz32(noLongerPendingLanes),
      lane = 1 << index$14;
    remainingLanes[index$14] = 0;
    eventTimes[index$14] = -1;
    expirationTimes[index$14] = -1;
    var hiddenUpdatesForLane = root[index$14];
    if (null !== hiddenUpdatesForLane)
      for (
        root[index$14] = null, index$14 = 0;
        index$14 < hiddenUpdatesForLane.length;
        index$14++
      ) {
        var update = hiddenUpdatesForLane[index$14];
...
function markRootEntangled(root, entangledLanes) {
  ...
  for (root = root.entanglements; rootEntangledLanes; ) {
    var index$15 = 31 - clz32(rootEntangledLanes),
      lane = 1 << index$15;
    (lane & entangledLanes) | (root[index$15] & entangledLanes) &&
      (root[index$15] |= entangledLanes);
...
function getTransitionsForLanes(root, lanes) {
  ...
  for (var transitionsForLanes = []; 0 < lanes; ) {
    var index$17 = 31 - clz32(lanes),
      lane = 1 << index$17;
    index$17 = root.transitionLanes[index$17];
    null !== index$17 &&
      index$17.forEach(function(transition) {
  ...
  if (enableTransitionTracing)
    for (; 0 < lanes; ) {
      var index$18 = 31 - clz32(lanes),
        lane = 1 << index$18;
      null !== root.transitionLanes[index$18] &&
        (root.transitionLanes[index$18] = null);
      lanes &= ~lane;
    }
}
...
function acquireResource(resource) {
  switch (resource.type) {
    ...
    case "meta":
      a: {
        ...
        if (!instance) {
          var props = resource.props,
            root$40 = resource.root,
            type = resource.type;
          switch (type) {
            case "title":
              var titles = root$40.querySelectorAll("title");
            ...
            case "meta":
              ...
              } else if ((instance = root$40.querySelector(matcher))) {
              ...
              insertResourceInstanceBefore(root$40, instance, titles);
              break;
            case "link":
              ...
              if ((titles = root$40.querySelector(titles))) {
              ...
              insertResourceInstanceBefore(root$40, instance, null);
              break;
            case "base":
              (titles = root$40.querySelector(resource.matcher))
                ? ((instance = resource.instance = titles),
                  (instance[internalResourceMarker] = !0))
                : ((instance = resource.instance = createResourceInstance(
                    type,
      ...
      return resource;
    case "style":
      root$40 = resource.instance;
      if (!root$40)
        if (
          ((props = resource.root),
          (type = resource.precedence),
          (root$40 = escapeSelectorAttributeValueInsideDoubleQuotes(
            resource.props.href
          )),
          (titles = props.querySelector(
            'link[rel="stylesheet"][data-precedence][href="' + root$40 + '"]'
          )))
        )
          if (
            ((root$40 = resource.instance = titles),
            (root$40[internalResourceMarker] = !0),
          ...
          root$40 = resource.instance = createResourceInstance(
            "link",
            resource.props,
            getDocumentFromRoot(props)
          );
          attachLoadListeners(root$40, resource);
          titles = root$40;
...
function isHostResourceType(type, props, hostContext) {
  switch (type) {
    ...
    case "script":
      ...
      var onError$48 = props.onError;
      return (
        props.async && "string" === typeof type && !hostContext && !onError$48
      );
  }
  return !1;
}
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$91 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      return trackUsedThenable(thenableState, usable, index$91);
    }
    if (
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$97 = enqueueUpdate$1(provider, fiber, lane);
        null !== root$97 &&
          (scheduleUpdateOnFiber(root$97, provider, lane, eventTime),
          entangleTransitions(root$97, provider, lane));
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$93 = workInProgressRoot;
      if (null === root$93) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$93, renderLanes) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$93 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$93;
    mountEffect(subscribeToStore.bind(null, fiber, root$93, subscribe), [
      subscribe
    ]);
    fiber.flags |= 1024;
    pushEffect(
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$108 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function(transition) {
        if (!root$108.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$108.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$108.incompleteTransitions.forEach(function(markerInstance) {
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null !== JSCompiler_temp) {
    var dehydrated$115 = JSCompiler_temp.dehydrated;
    if (null !== dehydrated$115)
  ...
  if (showFallback) {
    ...
    dehydrated$115 = JSCompiler_temp.sibling;
    ...
    null !== dehydrated$115
      ? (showFallback = createWorkInProgress(dehydrated$115, showFallback))
    ...
    null === didSuspend
      ...
      : ((JSCompiler_temp = didSuspend.cachePool),
        null !== JSCompiler_temp
          ? ((dehydrated$115 = CacheContext._currentValue),
            (JSCompiler_temp =
              JSCompiler_temp.parent !== dehydrated$115
                ? { parent: dehydrated$115, pool: dehydrated$115 }
                : JSCompiler_temp))
    ...
    enableTransitionTracing &&
      ...
      null !== didSuspend &&
        ((JSCompiler_temp = enableTransitionTracing
          ? markerInstanceStack.current
          : null),
        (dehydrated$115 = showFallback.updateQueue),
        ...
        null === dehydrated$115
          ...
          : dehydrated$115 === primaryChildProps
          ? (showFallback.updateQueue = {
              transitions: didSuspend,
              markerInstances: JSCompiler_temp,
              wakeables:
          ...
          : ((dehydrated$115.transitions = didSuspend),
            (dehydrated$115.markerInstances = JSCompiler_temp))));
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$145 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$145 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$145
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$145.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$146 = completedWork.child; null !== child$146; )
      (newChildLanes |= child$146.lanes | child$146.childLanes),
        (subtreeFlags |= child$146.subtreeFlags & 7340032),
        (subtreeFlags |= child$146.flags & 7340032),
        (child$146.return = completedWork),
        (child$146 = child$146.sibling);
  else
    for (child$146 = completedWork.child; null !== child$146; )
      (newChildLanes |= child$146.lanes | child$146.childLanes),
        (subtreeFlags |= child$146.subtreeFlags),
        (subtreeFlags |= child$146.flags),
        (child$146.return = completedWork),
        (child$146 = child$146.sibling);
    ...
    if (enableTransitionTracing) {
      ...
      if (
        ...
        var transitionLanesMap = root.transitionLanes,
          index$16 = 31 - clz32(lane),
          transitions = transitionLanesMap[index$16];
        null === transitions && (transitions = new Set());
        transitions.add(transition);
        transitionLanesMap[index$16] = transitions;
      }
    }
...
function markRootSuspended$1(root, suspendedLanes) {
  ...
  for (root = root.expirationTimes; 0 < suspendedLanes; ) {
    var index$13 = 31 - clz32(suspendedLanes),
      lane = 1 << index$13;
    root[index$13] = -1;
    suspendedLanes &= ~lane;
  }
              ...
              case 22:
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (null === offscreenQueue) {
                    ...
                    var wakeables$103 = offscreenQueue.wakeables;
                    null === wakeables$103
                      ? (offscreenQueue.wakeables = new Set([wakeable]))
                      : wakeables$103.add(wakeable);
                  }
                  break;
                }
              default:
  ...
  switch (fiber.tag) {
    case 3:
      ...
      if (root$226.current.memoizedState.isDehydrated) {
        ...
        0 !== lanes &&
          (markRootEntangled(root$226, lanes | 1),

...
function flushSyncWorkAcrossRoots_impl(onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$45 = firstScheduledRoot; null !== root$45; ) {
        if (
          (!onlyLegacy || 0 === root$45.tag) &&
          0 !==
            (getNextLanes(
              root$45,
              root$45 === workInProgressRoot$jscomp$0
  ...
  try {
    if (enableAsyncActions) {
      ...
      if (
        ...
        var entangledResult$53 = requestSyncActionContext(
          returnValue,
          finishedState
        );
        dispatchSetState(fiber, queue, entangledResult$53);
      }
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$367 = isSupported$jscomp$inline_1562;
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      return;
    case "select":
      defaultValue = value = propKey = propKey$216 = null;
      ...
      updateSelect(domElement, propKey$216, propKey, value, defaultValue);
      return;
    case "textarea":
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$281 = getResourcesFromRoot(currentProps).hoistableStyles,
...
var devToolsConfig$jscomp$inline_1770 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-1275e069",
...
var internals$jscomp$inline_2137 = {
  ...
  reconcilerVersion: "18.3.0-www-modern-1275e069"
};
...
exports.version = "18.3.0-www-modern-1275e069";

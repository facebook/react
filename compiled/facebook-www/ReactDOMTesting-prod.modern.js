    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$200 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$200);
          if (resource) break;
          var state = { loading: 0, preload: null };
          if (
            (resource = resourceRoot.querySelector(
              getStylesheetSelectorFromKey(key$200)
            ))
          )
            state.loading = 1;
          else {
            ...
            (options = preloadPropsMap.get(key$200)) &&
          ...
          as.set(key$200, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$200 = getScriptKey(href)),
            (precedence = as.get(key$200)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$200
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$200, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$200 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$200 =
          'link[rel="preload"][as="' + as + '"][href="' + key$200 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$200) &&
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$209 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$210 = styles$209.get(type);
        resource$210 ||
          ...
          styles$209.set(type, resource$210),
...
var devToolsConfig$jscomp$inline_1769 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-e85ff880",
...
var internals$jscomp$inline_2166 = {
  ...
  reconcilerVersion: "18.3.0-www-modern-e85ff880"
};
...
exports.version = "18.3.0-www-modern-e85ff880";

  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        cache$127 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
    ...
    case 19:
      ...
      cache$127 = currentResource.rendering;
      if (null === cache$127)
        ...
        currentResource.isBackwards
          ...
          : ((current = currentResource.last),
            null !== current
              ...
              : (workInProgress.child = cache$127),
            (currentResource.last = cache$127));
      }
  ...
  switch (fiber.tag) {
    case 3:
      ...
      if (root$193.current.memoizedState.isDehydrated) {
        ...
        0 !== lanes &&
          (upgradePendingLanesToSync(root$193, lanes),
          ensureRootIsScheduled(root$193),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now() + 500),
            flushSyncWorkAcrossRoots_impl(!1)));
      }
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1508 = "oninput" in document;
    if (!isSupported$jscomp$inline_1508) {
      var element$jscomp$inline_1509 = document.createElement("div");
      element$jscomp$inline_1509.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1508 =
        "function" === typeof element$jscomp$inline_1509.oninput;
    }
    JSCompiler_inline_result$jscomp$346 = isSupported$jscomp$inline_1508;
...
var internals$jscomp$inline_2110 = {
  bundleType: devToolsConfig$jscomp$inline_1707.bundleType,
  version: devToolsConfig$jscomp$inline_1707.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1707.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1707.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1707.findFiberByHostInstance ||

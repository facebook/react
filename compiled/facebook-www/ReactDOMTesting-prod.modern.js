...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$293 = isSupported$jscomp$inline_424;
...
for (
  var reportGlobalError =
    ...
    i$jscomp$inline_465 = 0;
  i$jscomp$inline_465 < simpleEventPluginEvents.length;
  i$jscomp$inline_465++
) {
  var eventName$jscomp$inline_466 =
      simpleEventPluginEvents[i$jscomp$inline_465],
    domEventName$jscomp$inline_467 = eventName$jscomp$inline_466.toLowerCase(),
    capitalizedEvent$jscomp$inline_468 =
      eventName$jscomp$inline_466[0].toUpperCase() +
      eventName$jscomp$inline_466.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_467,
    "on" + capitalizedEvent$jscomp$inline_468
  );
}
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      for (var propKey$50 in nextProps) {
        var propKey = nextProps[propKey$50];
        lastProp = lastProps[propKey$50];
        if (
          nextProps.hasOwnProperty(propKey$50) &&
      ...
      return;
    case "select":
      propKey = value = defaultValue = propKey$50 = null;
      ...
      nextProps = propKey;
      null != propKey$50
        ? updateOptions(domElement, !!lastProps, propKey$50, !1)
        : !!nextProps !== !!lastProps &&
          (null != tag
    ...
    case "textarea":
      ...
      updateTextarea(domElement, propKey$50, propKey);
      return;
    case "option":
      for (var propKey$66 in lastProps)
        if (
          ((propKey$50 = lastProps[propKey$66]),
          lastProps.hasOwnProperty(propKey$66) &&
            null != propKey$50 &&
            !nextProps.hasOwnProperty(propKey$66))
        )
          switch (propKey$66) {
            case "selected":
              ...
              break;
            default:
              setProp(domElement, tag, propKey$66, null, nextProps, propKey$50);
          }
      for (lastDefaultValue in nextProps)
        if (
          ((propKey$50 = nextProps[lastDefaultValue]),
          (propKey = lastProps[lastDefaultValue]),
          nextProps.hasOwnProperty(lastDefaultValue) &&
            propKey$50 !== propKey &&
            (null != propKey$50 || null != propKey))
        )
          switch (lastDefaultValue) {
            case "selected":
              domElement.selected =
                propKey$50 &&
                "function" !== typeof propKey$50 &&
                "symbol" !== typeof propKey$50;
              break;
            default:
              setProp(
                domElement,
    ...
    case "wbr":
    case "menuitem":
      for (var propKey$71 in lastProps)
        (propKey$50 = lastProps[propKey$71]),
          lastProps.hasOwnProperty(propKey$71) &&
            null != propKey$50 &&
            !nextProps.hasOwnProperty(propKey$71) &&
            setProp(domElement, tag, propKey$71, null, nextProps, propKey$50);
      for (checked in nextProps)
        if (
          ((propKey$50 = nextProps[checked]),
          ...
          switch (checked) {
            ...
            case "dangerouslySetInnerHTML":
              ...
              break;
            default:
              setProp(domElement, tag, checked, propKey$50, nextProps, propKey);
          }
      return;
    default:
      if (isCustomElement(tag)) {
        for (var propKey$76 in lastProps)
          (propKey$50 = lastProps[propKey$76]),
            lastProps.hasOwnProperty(propKey$76) &&
              void 0 !== propKey$50 &&
              !nextProps.hasOwnProperty(propKey$76) &&
              setPropOnCustomElement(
                domElement,
                tag,
                propKey$76,
        ...
        for (defaultChecked in nextProps)
          (propKey$50 = nextProps[defaultChecked]),
            (propKey = lastProps[defaultChecked]),
            !nextProps.hasOwnProperty(defaultChecked) ||
              propKey$50 === propKey ||
              (void 0 === propKey$50 && void 0 === propKey) ||
              setPropOnCustomElement(
                domElement,
                tag,
                defaultChecked,
  ...
  for (var propKey$81 in lastProps)
    (propKey$50 = lastProps[propKey$81]),
      lastProps.hasOwnProperty(propKey$81) &&
        null != propKey$50 &&
        !nextProps.hasOwnProperty(propKey$81) &&
        setProp(domElement, tag, propKey$81, null, nextProps, propKey$50);
  for (lastProp in nextProps)
    (propKey$50 = nextProps[lastProp]),
      (propKey = lastProps[lastProp]),
      !nextProps.hasOwnProperty(lastProp) ||
        propKey$50 === propKey ||
        (null == propKey$50 && null == propKey) ||
        setProp(domElement, tag, lastProp, propKey$50, nextProps, propKey);
}
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$89 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$90 = styles$89.get(type);
        resource$90 ||
          ...
          styles$89.set(type, resource$90),
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$94 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$94)
          return (
            (resource.state.loading |= 4),
            (resource.instance = instance$94),
            markNodeAsHoistable(instance$94),
            instance$94
          );
        ...
        markNodeAsHoistable(instance$94);
        var linkInstance = instance$94;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$94, "link", instance);
        resource.state.loading |= 4;
        insertStylesheet(instance$94, props.precedence, hoistableRoot);
        return (resource.instance = instance$94);
      case "script":
        instance$94 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            getScriptSelectorFromKey(instance$94)
          ))
        )
          return (
        ...
        instance = props;
        if ((styleProps = preloadPropsMap.get(instance$94)))
...
function flushSyncWorkAcrossRoots_impl(onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$112 = firstScheduledRoot; null !== root$112; ) {
        if (!onlyLegacy) {
          var workInProgressRootRenderLanes$114 = workInProgressRootRenderLanes;
          workInProgressRootRenderLanes$114 = getNextLanes(
            root$112,
            root$112 === workInProgressRoot
              ? workInProgressRootRenderLanes$114
              : 0
          );
          0 !== (workInProgressRootRenderLanes$114 & 3) &&
            ((didPerformSomeWork = !0),
            performSyncWorkOnRoot(root$112, workInProgressRootRenderLanes$114));
        }
        root$112 = root$112.next;
      }
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$138 = !1;
    do {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$138 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$138 &&
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$147 = enqueueUpdate(provider, fiber, lane);
        null !== root$147 &&
          (scheduleUpdateOnFiber(root$147, provider, lane),
          entangleTransitions(root$147, provider, lane));
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$141 = workInProgressRoot;
      if (null === root$141) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$141, workInProgressRootRenderLanes) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$141 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$141;
    mountEffect(subscribeToStore.bind(null, fiber, root$141, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
...
function throwException(
  ...
  if (isHydrating) {
    var suspenseBoundary$155 = suspenseHandlerStackCursor.current;
    if (null !== suspenseBoundary$155)
      return (
        0 === (suspenseBoundary$155.flags & 65536) &&
          (suspenseBoundary$155.flags |= 256),
        (suspenseBoundary$155.flags |= 65536),
        (suspenseBoundary$155.lanes = rootRenderLanes),
        queueHydrationError(createCapturedValueAtFiber(value, sourceFiber)),
        !1
      );
  }
  suspenseBoundary$155 = value = createCapturedValueAtFiber(value, sourceFiber);
  4 !== workInProgressRootExitStatus && (workInProgressRootExitStatus = 2);
  null === workInProgressRootConcurrentErrors
    ? (workInProgressRootConcurrentErrors = [suspenseBoundary$155])
    : workInProgressRootConcurrentErrors.push(suspenseBoundary$155);
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$159 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$159.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$159.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$159.incompleteTransitions.forEach(function (markerInstance) {
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$197 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$197 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$197
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$197.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$198 = completedWork.child; null !== child$198; )
      (newChildLanes |= child$198.lanes | child$198.childLanes),
        (subtreeFlags |= child$198.subtreeFlags & 31457280),
        (subtreeFlags |= child$198.flags & 31457280),
        (child$198.return = completedWork),
        (child$198 = child$198.sibling);
  else
    for (child$198 = completedWork.child; null !== child$198; )
      (newChildLanes |= child$198.lanes | child$198.childLanes),
        (subtreeFlags |= child$198.subtreeFlags),
        (subtreeFlags |= child$198.flags),
        (child$198.return = completedWork),
        (child$198 = child$198.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$210 = newProps.memoizedState.cachePool.pool);
        cache$210 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
    ...
    case 19:
      ...
      cache$210 = currentResource.rendering;
      if (null === cache$210)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$210 = findFirstSuspended(current);
              if (null !== cache$210) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$210.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$210)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$210.sibling = workInProgress.child),
            (workInProgress.child = cache$210))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$210)
              : (workInProgress.child = cache$210),
            (currentResource.last = cache$210));
      }
  ...
  if (null !== ref)
    if ("function" === typeof refCleanup)
      ...
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$227);
      }
    ...
    case 5:
      ...
      if (flags & 4 && ((flags = finishedWork.stateNode), null != flags)) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$247);
        }
      }
      break;
    case 6:
      ...
      if (flags & 4) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$248);
        }
      }
      break;
    case 3:
      ...
      if (flags & 4 && null !== current && current.memoizedState.isDehydrated)
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$249);
        }
      break;
    case 4:
    ...
    case 13:
      ...
      if (flags & 4) {
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$251);
        }
      ...
      if (27 !== finishedWork.tag) {
        ...
        switch (JSCompiler_inline_result.tag) {
          case 27:
            ...
            break;
          case 5:
            var parent$233 = JSCompiler_inline_result.stateNode;
            JSCompiler_inline_result.flags & 32 &&
              (setTextContent(parent$233, ""),
              (JSCompiler_inline_result.flags &= -33));
            var before$234 = getHostSibling(finishedWork);
            insertOrAppendPlacementNode(finishedWork, before$234, parent$233);
            break;
          case 3:
          case 4:
            var parent$235 = JSCompiler_inline_result.stateNode.containerInfo,
              before$236 = getHostSibling(finishedWork);
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    ...
    switch (finishedWork.tag) {
      ...
      case 23:
        ...
        break;
      case 22:
        var instance$258 = finishedWork.stateNode;
        null !== finishedWork.memoizedState
          ? instance$258._visibility & 4
            ? recursivelyTraverseReconnectPassiveEffects(
                finishedRoot,
                finishedWork,
                committedLanes,
...
function renderRootConcurrent(root, lanes) {
  ...
  a: do
    try {
      ...
      workLoopConcurrent();
      break;
    } catch (thrownValue$269) {
      handleThrow(root, thrownValue$269);
    }
  while (1);
  resetContextDependencies();
  ReactCurrentDispatcher.current = prevDispatcher;
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    executionContext |= 4;
    ReactCurrentOwner.current = null;
    var shouldFireAfterActiveInstanceBlur$273 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitMutationEffectsOnFiber(finishedWork, root);
    shouldFireAfterActiveInstanceBlur$273 &&
      ((_enabled = !0),
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$274 = rootWithPendingPassiveEffects,
    ...
    try {
      ...
      (currentUpdatePriority = previousPriority),
        (ReactCurrentBatchConfig$1.transition = prevTransition),
        releaseRootPooledCache(root$274, remainingLanes);
    }
  }
  return !1;
}
...
function attemptSynchronousHydration(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$276 = fiber.stateNode;
      if (root$276.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$276.pendingLanes);
        0 !== lanes &&
          (upgradePendingLanesToSync(root$276, lanes),
          ensureRootIsScheduled(root$276),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now() + 500),
            flushSyncWorkAcrossRoots_impl(!1)));
      }
...
var devToolsConfig$jscomp$inline_1712 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "19.0.0-www-modern-eb01ec3b",
  rendererPackageName: "react-dom"
};
var internals$jscomp$inline_2112 = {
  bundleType: devToolsConfig$jscomp$inline_1712.bundleType,
  version: devToolsConfig$jscomp$inline_1712.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1712.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1712.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1712.findFiberByHostInstance ||
  ...
  reconcilerVersion: "19.0.0-www-modern-eb01ec3b"
};
...
exports.hydrateRoot = function (container, children, options) {
  ...
  children.context = getContextForSubtree(null);
...
exports.version = "19.0.0-www-modern-eb01ec3b";

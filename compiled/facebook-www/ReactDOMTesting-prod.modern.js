  ...
  switch (finishedWork.tag) {
    ...
    case 30:
      isViewTransitionEligible &&
        ...
        null !== isViewTransitionEligible &&
          restoreUpdateViewTransition(isViewTransitionEligible, finishedWork));
      recursivelyTraversePassiveMountEffects(
        finishedRoot,
        finishedWork,
        committedLanes,
      ...
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              propKey$247 !== propKey && (viewTransitionMutationContext = !0);
              domElement.selected =
                propKey$247 &&
...
var internals$jscomp$inline_2748 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2749 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2749.isDisabled &&
    hook$jscomp$inline_2749.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2749.inject(
        internals$jscomp$inline_2748
      )),
        (injectedHook = hook$jscomp$inline_2749);
    } catch (err) {}
}

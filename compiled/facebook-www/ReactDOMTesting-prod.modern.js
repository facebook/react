...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$62 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$62.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$62.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$62.incompleteTransitions.forEach(function (markerInstance) {
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null !== JSCompiler_temp) {
    var dehydrated$69 = JSCompiler_temp.dehydrated;
    if (null !== dehydrated$69)
  ...
  if (showFallback) {
    ...
    dehydrated$69 = JSCompiler_temp.sibling;
    ...
    null !== dehydrated$69
      ? (showFallback = createWorkInProgress(dehydrated$69, showFallback))
    ...
    null === didSuspend
      ...
      : ((JSCompiler_temp = didSuspend.cachePool),
        null !== JSCompiler_temp
          ? ((dehydrated$69 = CacheContext._currentValue),
            (JSCompiler_temp =
              JSCompiler_temp.parent !== dehydrated$69
                ? { parent: dehydrated$69, pool: dehydrated$69 }
                : JSCompiler_temp))
    ...
    enableTransitionTracing &&
      ...
      null !== didSuspend &&
        ((JSCompiler_temp = enableTransitionTracing
          ? markerInstanceStack.current
          : null),
        (dehydrated$69 = showFallback.updateQueue),
        ...
        null === dehydrated$69
          ...
          : dehydrated$69 === primaryChildProps
          ? (showFallback.updateQueue = {
              transitions: didSuspend,
              markerInstances: JSCompiler_temp,
              retryQueue:
          ...
          : ((dehydrated$69.transitions = didSuspend),
            (dehydrated$69.markerInstances = JSCompiler_temp))));
    ...
    if (6 === exitStatus) markRootSuspended(root, lanes);
      ...
      if (
        ...
        if (2 === exitStatus) {
          ...
          0 !== errorRetryLanes$173 &&
            ((lanes = errorRetryLanes$173),
            (exitStatus = recoverFromConcurrentError(
              root,
              errorRetryLanes,
              errorRetryLanes$173
      ...
      switch (exitStatus) {
        ...
        case 4:
          ...
          for (errorRetryLanes$173 = -1; 0 < exitStatus; ) {
            var index$10 = 31 - clz32(exitStatus),
              lane = 1 << index$10;
            index$10 = errorRetryLanes[index$10];
            index$10 > errorRetryLanes$173 && (errorRetryLanes$173 = index$10);
            exitStatus &= ~lane;
          }
          exitStatus = errorRetryLanes$173;
                ...
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (wakeable === noopSuspenseyCommitThenable)
                    ...
                    if (null === offscreenQueue) {
                      ...
                      var retryQueue$57 = offscreenQueue.retryQueue;
                      null === retryQueue$57
                        ? (offscreenQueue.retryQueue = new Set([wakeable]))
                        : retryQueue$57.add(wakeable);
                    }
                  }
                  break;
                }
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    shouldFireAfterActiveInstanceBlur$181 &&
      ((_enabled = !0),
...
function attemptSynchronousHydration(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$184 = fiber.stateNode;
      if (root$184.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$184.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$184, lanes | 2),
          ensureRootIsScheduled(root$184, now()),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now() + 500),
            flushSyncCallbacks()));
      }
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$304 = isSupported$jscomp$inline_1562;
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$204 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$204);
          if (resource) break;
          resource = resourceRoot.querySelector(
            getStylesheetSelectorFromKey(key$204)
          );
          resource ||
            ((href = {
              rel: "stylesheet",
            ...
            (options = preloadPropsMap.get(key$204)) &&
          ...
          as.set(key$204, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$204 = getScriptKey(href)),
            (precedence = as.get(key$204)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$204
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$204, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$204 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$204 =
          'link[rel="preload"][as="' + as + '"][href="' + key$204 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$204) &&
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var key$211 = getStyleKey(pendingProps.href),
          styles$212 = getResourcesFromRoot(currentProps).hoistableStyles;
        type = styles$212.get(key$211);
        type ||
          ((currentProps = currentProps.ownerDocument || currentProps),
          (type = { type: "stylesheet", instance: null, count: 0 }),
          styles$212.set(key$211, type),
          preloadPropsMap.has(key$211) ||
            ((pendingProps = {
              rel: "preload",
              as: "style",
            ...
            preloadPropsMap.set(key$211, pendingProps),
            currentProps.querySelector(getStylesheetSelectorFromKey(key$211)) ||
              null !==
                currentProps.querySelector(
                  'link[rel="preload"][as="style"][' + key$211 + "]"
                ) ||
              ((key$211 = currentProps.createElement("link")),
              setInitialProperties(key$211, "link", pendingProps),
              markNodeAsHoistable(key$211),
              currentProps.head.appendChild(key$211))));
        return type;
      }
      return null;
    case "script":
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$219 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$219)
          return (
            (resource.instance = instance$219),
            markNodeAsHoistable(instance$219),
            instance$219
          );
        key = assign({}, props, {
          "data-precedence": props.precedence,
        ...
        setInitialProperties(instance$219, "link", key);
        insertStylesheet(instance$219, props.precedence, hoistableRoot);
        return (resource.instance = instance$219);
      case "script":
        instance$219 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            "script[async]" + instance$219
          ))
        )
          return (
        ...
        key = props;
        if ((styleProps = preloadPropsMap.get(instance$219)))
          (key = assign({}, props)),
...
var devToolsConfig$jscomp$inline_1782 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-1ad200fa",
...
var internals$jscomp$inline_2186 = {
  ...
  reconcilerVersion: "18.3.0-www-modern-1ad200fa"
};
...
exports.version = "18.3.0-www-modern-1ad200fa";

...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_355 = "oninput" in document;
    if (!isSupported$jscomp$inline_355) {
      var element$jscomp$inline_356 = document.createElement("div");
      element$jscomp$inline_356.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_355 =
        "function" === typeof element$jscomp$inline_356.oninput;
    }
    JSCompiler_inline_result$jscomp$210 = isSupported$jscomp$inline_355;
  } else JSCompiler_inline_result$jscomp$210 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$210 &&
...
for (
  var i$jscomp$inline_396 = 0;
  i$jscomp$inline_396 < simpleEventPluginEvents.length;
  i$jscomp$inline_396++
) {
  var eventName$jscomp$inline_397 =
      simpleEventPluginEvents[i$jscomp$inline_396],
    domEventName$jscomp$inline_398 = eventName$jscomp$inline_397.toLowerCase(),
    capitalizedEvent$jscomp$inline_399 =
      eventName$jscomp$inline_397[0].toUpperCase() +
      eventName$jscomp$inline_397.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_398,
    "on" + capitalizedEvent$jscomp$inline_399
  );
}
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$31 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$31);
          if (resource) break;
          resource = resourceRoot.querySelector(
            getStylesheetSelectorFromKey(key$31)
          );
          resource ||
            ((href = {
              rel: "stylesheet",
            ...
            (options = preloadPropsMap.get(key$31)) &&
          ...
          as.set(key$31, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$31 = getScriptKey(href)),
            (precedence = as.get(key$31)),
            precedence ||
              ...
              as.set(key$31, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$31 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$31 =
          'link[rel="preload"][as="' + as + '"][href="' + key$31 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$31) &&
            ((options = createElement(
              "link",
              href,
              resourceRoot,
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var key$37 = getStyleKey(pendingProps.href),
          styles$38 = getResourcesFromRoot(currentProps).hoistableStyles;
        type = styles$38.get(key$37);
        type ||
          ((currentProps = currentProps.ownerDocument || currentProps),
          (type = { type: "stylesheet", instance: null, count: 0 }),
          styles$38.set(key$37, type),
          preloadPropsMap.has(key$37) ||
            ((pendingProps = {
              rel: "preload",
              as: "style",
            ...
            preloadPropsMap.set(key$37, pendingProps),
            currentProps.querySelector(getStylesheetSelectorFromKey(key$37)) ||
              null !==
                currentProps.querySelector(
                  'link[rel="preload"][as="style"][' + key$37 + "]"
                ) ||
              ((key$37 = createElement(
                "link",
                pendingProps,
                currentProps,
                "http://www.w3.org/1999/xhtml"
              )),
              setInitialProperties(key$37, "link", pendingProps),
              (key$37[internalResourceMarker] = !0),
              currentProps.head.appendChild(key$37))));
        return type;
      }
      return null;
    case "script":
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$44 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$44) return (resource.instance = instance$44);
        key = assign({}, props, {
          "data-precedence": props.precedence,
          precedence: null
        });
        ...
        instance$44 = createElement(
          "link",
          key,
          hoistableRoot,
          "http://www.w3.org/1999/xhtml"
        );
        instance$44[internalResourceMarker] = !0;
        var linkInstance = instance$44;
        ...
        setInitialProperties(instance$44, "link", key);
        insertStylesheet(instance$44, props.precedence, hoistableRoot);
        return (resource.instance = instance$44);
      case "script":
        styleProps = getScriptKey(props.src);
        if (
          (instance$44 = hoistableRoot.querySelector(
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$74 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      return trackUsedThenable(thenableState, usable, index$74);
    }
    if (
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        null !== root$79 &&
          (scheduleUpdateOnFiber(root$79, provider, lane, eventTime),
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$76 = workInProgressRoot;
      if (null === root$76) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$76, renderLanes$1) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$76 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$76;
    mountEffect(subscribeToStore.bind(null, fiber, root$76, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null !== JSCompiler_temp) {
    var dehydrated$96 = JSCompiler_temp.dehydrated;
  ...
  if (showFallback) {
    ...
    dehydrated$96 = JSCompiler_temp.sibling;
    ...
    null === didSuspend
      ...
      : ((JSCompiler_temp = didSuspend.cachePool),
        null !== JSCompiler_temp
          ? ((dehydrated$96 = CacheContext._currentValue),
            (JSCompiler_temp =
              JSCompiler_temp.parent !== dehydrated$96
                ? { parent: dehydrated$96, pool: dehydrated$96 }
                : JSCompiler_temp))
  ...
  if (didBailout)
    for (var child$122 = completedWork.child; null !== child$122; )
      (newChildLanes |= child$122.lanes | child$122.childLanes),
        (subtreeFlags |= child$122.subtreeFlags & 14680064),
        (subtreeFlags |= child$122.flags & 14680064),
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$132 = newProps.memoizedState.cachePool.pool);
        cache$132 !== type && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      if (null === cache$132)
        if (newProps) cutOffTailIfNeeded(type, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$132 = findFirstSuspended(current);
              if (null !== cache$132) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(type, !1);
                current = cache$132.updateQueue;
                null !== current &&
                  ((workInProgress.updateQueue = current),
                  (workInProgress.flags |= 4));
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$132)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
            ...
            2 * now() - type.renderingStartTime >
              ...
              (workInProgress.lanes = 8388608));
        type.isBackwards
          ? ((cache$132.sibling = workInProgress.child),
            (workInProgress.child = cache$132))
          : ((current = type.last),
            null !== current
              ? (current.sibling = cache$132)
              : (workInProgress.child = cache$132),
            (type.last = cache$132));
      }
      if (null !== type.tail)
    ...
    if (6 === didTimeout) markRootSuspended(root, lanes);
      ...
      if (
        ...
        if (2 === didTimeout) {
          ...
          var errorRetryLanes$180 = getLanesToRetrySynchronouslyOnError(
            root,
            errorRetryLanes
          );
          0 !== errorRetryLanes$180 &&
            ((lanes = errorRetryLanes$180),
            (didTimeout = recoverFromConcurrentError(
              root,
              errorRetryLanes,
              errorRetryLanes$180
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$180 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$180),
              (errorRetryLanes$180 = didTimeout[errorRetryLanes$180]),
              errorRetryLanes$180 > originallyAttemptedLanes &&
              ...
              case 22:
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (null === offscreenQueue) {
                    ...
                    var wakeables$85 = offscreenQueue.wakeables;
                    null === wakeables$85
                      ? (offscreenQueue.wakeables = new Set([wakeable]))
                      : wakeables$85.add(wakeable);
                  }
                  break;
                }
              default:
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$189 = rootWithPendingPassiveEffects,
    ...
    try {
      ...
      (currentUpdatePriority = previousPriority),
        ...
        releaseRootPooledCache(root$189, remainingLanes);
    }
  }
  return !1;
}
...
_attemptSynchronousHydration = function (fiber) {
  switch (fiber.tag) {
    case 3:
      ...
      if (root$191.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$191.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$191, lanes | 2),
          ensureRootIsScheduled(root$191, now()),
          0 === (executionContext & 6) &&
...
var internals$jscomp$inline_2020 = {
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2021 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2021.isDisabled &&
    hook$jscomp$inline_2021.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2021.inject(
        internals$jscomp$inline_2020
      )),
        (injectedHook = hook$jscomp$inline_2021);
    } catch (err) {}
}

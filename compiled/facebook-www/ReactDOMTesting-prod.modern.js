...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (
    !hook$jscomp$inline_2590.isDisabled &&
    hook$jscomp$inline_2590.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2590.inject(
        internals$jscomp$inline_2589
      )),
        (injectedHook = hook$jscomp$inline_2590);
    } catch (err) {}
}

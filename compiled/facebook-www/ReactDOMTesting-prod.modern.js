    ...
    case 22:
      ...
      null !== finishedWork.memoizedState
        ? (isViewTransitionEligible &&
            ...
            restoreExitViewTransitions(current$178),
...
for (
  var i$jscomp$inline_1740 = 0;
  i$jscomp$inline_1740 < simpleEventPluginEvents.length;
  i$jscomp$inline_1740++
) {
  var eventName$jscomp$inline_1741 =
      simpleEventPluginEvents[i$jscomp$inline_1740],
    domEventName$jscomp$inline_1742 =
      eventName$jscomp$inline_1741.toLowerCase(),
    capitalizedEvent$jscomp$inline_1743 =
      eventName$jscomp$inline_1741[0].toUpperCase() +
      eventName$jscomp$inline_1741.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1742,
    "on" + capitalizedEvent$jscomp$inline_1743
  );
}
    ...
    case "link":
      if (
        ...
        resource$276 ||
          ...
          (styles$275 = JSCompiler_inline_result.querySelector(
            getStylesheetSelectorFromKey(type)
          )) &&
            !styles$275._p &&
            ((resource$276.instance = styles$275),
            (resource$276.state.loading = 5)),
...
var isomorphicReactPackageVersion$jscomp$inline_1926 = React.version;
if (
  "19.1.0-www-modern-696950aa-20250310" !==
  isomorphicReactPackageVersion$jscomp$inline_1926
)
  throw Error(
    formatProdErrorMessage(
      527,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2497 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2497.isDisabled &&
    hook$jscomp$inline_2497.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2497.inject(
        internals$jscomp$inline_2496
      )),
        (injectedHook = hook$jscomp$inline_2497);
    } catch (err) {}
}

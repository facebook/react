...
for (
  var i$jscomp$inline_1727 = 0;
  i$jscomp$inline_1727 < simpleEventPluginEvents.length;
  i$jscomp$inline_1727++
) {
  var eventName$jscomp$inline_1728 =
      simpleEventPluginEvents[i$jscomp$inline_1727],
    domEventName$jscomp$inline_1729 =
      eventName$jscomp$inline_1728.toLowerCase(),
    capitalizedEvent$jscomp$inline_1730 =
      eventName$jscomp$inline_1728[0].toUpperCase() +
      eventName$jscomp$inline_1728.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1729,
    "on" + capitalizedEvent$jscomp$inline_1730
  );
}
...
var isomorphicReactPackageVersion$jscomp$inline_1916 = React.version;
if (
  "19.1.0-www-modern-2e385738-20250314" !==
  isomorphicReactPackageVersion$jscomp$inline_1916
)
  throw Error(
    formatProdErrorMessage(
      527,
...
var internals$jscomp$inline_2503 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2504 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2504.isDisabled &&
    hook$jscomp$inline_2504.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2504.inject(
        internals$jscomp$inline_2503
      )),
        (injectedHook = hook$jscomp$inline_2504);
    } catch (err) {}
}

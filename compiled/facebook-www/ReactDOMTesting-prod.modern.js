...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$297 = isSupported$jscomp$inline_431;
...
function flushSyncWorkAcrossRoots_impl(onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$108 = firstScheduledRoot; null !== root$108; ) {
        if (!onlyLegacy) {
          var workInProgressRootRenderLanes$110 = workInProgressRootRenderLanes;
          workInProgressRootRenderLanes$110 = getNextLanes(
            root$108,
            root$108 === workInProgressRoot
              ? workInProgressRootRenderLanes$110
              : 0
          );
          0 !== (workInProgressRootRenderLanes$110 & 3) &&
            ((didPerformSomeWork = !0),
            performSyncWorkOnRoot(root$108, workInProgressRootRenderLanes$110));
        }
        root$108 = root$108.next;
      }
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$111 = !1;
    do {
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$111 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$111 &&
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$120 = enqueueUpdate(provider, fiber, lane);
        null !== root$120 &&
          (scheduleUpdateOnFiber(root$120, provider, lane),
          entangleTransitions(root$120, provider, lane));
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$114 = workInProgressRoot;
      if (null === root$114) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$114, workInProgressRootRenderLanes) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$114 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$114;
    mountEffect(subscribeToStore.bind(null, fiber, root$114, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
...
function resolveClassComponentProps(
  ...
  if (
    ...
    for (var propName$175 in Component)
      void 0 === newProps[propName$175] &&
        (newProps[propName$175] = Component[propName$175]);
  }
  return newProps;
}
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$216 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$216 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$216
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$216.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$217 = completedWork.child; null !== child$217; )
      (newChildLanes |= child$217.lanes | child$217.childLanes),
        (subtreeFlags |= child$217.subtreeFlags & 31457280),
        (subtreeFlags |= child$217.flags & 31457280),
        (child$217.return = completedWork),
        (child$217 = child$217.sibling);
  else
    for (child$217 = completedWork.child; null !== child$217; )
      (newChildLanes |= child$217.lanes | child$217.childLanes),
        (subtreeFlags |= child$217.subtreeFlags),
        (subtreeFlags |= child$217.flags),
        (child$217.return = completedWork),
        (child$217 = child$217.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$229 = newProps.memoizedState.cachePool.pool);
        cache$229 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
    ...
    case 19:
      ...
      cache$229 = currentResource.rendering;
      if (null === cache$229)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$229 = findFirstSuspended(current);
              if (null !== cache$229) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$229.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$229)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$229.sibling = workInProgress.child),
            (workInProgress.child = cache$229))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$229)
              : (workInProgress.child = cache$229),
            (currentResource.last = cache$229));
      }
...
function renderRootSync(root, lanes) {
  ...
  a: do
    try {
      ...
      workLoopSync();
      break;
    } catch (thrownValue$247) {
      handleThrow(root, thrownValue$247);
    }
  while (1);
...
function renderRootConcurrent(root, lanes) {
  ...
  a: do
    try {
      ...
      workLoopConcurrent();
      break;
    } catch (thrownValue$249) {
      handleThrow(root, thrownValue$249);
    }
  while (1);
  resetContextDependencies();
  ReactSharedInternals.H = prevDispatcher;
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    executionContext |= 4;
    ReactSharedInternals.owner = null;
    var shouldFireAfterActiveInstanceBlur$253 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitMutationEffectsOnFiber(finishedWork, root);
    shouldFireAfterActiveInstanceBlur$253 &&
      ((_enabled = !0),
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$254 = rootWithPendingPassiveEffects,
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$259 = getResourcesFromRoot(currentProps).hoistableStyles,
...
function injectIntoDevTools(devToolsConfig) {
  devToolsConfig = {
    ...
    reconcilerVersion: "19.0.0-www-modern-97008ace"
  };
...
injectIntoDevTools({
  ...
  bundleType: 0,
  version: "19.0.0-www-modern-97008ace",
...
exports.version = "19.0.0-www-modern-97008ace";

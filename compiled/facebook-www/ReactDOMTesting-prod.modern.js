...
function requestAsyncActionContext(actionReturnValue) {
  if (
    ...
    var asyncAction$45 = currentAsyncAction;
    attachPingListeners(actionReturnValue, asyncAction$45);
    return asyncAction$45;
  }
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        null !== root$51 &&
          (scheduleUpdateOnFiber(root$51, provider, lane),
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1632 = "oninput" in document;
    if (!isSupported$jscomp$inline_1632) {
      var element$jscomp$inline_1633 = document.createElement("div");
      element$jscomp$inline_1633.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1632 =
        "function" === typeof element$jscomp$inline_1633.oninput;
    }
    JSCompiler_inline_result$jscomp$373 = isSupported$jscomp$inline_1632;
...
for (
  var i$jscomp$inline_1673 = 0;
  i$jscomp$inline_1673 < simpleEventPluginEvents.length;
  i$jscomp$inline_1673++
) {
  var eventName$jscomp$inline_1674 =
      simpleEventPluginEvents[i$jscomp$inline_1673],
    domEventName$jscomp$inline_1675 =
      eventName$jscomp$inline_1674.toLowerCase(),
    capitalizedEvent$jscomp$inline_1676 =
      eventName$jscomp$inline_1674[0].toUpperCase() +
      eventName$jscomp$inline_1674.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1675,
    "on" + capitalizedEvent$jscomp$inline_1676
  );
}
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      return;
    case "select":
      defaultValue = value = propKey = propKey$219 = null;
      ...
      updateSelect(domElement, propKey$219, propKey, value, defaultValue);
      return;
    case "textarea":
...
var devToolsConfig$jscomp$inline_1843 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-bcc00dd5",
...
var internals$jscomp$inline_2217 = {
  ...
  reconcilerVersion: "18.3.0-www-modern-bcc00dd5"
};
...
exports.version = "18.3.0-www-modern-bcc00dd5";

...
var internals$jscomp$inline_2719 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2720 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2720.isDisabled &&
    hook$jscomp$inline_2720.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2720.inject(
        internals$jscomp$inline_2719
      )),
        (injectedHook = hook$jscomp$inline_2720);
    } catch (err) {}
}

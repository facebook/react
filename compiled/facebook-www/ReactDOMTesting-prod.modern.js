...
for (
  var i$jscomp$inline_1772 = 0;
  i$jscomp$inline_1772 < simpleEventPluginEvents.length;
  i$jscomp$inline_1772++
) {
  var eventName$jscomp$inline_1773 =
      simpleEventPluginEvents[i$jscomp$inline_1772],
    domEventName$jscomp$inline_1774 =
      eventName$jscomp$inline_1773.toLowerCase(),
    capitalizedEvent$jscomp$inline_1775 =
      eventName$jscomp$inline_1773[0].toUpperCase() +
      eventName$jscomp$inline_1773.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1774,
    "on" + capitalizedEvent$jscomp$inline_1775
  );
}

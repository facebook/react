...
__DEV__ &&
  (function () {
    ...
    function mountResourceEffect(
      ...
      if (
        ...
        var hookFlags = Passive,
          hook = mountWorkInProgressHook();
        currentlyRenderingFiber.flags |= 142608384;
    ...
    function mountLayoutEffect(create, deps) {
      ...
      0 !== (currentlyRenderingFiber.mode & 16) && (fiberFlags |= 67108864);
    ...
    function updateContainerSync(
      ...
      a: if (parentComponent) {
        ...
        b: {
          ...
          if (!parentContext || 1 !== parentComponent.tag)
            throw Error(
    ...
    (function () {
      var internals = {
        bundleType: 1,
        version: "19.1.0-www-classic-c81312e3-20250102",
        rendererPackageName: "react-art",
        currentDispatcherRef: ReactSharedInternals,
        reconcilerVersion: "19.1.0-www-classic-c81312e3-20250102"
      };
    ...
    exports.Text = Text;
    exports.version = "19.1.0-www-classic-c81312e3-20250102";
    "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
      "function" ===

...
__DEV__ &&
  (function () {
    ...
    function processRootScheduleInMicrotask() {
      ...
      for (
        ...
        0 === nextLanes
          ...
          : ((prev = root),
            0 !== (nextLanes & (SyncLane | SyncHydrationLane)) &&
              (mightHavePendingSyncWork = !0));
        root = next;
      }
              ...
              disableLegacyMode || 0 !== (currentSourceFiber.mode & 1)
                ...
                : ((currentSourceFiber.flags |= 128),
                  ...
                  1 === sourceFiber.tag
                    ? null === sourceFiber.alternate
                      ? (sourceFiber.tag = 17)
                      : ((returnFiber = createUpdate(SyncLane)),
                        (returnFiber.tag = ForceUpdate),
                        enqueueUpdate(sourceFiber, returnFiber, SyncLane))
                    : 0 === sourceFiber.tag &&
                      null === sourceFiber.alternate &&
                      (sourceFiber.tag = 28),
            ...
            if (enableUnifiedSyncLane && 0 !== (nextProps & SyncUpdateLanes))
              ...
              switch (nextProps) {
                case SyncLane:
                  ...
                  break;
                case InputContinuousLane:
                  nextProps = InputContinuousHydrationLane;
                  break;
                case DefaultLane:
                  nextProps = DefaultHydrationLane;
                  break;
                case 128:
                case 256:
                case 512:
                ...
                case 16777216:
                case 33554432:
                  nextProps = TransitionHydrationLane;
                  break;
                case IdleLane:
                  nextProps = IdleHydrationLane;
                  break;
                default:
                  nextProps = 0;
              }
      ...
      switch (workInProgress.tag) {
        ...
        case 10:
          a: {
            ...
            pushProvider(workInProgress, returnFiber, nextCache);
            if (!enableLazyContextPropagation && null !== nextProps)
              if (objectIs(nextProps.value, nextCache)) {
                if (
                  nextProps.children === prevSibling.children &&
                  !didPerformWorkStackCursor.current
                ) {
                  workInProgress = bailoutOnAlreadyFinishedWork(
                    current,
        ...
        if (0 !== (root.subtreeFlags & 9236) && null !== firstChild)
          ...
          for (; null !== nextEffect; ) {
            ...
            try {
              ...
              captureCommitPhaseError(root, root.return, error$12);
            }
      ...
      if (null !== deletions)
        for (var i = 0; i < deletions.length; i++) {
          ...
          try {
            ...
            captureCommitPhaseError(childToDelete, parentFiber, error$25);
          }
        }
    ...
    function commitHookPassiveMountEffects(finishedWork, hookFlags) {
      if (shouldProfile(finishedWork)) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$36);
        }
    }
      ...
      switch (fiber.tag) {
        ...
        case 15:
          try {
            ...
            captureCommitPhaseError(fiber, fiber.return, error$40);
          }
          break;
        case 1:
          var instance = fiber.stateNode;
      ...
      switch (fiber.tag) {
        ...
        case 15:
          try {
            ...
            captureCommitPhaseError(fiber, fiber.return, error$41);
          }
      }
    }
    ...
    function requestUpdateLane(fiber) {
      var mode = fiber.mode;
      if (!disableLegacyMode && 0 === (mode & 1)) return SyncLane;
      if (
    ...
    function renderRootConcurrent(root, lanes) {
      ...
      a: do
        try {
          ...
          handleThrow(root, thrownValue$44);
        }
      while (1);
      resetContextDependencies();
      ReactSharedInternals.H = prevDispatcher;
    ...
    function throwAndUnwindWorkLoop(root, unitOfWork, thrownValue) {
      ...
      try {
        ...
        if (null !== returnFiber)
          throw ((workInProgress = returnFiber), error$45);
        workInProgressRootExitStatus = RootFatalErrored;
        logUncaughtError(
          root,
          createCapturedValueAtFiber(thrownValue, root.current)
    ...
    (function (devToolsConfig) {
      return injectInternals({
        ...
        reconcilerVersion: "19.0.0-www-classic-babe5a2f1b-20240620"
      });
    })({
      ...
      bundleType: 1,
      version: "19.0.0-www-classic-babe5a2f1b-20240620",

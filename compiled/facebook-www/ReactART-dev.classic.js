  ...
  (function () {
    ...
    function completeRoot(
      ...
      if (exitStatus === RootErrored)
        ...
        if (
          ...
          for (var properties = [], i = 0; i < recoverableErrors.length; i++) {
    ...
    function flushSpawnedWork() {
      if (
        ...
        abortedViewTransition = pendingDidIncludeRenderPhaseUpdate;
        var passiveSubtreeMask =
          enableViewTransition && (endTime & 335544064) === endTime
            ? 10262
            : 10256;
        (passiveSubtreeMask =
          0 !== finishedWork.actualDuration ||
    ...
    (function () {
      var internals = {
        bundleType: 1,
        version: "19.3.0-www-classic-cd0c4879-20260203",
        rendererPackageName: "react-art",
        currentDispatcherRef: ReactSharedInternals,
        reconcilerVersion: "19.3.0-www-classic-cd0c4879-20260203"
      };
    ...
    exports.Text = Text;
    exports.version = "19.3.0-www-classic-cd0c4879-20260203";
    "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
      "function" ===

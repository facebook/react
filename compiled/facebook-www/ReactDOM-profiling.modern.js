...
function initInput(
  ...
  isHydrating || (element.checked = !!checked);
  disableInputAttributeSyncing
...
function findCurrentFiberUsingSlowPath(fiber) {
  ...
  for (var a = fiber, b = alternate; ; ) {
    ...
    if (a.return !== b.return) (a = parentA), (b = parentB);
      ...
      for (var didFindChild = !1, child$21 = parentA.child; child$21; ) {
        if (child$21 === a) {
          didFindChild = !0;
          a = parentA;
          b = parentB;
        ...
        child$21 = child$21.sibling;
      }
      if (!didFindChild) {
        for (child$21 = parentB.child; child$21; ) {
          if (child$21 === a) {
            didFindChild = !0;
            a = parentB;
            b = parentA;
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$47 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      usable = trackUsedThenable(thenableState, usable, index$47);
    ...
    switch (provider.tag) {
      ...
      case 3:
        ...
        if (null !== root$53) {
          ...
          scheduleUpdateOnFiber(root$53, provider, lane, eventTime);
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    ...
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$66.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$66.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null !== JSCompiler_temp) {
    var dehydrated$73 = JSCompiler_temp.dehydrated;
    if (null !== dehydrated$73)
  ...
  if (showFallback) {
    ...
    dehydrated$73 = JSCompiler_temp.sibling;
    ...
    null !== dehydrated$73
      ? (showFallback = createWorkInProgress(dehydrated$73, showFallback))
    ...
    null === didSuspend
      ...
      : ((JSCompiler_temp = didSuspend.cachePool),
        null !== JSCompiler_temp
          ? ((dehydrated$73 = CacheContext._currentValue),
            (JSCompiler_temp =
              JSCompiler_temp.parent !== dehydrated$73
                ? { parent: dehydrated$73, pool: dehydrated$73 }
                : JSCompiler_temp))
    ...
    enableTransitionTracing &&
      ...
      null !== didSuspend &&
        ...
        null === dehydrated$73
          ...
          : dehydrated$73 === primaryChildProps
          ? (showFallback.updateQueue = {
              transitions: didSuspend,
              markerInstances: JSCompiler_temp,
              retryQueue:
          ...
          : ((dehydrated$73.transitions = didSuspend),
            (dehydrated$73.markerInstances = JSCompiler_temp))));
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$107 = completedWork.selfBaseDuration,
          child$108 = completedWork.child;
        null !== child$108;
        ...
        (newChildLanes |= child$108.lanes | child$108.childLanes),
          ...
          (treeBaseDuration$107 += child$108.treeBaseDuration),
          (child$108 = child$108.sibling);
      completedWork.treeBaseDuration = treeBaseDuration$107;
    } else
      for (
        treeBaseDuration$107 = completedWork.child;
        null !== treeBaseDuration$107;

      )
        (newChildLanes |=
          treeBaseDuration$107.lanes | treeBaseDuration$107.childLanes),
          (subtreeFlags |= treeBaseDuration$107.subtreeFlags & 31457280),
          (subtreeFlags |= treeBaseDuration$107.flags & 31457280),
          (treeBaseDuration$107.return = completedWork),
          (treeBaseDuration$107 = treeBaseDuration$107.sibling);
    ...
    for (var child = completedWork.child; null !== child; )
      (newChildLanes |= child.lanes | child.childLanes),
        ...
        (treeBaseDuration$107 += child.actualDuration),
        (child$108 += child.treeBaseDuration),
        (child = child.sibling);
    completedWork.actualDuration = treeBaseDuration$107;
    completedWork.treeBaseDuration = child$108;
  } else
    for (
      treeBaseDuration$107 = completedWork.child;
      null !== treeBaseDuration$107;
      ...
      (newChildLanes |=
        treeBaseDuration$107.lanes | treeBaseDuration$107.childLanes),
        (subtreeFlags |= treeBaseDuration$107.subtreeFlags),
        (subtreeFlags |= treeBaseDuration$107.flags),
        (treeBaseDuration$107.return = completedWork),
        (treeBaseDuration$107 = treeBaseDuration$107.sibling);
  ...
  switch (workInProgress.tag) {
    ...
    case 27:
      ...
      if (null !== current && null != workInProgress.stateNode)
        updateHostComponent(current, workInProgress, nextResource, newProps),
          current.ref !== workInProgress.ref && markRef(workInProgress);
      else {
        if (!newProps) {
          if (null === workInProgress.stateNode)
        ...
        if (popHydrationState(workInProgress))
          ...
          switch (current) {
            ...
            case "http://www.w3.org/1998/Math/MathML":
              current = nextResource.createElementNS(current, renderLanes);
              break;
            default:
              switch (renderLanes) {
                case "svg":
...
function flushSyncWorkAcrossRoots_impl(onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$191 = firstScheduledRoot; null !== root$191; ) {
        if (
          (!onlyLegacy || 0 === root$191.tag) &&
          0 !==
            (getNextLanes(
              root$191,
              root$191 === workInProgressRoot$jscomp$0
    ...
    if (6 === exitStatus) markRootSuspended(root, lanes);
      ...
      switch (exitStatus) {
        ...
        case 4:
          ...
          for (errorRetryLanes$194 = -1; 0 < exitStatus; ) {
            var index$2 = 31 - clz32(exitStatus),
              lane = 1 << index$2;
            index$2 = errorRetryLanes[index$2];
            index$2 > errorRetryLanes$194 && (errorRetryLanes$194 = index$2);
            exitStatus &= ~lane;
          }
          exitStatus = errorRetryLanes$194;
                ...
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (wakeable === noopSuspenseyCommitThenable)
                    ...
                    if (null === offscreenQueue) {
                      ...
                      var retryQueue$61 = offscreenQueue.retryQueue;
                      null === retryQueue$61
  ...
  switch (fiber.tag) {
    case 3:
      ...
      if (root$207.current.memoizedState.isDehydrated) {
        ...
        0 !== lanes &&
          (markRootEntangled(root$207, lanes | 2),
...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$399;
  if (canUseDOM) {
    var isSupported$jscomp$inline_1684 = "oninput" in document;
    if (!isSupported$jscomp$inline_1684) {
      var element$jscomp$inline_1685 = document.createElement("div");
      element$jscomp$inline_1685.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1684 =
        "function" === typeof element$jscomp$inline_1685.oninput;
    }
    JSCompiler_inline_result$jscomp$399 = isSupported$jscomp$inline_1684;
  } else JSCompiler_inline_result$jscomp$399 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$399 &&
...
for (
  var i$jscomp$inline_1725 = 0;
  i$jscomp$inline_1725 < simpleEventPluginEvents.length;
  i$jscomp$inline_1725++
) {
  var eventName$jscomp$inline_1726 =
      simpleEventPluginEvents[i$jscomp$inline_1725],
    domEventName$jscomp$inline_1727 =
      eventName$jscomp$inline_1726.toLowerCase(),
    capitalizedEvent$jscomp$inline_1728 =
      eventName$jscomp$inline_1726[0].toUpperCase() +
      eventName$jscomp$inline_1726.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1727,
    "on" + capitalizedEvent$jscomp$inline_1728
  );
}
        ...
        if (enableCustomElementPropertySupport)
          a: {
            ...
            if (
              ...
              (value = key.substr(2, tag ? key.length - 9 : void 0)),
...
function setInitialProperties(domElement, tag, props) {
  switch (tag) {
    ...
    case "select":
      listenToNonDelegatedEvent("invalid", domElement);
      var propKey = (value = defaultValue = null);
      for (type in props)
        if (
          props.hasOwnProperty(type) &&
          ((checked = props[type]), null != checked)
        )
          switch (type) {
            case "value":
            ...
            case "multiple":
              propKey = checked;
            default:
              setProp(domElement, tag, type, checked, props, null);
          }
      tag = defaultValue;
      props = value;
    ...
    case "textarea":
      ...
      for (value in props)
        if (
          ...
          ((defaultValue = props[value]), null != defaultValue)
        )
          switch (value) {
            case "value":
            ...
            case "dangerouslySetInnerHTML":
              ...
              break;
            default:
              setProp(domElement, tag, value, defaultValue, props);
          }
      track(domElement);
      initTextarea(domElement, propKey, type);
      return;
    case "option":
    ...
    case "menuitem":
      for (defaultChecked in props)
        if (
          ...
          ((propKey = props[defaultChecked]), null != propKey)
        )
          switch (defaultChecked) {
            ...
            case "dangerouslySetInnerHTML":
              throw Error(formatProdErrorMessage(137, tag));
            default:
              setProp(domElement, tag, defaultChecked, propKey, props, null);
          }
      return;
    default:
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
          ...
          switch (propKey$240) {
            case "type":
              ...
              propKey !== lastProp &&
                ...
                "function" !== typeof propKey &&
                "symbol" !== typeof propKey &&
                "boolean" !== typeof propKey
                  ? domElement.setAttribute(propKey$240, propKey)
                  : domElement.removeAttribute(propKey$240));
              break;
            case "name":
              name = propKey;
              break;
            case "checked":
              ...
              propKey !== lastProp &&
                ((propKey =
                  null != propKey ? propKey : nextProps.defaultChecked),
                (domElement.checked =
                  !!propKey &&
                  "function" !== typeof propKey &&
                  "symbol" !== propKey));
      ...
      return;
    case "select":
      defaultValue = value = propKey = propKey$240 = null;
      ...
      updateSelect(domElement, propKey$240, propKey, value, defaultValue);
      return;
    case "textarea":
    ...
    case "option":
      for (var propKey$258 in lastProps)
        if (
          ((propKey$240 = lastProps[propKey$258]),
    ...
    case "menuitem":
      for (var propKey$263 in lastProps)
        (propKey$240 = lastProps[propKey$263]),
          lastProps.hasOwnProperty(propKey$263) &&
            null != propKey$240 &&
            !nextProps.hasOwnProperty(propKey$263) &&
            setProp(domElement, tag, propKey$263, null, nextProps, propKey$240);
    ...
    default:
      if (isCustomElement(tag)) {
        for (var propKey$268 in lastProps)
          (propKey$240 = lastProps[propKey$268]),
  ...
  for (var propKey$273 in lastProps)
    (propKey$240 = lastProps[propKey$273]),
      lastProps.hasOwnProperty(propKey$273) &&
        null != propKey$240 &&
        !nextProps.hasOwnProperty(propKey$273) &&
        setProp(domElement, tag, propKey$273, null, nextProps, propKey$240);
      ...
      for (name = 0; name < updatePayload.length; name += 2)
        switch (
          ...
          case "selected":
            ...
            break;
          default:
            setProp(domElement, tag, type, value, nextProps, null);
        }
      return;
    case "img":
    case "link":
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$301 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$301);
          if (resource) break;
          var state = { loading: 0, preload: null };
          if (
            (resource = resourceRoot.querySelector(
              getStylesheetSelectorFromKey(key$301)
            ))
          )
            state.loading = 1;
          else {
            ...
            (options = preloadPropsMap.get(key$301)) &&
          ...
          as.set(key$301, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$301 = getScriptKey(href)),
            (precedence = as.get(key$301)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$301
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$301, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$301 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$301 =
          'link[rel="preload"][as="' + as + '"][href="' + key$301 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$301) &&
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$310 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$311 = styles$310.get(type);
        resource$311 ||
          ...
          styles$310.set(type, resource$311),
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$316 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$316)
          return (
            (resource.instance = instance$316),
            markNodeAsHoistable(instance$316),
            instance$316
          );
        ...
        markNodeAsHoistable(instance$316);
        var linkInstance = instance$316;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$316, "link", key);
        resource.state.loading |= 4;
        insertStylesheet(instance$316, props.precedence, hoistableRoot);
        return (resource.instance = instance$316);
      case "script":
        instance$316 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            "script[async]" + instance$316
          ))
        )
          return (
        ...
        key = props;
        if ((styleProps = preloadPropsMap.get(instance$316)))
          (key = assign({}, props)),
...
var devToolsConfig$jscomp$inline_1893 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "18.3.0-www-modern-5297e767",
...
(function (internals) {
  ...
  bundleType: devToolsConfig$jscomp$inline_1893.bundleType,
  version: devToolsConfig$jscomp$inline_1893.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1893.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1893.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1893.findFiberByHostInstance ||
  ...
  reconcilerVersion: "18.3.0-www-modern-5297e767"
});
...
exports.version = "18.3.0-www-modern-5297e767";

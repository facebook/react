...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1759 = "oninput" in document;
    if (!isSupported$jscomp$inline_1759) {
      var element$jscomp$inline_1760 = document.createElement("div");
      element$jscomp$inline_1760.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1759 =
        "function" === typeof element$jscomp$inline_1760.oninput;
    }
    JSCompiler_inline_result$jscomp$377 = isSupported$jscomp$inline_1759;
...
if (
  "19.1.0-www-modern-605a880c-20250303" !==
...
var internals$jscomp$inline_1980 = {
  bundleType: 0,
...
enableSchedulingProfiler &&
  ((internals$jscomp$inline_1980.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_1980.injectProfilingHooks = injectProfilingHooks));
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2500 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2500.isDisabled &&
    hook$jscomp$inline_2500.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2500.inject(
        internals$jscomp$inline_1980
      )),
        (injectedHook = hook$jscomp$inline_2500);
    } catch (err) {}
}

          ...
          if (0 !== syncTransitionLanes) {
            ...
            (JSCompiler_inline_result = workInProgressRootRenderLanes),
              ...
              0 === (JSCompiler_inline_result & 3) ||
                checkIfRootIsPrerendering(root$28, JSCompiler_inline_result) ||
                ((didPerformSomeWork = !0),
                performSyncWorkOnRoot(root$28, JSCompiler_inline_result));
...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$176 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$176;
      if (null !== hostParent)
...
function getLaneLabelMap() {
  if (enableSchedulingProfiler) {
    for (
      var map = new Map(), lane = 1, index$214 = 0;
      31 > index$214;
      index$214++
    ) {
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$372 = isSupported$jscomp$inline_1609;
  ...
  switch (tag) {
    ...
    case "input":
      ...
      for (hasSrc in props)
        if (props.hasOwnProperty(hasSrc)) {
          var propValue$230 = props[hasSrc];
          if (null != propValue$230)
            switch (hasSrc) {
              case "name":
                hasSrcSet = propValue$230;
                break;
              case "type":
                propKey = propValue$230;
                break;
              case "checked":
                checked = propValue$230;
                break;
              case "defaultChecked":
                defaultChecked = propValue$230;
                break;
              case "value":
                propValue = propValue$230;
                break;
              case "defaultValue":
                defaultValue = propValue$230;
                break;
              case "children":
              case "dangerouslySetInnerHTML":
                if (null != propValue$230)
                ...
                break;
              default:
                setProp(domElement, tag, hasSrc, propValue$230, props, null);
            }
        }
      initInput(
        domElement,
    ...
    default:
      if (isCustomElement(tag)) {
        for (propValue$230 in props)
          props.hasOwnProperty(propValue$230) &&
            ((hasSrc = props[propValue$230]),
            void 0 !== hasSrc &&
...
if (
  "19.0.0-www-modern-8a41d6ce-20241114" !==
...
enableSchedulingProfiler &&
  ((internals$jscomp$inline_1825.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_1825.injectProfilingHooks = injectProfilingHooks));

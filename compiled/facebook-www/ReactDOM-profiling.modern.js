      ...
      for (var root$31 = firstScheduledRoot; null !== root$31; ) {
        if (!onlyLegacy)
          if (0 !== syncTransitionLanes) {
            var pendingLanes = root$31.pendingLanes;
            if (0 === pendingLanes) var JSCompiler_inline_result = 0;
            else {
              var suspendedLanes = root$31.suspendedLanes,
                pingedLanes = root$31.pingedLanes;
            ...
            0 !== JSCompiler_inline_result &&
              ...
              performSyncWorkOnRoot(root$31, JSCompiler_inline_result));
          } else
            (JSCompiler_inline_result = workInProgressRootRenderLanes),
              (JSCompiler_inline_result = getNextLanes(
                root$31,
                root$31 === workInProgressRoot ? JSCompiler_inline_result : 0,
                null !== root$31.cancelPendingCommit ||
                  -1 !== root$31.timeoutHandle
              )),
              0 === (JSCompiler_inline_result & 3) ||
                checkIfRootIsPrerendering(root$31, JSCompiler_inline_result) ||
                ((didPerformSomeWork = !0),
                performSyncWorkOnRoot(root$31, JSCompiler_inline_result));
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$98 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$98.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$98.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$135 = completedWork.selfBaseDuration,
          child$136 = completedWork.child;
        null !== child$136;
        ...
        (newChildLanes |= child$136.lanes | child$136.childLanes),
          ...
          (treeBaseDuration$135 += child$136.treeBaseDuration),
          (child$136 = child$136.sibling);
      completedWork.treeBaseDuration = treeBaseDuration$135;
    } else
      for (
        treeBaseDuration$135 = completedWork.child;
        null !== treeBaseDuration$135;

      )
        (newChildLanes |=
          treeBaseDuration$135.lanes | treeBaseDuration$135.childLanes),
          (subtreeFlags |= treeBaseDuration$135.subtreeFlags & 65011712),
          (subtreeFlags |= treeBaseDuration$135.flags & 65011712),
          (treeBaseDuration$135.return = completedWork),
          (treeBaseDuration$135 = treeBaseDuration$135.sibling);
  else if (0 !== (completedWork.mode & 2)) {
    treeBaseDuration$135 = completedWork.actualDuration;
    child$136 = completedWork.selfBaseDuration;
    for (var child = completedWork.child; null !== child; )
      (newChildLanes |= child.lanes | child.childLanes),
        (subtreeFlags |= child.subtreeFlags),
        (subtreeFlags |= child.flags),
        (treeBaseDuration$135 += child.actualDuration),
        (child$136 += child.treeBaseDuration),
        (child = child.sibling);
    completedWork.actualDuration = treeBaseDuration$135;
    completedWork.treeBaseDuration = child$136;
  } else
    for (
      treeBaseDuration$135 = completedWork.child;
      null !== treeBaseDuration$135;
      ...
      (newChildLanes |=
        treeBaseDuration$135.lanes | treeBaseDuration$135.childLanes),
        (subtreeFlags |= treeBaseDuration$135.subtreeFlags),
        (subtreeFlags |= treeBaseDuration$135.flags),
        (treeBaseDuration$135.return = completedWork),
        (treeBaseDuration$135 = treeBaseDuration$135.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 27:
      ...
      var type$141 = workInProgress.type;
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode)
        ...
        if (popHydrationState(workInProgress))
          ...
          type$141 = getOwnerDocumentFromRootContainer(
            rootInstanceStackCursor.current
          );
          switch (current) {
            case 1:
              current = type$141.createElementNS(
            ...
            default:
              switch (renderLanes) {
                ...
                case "math":
                  ...
                  break;
                case "script":
                  current = type$141.createElement("div");
                ...
                case "select":
                  current =
                    "string" === typeof newProps.is
                      ? type$141.createElement("select", { is: newProps.is })
                      : type$141.createElement("select");
                  newProps.multiple
                    ? (current.multiple = !0)
                ...
                default:
                  current =
                    "string" === typeof newProps.is
                      ? type$141.createElement(renderLanes, { is: newProps.is })
                      : type$141.createElement(renderLanes);
              }
          }
          current[internalInstanceKey] = workInProgress;
          current[internalPropsKey] = newProps;
          a: for (type$141 = workInProgress.child; null !== type$141; ) {
            if (5 === type$141.tag || 6 === type$141.tag)
              current.appendChild(type$141.stateNode);
            else if (
              4 !== type$141.tag &&
              27 !== type$141.tag &&
              null !== type$141.child
            ) {
              type$141.child.return = type$141;
              type$141 = type$141.child;
              continue;
            }
            if (type$141 === workInProgress) break a;
            for (; null === type$141.sibling; ) {
              if (
                null === type$141.return ||
                type$141.return === workInProgress
              )
                break a;
              type$141 = type$141.return;
            }
            type$141.sibling.return = type$141.return;
            type$141 = type$141.sibling;
          }
          workInProgress.stateNode = current;
          a: switch (
    ...
    case 6:
      if (current && null != workInProgress.stateNode)
        ...
        if (popHydrationState(workInProgress)) {
          ...
          newProps = null;
          type$141 = hydrationParentFiber;
          if (null !== type$141)
            switch (type$141.tag) {
              case 27:
              case 5:
                newProps = type$141.memoizedProps;
            }
          current[internalInstanceKey] = workInProgress;
          current =
    ...
    case 13:
      ...
      if (
        ...
        type$141 = popHydrationState(workInProgress);
        if (null !== newProps && null !== newProps.dehydrated) {
          if (null === current) {
            if (!type$141) throw Error(formatProdErrorMessage(318));
            type$141 = workInProgress.memoizedState;
            type$141 = null !== type$141 ? type$141.dehydrated : null;
            if (!type$141) throw Error(formatProdErrorMessage(317));
            type$141[internalInstanceKey] = workInProgress;
            bubbleProperties(workInProgress);
            0 !== (workInProgress.mode & 2) &&
              null !== newProps &&
              ((type$141 = workInProgress.child),
              null !== type$141 &&
                (workInProgress.treeBaseDuration -= type$141.treeBaseDuration));
          } else
            resetHydrationState(),
              0 === (workInProgress.flags & 128) &&
                (workInProgress.memoizedState = null),
              ...
              0 !== (workInProgress.mode & 2) &&
                ...
                null !== type$141 &&
                  (workInProgress.treeBaseDuration -=
                    type$141.treeBaseDuration));
          type$141 = !1;
        } else
          (type$141 = upgradeHydrationErrorsToRecoverable()),
            null !== current &&
              null !== current.memoizedState &&
              (current.memoizedState.hydrationErrors = type$141),
            (type$141 = !0);
        if (!type$141) {
      ...
      if (renderLanes) {
        ...
        null !== newProps.alternate &&
          ...
          (type$141 = newProps.alternate.memoizedState.cachePool.pool);
        var cache$153 = null;
        null !== newProps.memoizedState &&
          null !== newProps.memoizedState.cachePool &&
          (cache$153 = newProps.memoizedState.cachePool.pool);
        cache$153 !== type$141 && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
    ...
    case 19:
      pop(suspenseStackCursor);
      type$141 = workInProgress.memoizedState;
      if (null === type$141) return bubbleProperties(workInProgress), null;
      newProps = 0 !== (workInProgress.flags & 128);
      cache$153 = type$141.rendering;
      if (null === cache$153)
        if (newProps) cutOffTailIfNeeded(type$141, !1);
        else {
          if (
            0 !== workInProgressRootExitStatus ||
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$153)), null !== current)) {
            if (
              ...
              (workInProgress.updateQueue = current),
              scheduleRetryEffect(workInProgress, current),
              cutOffTailIfNeeded(type$141, !0),
              null === type$141.tail &&
                "hidden" === type$141.tailMode &&
                !cache$153.alternate &&
                !isHydrating)
            )
              return bubbleProperties(workInProgress), null;
          } else
            2 * now$1() - type$141.renderingStartTime >
              ...
              cutOffTailIfNeeded(type$141, !1),
              (workInProgress.lanes = 4194304));
        type$141.isBackwards
          ? ((cache$153.sibling = workInProgress.child),
            (workInProgress.child = cache$153))
          : ((current = type$141.last),
            null !== current
              ? (current.sibling = cache$153)
              : (workInProgress.child = cache$153),
            (type$141.last = cache$153));
      }
      if (null !== type$141.tail)
        return (
          (workInProgress = type$141.tail),
          (type$141.rendering = workInProgress),
          (type$141.tail = workInProgress.sibling),
          (type$141.renderingStartTime = now$1()),
  ...
  switch (finishedWork.tag) {
    ...
    case 6:
      ...
      if (flags & 4) {
        ...
        try {
          (current.nodeValue = flags), trackHostMutation();
        } catch (error) {
          captureCommitPhaseError(finishedWork, finishedWork.return, error);
        }
      }
...
function performWorkOnRoot(root$jscomp$0, lanes, forceSync) {
  ...
  do {
    if (0 === exitStatus) {
      ...
      yieldEndTime = root$jscomp$0.current.alternate;
      if (
        yieldDuration &&
      ...
      a: {
        ...
        if (
          ...
          (alwaysThrottleRetries || 3 === yieldDuration) &&
          ...
          if (0 !== getNextLanes(startTime, 0, !0)) break a;
          startTime.timeoutHandle = scheduleTimeout(
...
function getLaneLabelMap() {
  if (enableSchedulingProfiler) {
    for (
      var map = new Map(), lane = 1, index$232 = 0;
      31 > index$232;
      index$232++
    ) {
...
for (
  var i$jscomp$inline_1922 = 0;
  i$jscomp$inline_1922 < simpleEventPluginEvents.length;
  i$jscomp$inline_1922++
) {
  var eventName$jscomp$inline_1923 =
      simpleEventPluginEvents[i$jscomp$inline_1922],
    domEventName$jscomp$inline_1924 =
      eventName$jscomp$inline_1923.toLowerCase(),
    capitalizedEvent$jscomp$inline_1925 =
      eventName$jscomp$inline_1923[0].toUpperCase() +
      eventName$jscomp$inline_1923.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1924,
    "on" + capitalizedEvent$jscomp$inline_1925
  );
}
  ...
  switch (tag) {
    ...
    case "input":
      ...
      for (hasSrc in props)
        if (props.hasOwnProperty(hasSrc)) {
          var propValue$248 = props[hasSrc];
          if (null != propValue$248)
            switch (hasSrc) {
              case "name":
                hasSrcSet = propValue$248;
                break;
              case "type":
                propKey = propValue$248;
                break;
              case "checked":
                checked = propValue$248;
                break;
              case "defaultChecked":
                defaultChecked = propValue$248;
                break;
              case "value":
                propValue = propValue$248;
                break;
              case "defaultValue":
                defaultValue = propValue$248;
                break;
              case "children":
              case "dangerouslySetInnerHTML":
                if (null != propValue$248)
                ...
                break;
              default:
                setProp(domElement, tag, hasSrc, propValue$248, props, null);
            }
        }
      initInput(
        domElement,
    ...
    default:
      if (isCustomElement(tag)) {
        for (propValue$248 in props)
          props.hasOwnProperty(propValue$248) &&
            ((hasSrc = props[propValue$248]),
            void 0 !== hasSrc &&
      ...
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              propKey$265 !== propKey && trackHostMutation();
              domElement.selected =
                propKey$265 &&
...
if (
  "19.2.0-www-modern-6a7650c7-20250405" !==

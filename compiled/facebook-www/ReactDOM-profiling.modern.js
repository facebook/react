...
for (
  var i$jscomp$inline_2040 = 0;
  i$jscomp$inline_2040 < simpleEventPluginEvents.length;
  i$jscomp$inline_2040++
) {
  var eventName$jscomp$inline_2041 =
      simpleEventPluginEvents[i$jscomp$inline_2040],
    domEventName$jscomp$inline_2042 =
      eventName$jscomp$inline_2041.toLowerCase(),
    capitalizedEvent$jscomp$inline_2043 =
      eventName$jscomp$inline_2041[0].toUpperCase() +
      eventName$jscomp$inline_2041.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_2042,
    "on" + capitalizedEvent$jscomp$inline_2043
  );
}
...
var isomorphicReactPackageVersion$jscomp$inline_2284 = React.version;
if (
  "19.2.0-www-modern-845d9374-20250506" !==
  isomorphicReactPackageVersion$jscomp$inline_2284
)
  throw Error(
    formatProdErrorMessage(
      527,
...
enableSchedulingProfiler &&
  ((internals$jscomp$inline_2286.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_2286.injectProfilingHooks = injectProfilingHooks));
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2867 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2867.isDisabled &&
    hook$jscomp$inline_2867.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2867.inject(
        internals$jscomp$inline_2286
      )),
        (injectedHook = hook$jscomp$inline_2867);
    } catch (err) {}
}

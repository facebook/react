...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$372 = isSupported$jscomp$inline_1643;
...
enableSchedulingProfiler &&
  ...
  (internals$jscomp$inline_1862.injectProfilingHooks = injectProfilingHooks));

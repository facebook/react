...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1676 = "oninput" in document;
    if (!isSupported$jscomp$inline_1676) {
      var element$jscomp$inline_1677 = document.createElement("div");
      element$jscomp$inline_1677.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1676 =
        "function" === typeof element$jscomp$inline_1677.oninput;
    }
    JSCompiler_inline_result$jscomp$372 = isSupported$jscomp$inline_1676;
...
if (
  "19.1.0-www-modern-0605cd9f-20250204" !==
...
enableSchedulingProfiler &&
  ...
  (internals$jscomp$inline_1897.injectProfilingHooks = injectProfilingHooks));
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2380 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2380.isDisabled &&
    hook$jscomp$inline_2380.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2380.inject(
        internals$jscomp$inline_1897
      )),
        (injectedHook = hook$jscomp$inline_2380);
    } catch (err) {}
}

...
function getTransitionsForLanes(root, lanes) {
  ...
  for (var transitionsForLanes = []; 0 < lanes; ) {
    var index$18 = 31 - clz32(lanes),
      lane = 1 << index$18;
    index$18 = root.transitionLanes[index$18];
    null !== index$18 &&
      index$18.forEach(function (transition) {
  ...
  if (enableTransitionTracing)
    for (; 0 < lanes; ) {
      var index$19 = 31 - clz32(lanes),
        lane = 1 << index$19;
      null !== root.transitionLanes[index$19] &&
        (root.transitionLanes[index$19] = null);
      lanes &= ~lane;
    }
}
...
function getLaneLabelMap() {
  if (enableSchedulingProfiler) {
    for (
      var map = new Map(), lane = 1, index$20 = 0;
      31 > index$20;
      index$20++
    ) {
...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      var index$48 = thenableIndexCounter;
      thenableIndexCounter += 1;
      null === thenableState && (thenableState = []);
      usable = trackUsedThenable(thenableState, usable, index$48);
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$54 = enqueueUpdate(provider, fiber, lane);
        if (null !== root$54) {
          var eventTime = requestEventTime();
          scheduleUpdateOnFiber(root$54, provider, lane, eventTime);
          entangleTransitions(root$54, provider, lane);
        }
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      includesBlockingLane(root$50, renderLanes$1) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$50 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$50;
    mountEffect(subscribeToStore.bind(null, fiber, root$50, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$67 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$67.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$67.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$67.incompleteTransitions.forEach(function (markerInstance) {
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null !== JSCompiler_temp) {
    var dehydrated$74 = JSCompiler_temp.dehydrated;
    if (null !== dehydrated$74)
  ...
  if (showFallback) {
    ...
    dehydrated$74 = JSCompiler_temp.sibling;
    ...
    null !== dehydrated$74
      ? (showFallback = createWorkInProgress(dehydrated$74, showFallback))
    ...
    null === didSuspend
      ...
      : ((JSCompiler_temp = didSuspend.cachePool),
        null !== JSCompiler_temp
          ? ((dehydrated$74 = CacheContext._currentValue),
            (JSCompiler_temp =
              JSCompiler_temp.parent !== dehydrated$74
                ? { parent: dehydrated$74, pool: dehydrated$74 }
                : JSCompiler_temp))
    ...
    enableTransitionTracing &&
      ...
      null !== didSuspend &&
        ((JSCompiler_temp = enableTransitionTracing
          ? markerInstanceStack.current
          : null),
        (dehydrated$74 = showFallback.updateQueue),
        ...
        null === dehydrated$74
          ...
          : dehydrated$74 === primaryChildProps
          ? (showFallback.updateQueue = {
              transitions: didSuspend,
              markerInstances: JSCompiler_temp,
              retryQueue:
          ...
          : ((dehydrated$74.transitions = didSuspend),
            (dehydrated$74.markerInstances = JSCompiler_temp))));
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$108 = completedWork.selfBaseDuration,
          child$109 = completedWork.child;
        null !== child$109;
        ...
        (newChildLanes |= child$109.lanes | child$109.childLanes),
          ...
          (treeBaseDuration$108 += child$109.treeBaseDuration),
          (child$109 = child$109.sibling);
      completedWork.treeBaseDuration = treeBaseDuration$108;
    } else
      for (
        treeBaseDuration$108 = completedWork.child;
        null !== treeBaseDuration$108;

      )
        (newChildLanes |=
          treeBaseDuration$108.lanes | treeBaseDuration$108.childLanes),
          (subtreeFlags |= treeBaseDuration$108.subtreeFlags & 31457280),
          (subtreeFlags |= treeBaseDuration$108.flags & 31457280),
          (treeBaseDuration$108.return = completedWork),
          (treeBaseDuration$108 = treeBaseDuration$108.sibling);
  else if (0 !== (completedWork.mode & 2)) {
    treeBaseDuration$108 = completedWork.actualDuration;
    child$109 = completedWork.selfBaseDuration;
    for (var child = completedWork.child; null !== child; )
      (newChildLanes |= child.lanes | child.childLanes),
        (subtreeFlags |= child.subtreeFlags),
        (subtreeFlags |= child.flags),
        (treeBaseDuration$108 += child.actualDuration),
        (child$109 += child.treeBaseDuration),
        (child = child.sibling);
    completedWork.actualDuration = treeBaseDuration$108;
    completedWork.treeBaseDuration = child$109;
  } else
    for (
      treeBaseDuration$108 = completedWork.child;
      null !== treeBaseDuration$108;
      ...
      (newChildLanes |=
        treeBaseDuration$108.lanes | treeBaseDuration$108.childLanes),
        (subtreeFlags |= treeBaseDuration$108.subtreeFlags),
        (subtreeFlags |= treeBaseDuration$108.flags),
        (treeBaseDuration$108.return = completedWork),
        (treeBaseDuration$108 = treeBaseDuration$108.sibling);
    ...
    if (6 === exitStatus) markRootSuspended(root, lanes);
      ...
      if (
        ...
        if (2 === exitStatus) {
          ...
          var errorRetryLanes$192 = getLanesToRetrySynchronouslyOnError(
            root,
            errorRetryLanes
          );
          0 !== errorRetryLanes$192 &&
            ((lanes = errorRetryLanes$192),
            (exitStatus = recoverFromConcurrentError(
              root,
              errorRetryLanes,
              errorRetryLanes$192
      ...
      switch (exitStatus) {
        ...
        case 4:
          ...
          for (errorRetryLanes$192 = -1; 0 < exitStatus; ) {
            var index$10 = 31 - clz32(exitStatus),
              lane = 1 << index$10;
            index$10 = errorRetryLanes[index$10];
            index$10 > errorRetryLanes$192 && (errorRetryLanes$192 = index$10);
            exitStatus &= ~lane;
          }
          exitStatus = errorRetryLanes$192;
                ...
                if (suspenseBoundary.mode & 1) {
                  ...
                  if (wakeable === noopSuspenseyCommitThenable)
                    ...
                    if (null === offscreenQueue) {
                      ...
                      var retryQueue$62 = offscreenQueue.retryQueue;
                      null === retryQueue$62
                        ? (offscreenQueue.retryQueue = new Set([wakeable]))
                        : retryQueue$62.add(wakeable);
                    }
                  }
                  break;
                }
...
function attemptSynchronousHydration(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$204 = fiber.stateNode;
      if (root$204.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$204.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$204, lanes | 2),
          ensureRootIsScheduled(root$204, now$1()),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now$1() + 500),
            flushSyncCallbacks()));
      }
...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$323;
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$323 = isSupported$jscomp$inline_1613;
  } else JSCompiler_inline_result$jscomp$323 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$323 &&
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$224 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$224);
          if (resource) break;
          resource = resourceRoot.querySelector(
            getStylesheetSelectorFromKey(key$224)
          );
          resource ||
            ((href = {
              rel: "stylesheet",
            ...
            (options = preloadPropsMap.get(key$224)) &&
          ...
          as.set(key$224, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$224 = getScriptKey(href)),
            (precedence = as.get(key$224)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$224
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$224, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$224 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$224 =
          'link[rel="preload"][as="' + as + '"][href="' + key$224 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$224) &&
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var key$231 = getStyleKey(pendingProps.href),
          styles$232 = getResourcesFromRoot(currentProps).hoistableStyles;
        type = styles$232.get(key$231);
        type ||
          ((currentProps = currentProps.ownerDocument || currentProps),
          (type = { type: "stylesheet", instance: null, count: 0 }),
          styles$232.set(key$231, type),
          preloadPropsMap.has(key$231) ||
            ((pendingProps = {
              rel: "preload",
              as: "style",
            ...
            preloadPropsMap.set(key$231, pendingProps),
            currentProps.querySelector(getStylesheetSelectorFromKey(key$231)) ||
              null !==
                currentProps.querySelector(
                  'link[rel="preload"][as="style"][' + key$231 + "]"
                ) ||
              ((key$231 = currentProps.createElement("link")),
              setInitialProperties(key$231, "link", pendingProps),
              markNodeAsHoistable(key$231),
              currentProps.head.appendChild(key$231))));
        return type;
      }
      return null;
    case "script":
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$239 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$239)
          return (
            (resource.instance = instance$239),
            markNodeAsHoistable(instance$239),
            instance$239
          );
        key = assign({}, props, {
          "data-precedence": props.precedence,
        ...
        setInitialProperties(instance$239, "link", key);
        insertStylesheet(instance$239, props.precedence, hoistableRoot);
        return (resource.instance = instance$239);
      case "script":
        instance$239 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            "script[async]" + instance$239
          ))
        )
          return (
        ...
        key = props;
        if ((styleProps = preloadPropsMap.get(instance$239)))
          (key = assign({}, props)),
...
var devToolsConfig$jscomp$inline_1833 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-e393cc91",
...
(function (internals) {
  ...
  reconcilerVersion: "18.3.0-www-modern-e393cc91"
});
...
exports.version = "18.3.0-www-modern-e393cc91";

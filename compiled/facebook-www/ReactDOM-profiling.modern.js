  ...
  switch (finishedWork.tag) {
    ...
    case 22:
      ...
      null !== finishedWork.memoizedState
        ? (isViewTransitionEligible &&
            null !== current$192 &&
            null === current$192.memoizedState &&
            restoreExitViewTransitions(current$192),
...
function getLaneLabelMap() {
  if (enableSchedulingProfiler) {
    for (
      var map = new Map(), lane = 1, index$219 = 0;
      31 > index$219;
      index$219++
    ) {
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1738 = "oninput" in document;
    if (!isSupported$jscomp$inline_1738) {
      var element$jscomp$inline_1739 = document.createElement("div");
      element$jscomp$inline_1739.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1738 =
        "function" === typeof element$jscomp$inline_1739.oninput;
    }
    JSCompiler_inline_result$jscomp$377 = isSupported$jscomp$inline_1738;
...
for (
  var i$jscomp$inline_1779 = 0;
  i$jscomp$inline_1779 < simpleEventPluginEvents.length;
  i$jscomp$inline_1779++
) {
  var eventName$jscomp$inline_1780 =
      simpleEventPluginEvents[i$jscomp$inline_1779],
    domEventName$jscomp$inline_1781 =
      eventName$jscomp$inline_1780.toLowerCase(),
    capitalizedEvent$jscomp$inline_1782 =
      eventName$jscomp$inline_1780[0].toUpperCase() +
      eventName$jscomp$inline_1780.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1781,
    "on" + capitalizedEvent$jscomp$inline_1782
  );
}
      ...
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              propKey$252 !== propKey && trackHostMutation();
              domElement.selected =
                propKey$252 &&
...
var internals$jscomp$inline_1959 = {
  bundleType: 0,
...
enableSchedulingProfiler &&
  ((internals$jscomp$inline_1959.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_1959.injectProfilingHooks = injectProfilingHooks));

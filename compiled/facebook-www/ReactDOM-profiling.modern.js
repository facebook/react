...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$314;
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$314 = isSupported$jscomp$inline_443;
  } else JSCompiler_inline_result$jscomp$314 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$314 &&
...
for (
  var reportGlobalError =
    ...
    i$jscomp$inline_484 = 0;
  i$jscomp$inline_484 < simpleEventPluginEvents.length;
  i$jscomp$inline_484++
) {
  var eventName$jscomp$inline_485 =
      simpleEventPluginEvents[i$jscomp$inline_484],
    domEventName$jscomp$inline_486 = eventName$jscomp$inline_485.toLowerCase(),
    capitalizedEvent$jscomp$inline_487 =
      eventName$jscomp$inline_485[0].toUpperCase() +
      eventName$jscomp$inline_485.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_486,
    "on" + capitalizedEvent$jscomp$inline_487
  );
}
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      for (var propKey$53 in nextProps) {
        var propKey = nextProps[propKey$53];
        lastProp = lastProps[propKey$53];
        if (
          nextProps.hasOwnProperty(propKey$53) &&
      ...
      return;
    case "select":
      propKey = value = defaultValue = propKey$53 = null;
      ...
      nextProps = propKey;
      null != propKey$53
        ? updateOptions(domElement, !!lastProps, propKey$53, !1)
        : !!nextProps !== !!lastProps &&
          (null != tag
    ...
    case "textarea":
      ...
      updateTextarea(domElement, propKey$53, propKey);
      return;
    case "option":
      for (var propKey$69 in lastProps)
        if (
          ((propKey$53 = lastProps[propKey$69]),
          ...
          switch (propKey$69) {
            case "selected":
              ...
              break;
            default:
              setProp(domElement, tag, propKey$69, null, nextProps, propKey$53);
          }
      for (lastDefaultValue in nextProps)
        if (
          ((propKey$53 = nextProps[lastDefaultValue]),
          (propKey = lastProps[lastDefaultValue]),
          nextProps.hasOwnProperty(lastDefaultValue) &&
            propKey$53 !== propKey &&
            (null != propKey$53 || null != propKey))
        )
          switch (lastDefaultValue) {
            case "selected":
              domElement.selected =
                propKey$53 &&
                "function" !== typeof propKey$53 &&
                "symbol" !== typeof propKey$53;
              break;
            default:
              setProp(
                domElement,
    ...
    case "menuitem":
      for (var propKey$74 in lastProps)
        (propKey$53 = lastProps[propKey$74]),
          lastProps.hasOwnProperty(propKey$74) &&
            null != propKey$53 &&
            !nextProps.hasOwnProperty(propKey$74) &&
            setProp(domElement, tag, propKey$74, null, nextProps, propKey$53);
      for (checked in nextProps)
        if (
          ((propKey$53 = nextProps[checked]),
          ...
          switch (checked) {
            ...
            case "dangerouslySetInnerHTML":
              ...
              break;
            default:
              setProp(domElement, tag, checked, propKey$53, nextProps, propKey);
          }
      return;
    default:
      if (isCustomElement(tag)) {
        for (var propKey$79 in lastProps)
          (propKey$53 = lastProps[propKey$79]),
            lastProps.hasOwnProperty(propKey$79) &&
              void 0 !== propKey$53 &&
              !nextProps.hasOwnProperty(propKey$79) &&
              setPropOnCustomElement(
                domElement,
                tag,
                propKey$79,
        ...
        for (defaultChecked in nextProps)
          (propKey$53 = nextProps[defaultChecked]),
            (propKey = lastProps[defaultChecked]),
            !nextProps.hasOwnProperty(defaultChecked) ||
              propKey$53 === propKey ||
              (void 0 === propKey$53 && void 0 === propKey) ||
              setPropOnCustomElement(
                domElement,
                tag,
                defaultChecked,
  ...
  for (var propKey$84 in lastProps)
    (propKey$53 = lastProps[propKey$84]),
      lastProps.hasOwnProperty(propKey$84) &&
        null != propKey$53 &&
        !nextProps.hasOwnProperty(propKey$84) &&
        setProp(domElement, tag, propKey$84, null, nextProps, propKey$53);
  for (lastProp in nextProps)
    (propKey$53 = nextProps[lastProp]),
      (propKey = lastProps[lastProp]),
      !nextProps.hasOwnProperty(lastProp) ||
        propKey$53 === propKey ||
        (null == propKey$53 && null == propKey) ||
        setProp(domElement, tag, lastProp, propKey$53, nextProps, propKey);
}
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$92 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$93 = styles$92.get(type);
        resource$93 ||
          ...
          styles$92.set(type, resource$93),
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$97 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$97)
          return (
            (resource.state.loading |= 4),
            (resource.instance = instance$97),
            markNodeAsHoistable(instance$97),
            instance$97
          );
        ...
        markNodeAsHoistable(instance$97);
        var linkInstance = instance$97;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$97, "link", instance);
        resource.state.loading |= 4;
        insertStylesheet(instance$97, props.precedence, hoistableRoot);
        return (resource.instance = instance$97);
      case "script":
        instance$97 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            getScriptSelectorFromKey(instance$97)
          ))
        )
          return (
        ...
        instance = props;
        if ((styleProps = preloadPropsMap.get(instance$97)))
...
function flushSyncWorkAcrossRoots_impl(onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$115 = firstScheduledRoot; null !== root$115; ) {
        if (!onlyLegacy) {
          var workInProgressRootRenderLanes$117 = workInProgressRootRenderLanes;
          workInProgressRootRenderLanes$117 = getNextLanes(
            root$115,
            root$115 === workInProgressRoot
              ? workInProgressRootRenderLanes$117
              : 0
          );
          0 !== (workInProgressRootRenderLanes$117 & 3) &&
            ((didPerformSomeWork = !0),
            performSyncWorkOnRoot(root$115, workInProgressRootRenderLanes$117));
        }
        root$115 = root$115.next;
      }
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$141 = !1;
    do {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$141 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$141 &&
          ...
          if (nextHydratableInstance) {
            b: {
              ...
              for (
                ...
                JSCompiler_inline_result = getNextHydratable(
                  JSCompiler_inline_result.nextSibling
                );
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$151 = enqueueUpdate(provider, fiber, lane);
        null !== root$151 &&
          (scheduleUpdateOnFiber(root$151, provider, lane),
          entangleTransitions(root$151, provider, lane));
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function (subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      var root$144 = workInProgressRoot;
      if (null === root$144) throw Error(formatProdErrorMessage(349));
      includesBlockingLane(root$144, workInProgressRootRenderLanes) ||
        pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
    }
    hook.memoizedState = getServerSnapshot;
    root$144 = { value: getServerSnapshot, getSnapshot: getSnapshot };
    hook.queue = root$144;
    mountEffect(subscribeToStore.bind(null, fiber, root$144, subscribe), [
      subscribe
    ]);
    fiber.flags |= 2048;
    pushEffect(
...
function throwException(
        ...
        case 13:
          return (
            ...
            returnFiber === noopSuspenseyCommitThenable
              ...
              : ((value = sourceFiber.updateQueue),
                null === value
                  ? (sourceFiber.updateQueue = new Set([returnFiber]))
              ...
              : ((value = sourceFiber.updateQueue),
                null === value
                  ? ((value = {
                    ...
                    (sourceFiber.updateQueue = value))
                  : ((sourceFiber = value.retryQueue),
                    null === sourceFiber
                      ? (value.retryQueue = new Set([returnFiber]))
  ...
  if (isHydrating) {
    var suspenseBoundary$161 = suspenseHandlerStackCursor.current;
    if (null !== suspenseBoundary$161)
      return (
        0 === (suspenseBoundary$161.flags & 65536) &&
          (suspenseBoundary$161.flags |= 256),
        (suspenseBoundary$161.flags |= 65536),
        (suspenseBoundary$161.lanes = rootRenderLanes),
        queueHydrationError(createCapturedValueAtFiber(value, sourceFiber)),
        !1
      );
  }
  suspenseBoundary$161 = value = createCapturedValueAtFiber(value, sourceFiber);
  4 !== workInProgressRootExitStatus && (workInProgressRootExitStatus = 2);
  null === workInProgressRootConcurrentErrors
    ? (workInProgressRootConcurrentErrors = [suspenseBoundary$161])
    : workInProgressRootConcurrentErrors.push(suspenseBoundary$161);
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$165 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$165.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$165.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$165.incompleteTransitions.forEach(function (markerInstance) {
  ...
  if (null === current) {
    if (isHydrating) {
      ...
      if (isHydrating) {
        ...
        JSCompiler_temp$jscomp$0 || throwOnHydrationMismatch();
      }
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$204 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$204 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$204
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$204.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$206 = completedWork.selfBaseDuration,
          child$207 = completedWork.child;
        null !== child$207;

      )
        (newChildLanes |= child$207.lanes | child$207.childLanes),
          (subtreeFlags |= child$207.subtreeFlags & 31457280),
          (subtreeFlags |= child$207.flags & 31457280),
          (treeBaseDuration$206 += child$207.treeBaseDuration),
          (child$207 = child$207.sibling);
      completedWork.treeBaseDuration = treeBaseDuration$206;
    } else
      for (
        treeBaseDuration$206 = completedWork.child;
        null !== treeBaseDuration$206;

      )
        (newChildLanes |=
          treeBaseDuration$206.lanes | treeBaseDuration$206.childLanes),
          (subtreeFlags |= treeBaseDuration$206.subtreeFlags & 31457280),
          (subtreeFlags |= treeBaseDuration$206.flags & 31457280),
          (treeBaseDuration$206.return = completedWork),
          (treeBaseDuration$206 = treeBaseDuration$206.sibling);
  else if (0 !== (completedWork.mode & 2)) {
    treeBaseDuration$206 = completedWork.actualDuration;
    child$207 = completedWork.selfBaseDuration;
    for (var child = completedWork.child; null !== child; )
      (newChildLanes |= child.lanes | child.childLanes),
        (subtreeFlags |= child.subtreeFlags),
        (subtreeFlags |= child.flags),
        (treeBaseDuration$206 += child.actualDuration),
        (child$207 += child.treeBaseDuration),
        (child = child.sibling);
    completedWork.actualDuration = treeBaseDuration$206;
    completedWork.treeBaseDuration = child$207;
  } else
    for (
      treeBaseDuration$206 = completedWork.child;
      null !== treeBaseDuration$206;
      ...
      (newChildLanes |=
        treeBaseDuration$206.lanes | treeBaseDuration$206.childLanes),
        (subtreeFlags |= treeBaseDuration$206.subtreeFlags),
        (subtreeFlags |= treeBaseDuration$206.flags),
        (treeBaseDuration$206.return = completedWork),
        (treeBaseDuration$206 = treeBaseDuration$206.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$222 = newProps.memoizedState.cachePool.pool);
        cache$222 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
    ...
    case 19:
      ...
      cache$222 = currentResource.rendering;
      if (null === cache$222)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$222 = findFirstSuspended(current);
              if (null !== cache$222) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$222.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$222)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$222.sibling = workInProgress.child),
            (workInProgress.child = cache$222))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$222)
              : (workInProgress.child = cache$222),
            (currentResource.last = cache$222));
      }
  ...
  if (null !== ref)
    if ("function" === typeof refCleanup)
      ...
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$239);
      }
...
function commitHookLayoutEffects(finishedWork, hookFlags) {
  if (shouldProfile(finishedWork)) {
    ...
    try {
      ...
      captureCommitPhaseError(finishedWork, finishedWork.return, error$243);
    }
}
    ...
    case 5:
      ...
      if (finishedWork.flags & 32) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$264);
        }
      }
      if (flags & 4 && ((flags = finishedWork.stateNode), null != flags)) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$267);
        }
      }
      break;
    case 6:
      ...
      if (flags & 4) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$268);
        }
      }
      break;
    case 3:
      ...
      if (flags & 4 && null !== current && current.memoizedState.isDehydrated)
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$269);
        }
      break;
    case 4:
    ...
    case 13:
      ...
      if (flags & 4) {
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$271);
        }
      ...
      if (27 !== finishedWork.tag) {
        ...
        switch (JSCompiler_inline_result.tag) {
          case 27:
            ...
            break;
          case 5:
            var parent$252 = JSCompiler_inline_result.stateNode;
            JSCompiler_inline_result.flags & 32 &&
              (setTextContent(parent$252, ""),
              (JSCompiler_inline_result.flags &= -33));
            var before$253 = getHostSibling(finishedWork);
            insertOrAppendPlacementNode(finishedWork, before$253, parent$252);
            break;
          case 3:
          case 4:
            var parent$254 = JSCompiler_inline_result.stateNode.containerInfo,
              before$255 = getHostSibling(finishedWork);
...
function commitHookPassiveMountEffects(finishedWork, hookFlags) {
  if (shouldProfile(finishedWork)) {
    ...
    try {
      ...
      captureCommitPhaseError(finishedWork, finishedWork.return, error$274);
    }
}
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    ...
    switch (finishedWork.tag) {
      ...
      case 23:
        ...
        break;
      case 22:
        var instance$279 = finishedWork.stateNode;
        null !== finishedWork.memoizedState
          ? instance$279._visibility & 4
            ? recursivelyTraverseReconnectPassiveEffects(
                finishedRoot,
                finishedWork,
                committedLanes,
...
function requestUpdateLane() {
  ...
  if (0 !== actionScopeLane) return actionScopeLane;
  actionScopeLane = window.event;
  actionScopeLane =
    void 0 === actionScopeLane ? 32 : getEventPriority(actionScopeLane.type);
...
function renderRootSync(root, lanes) {
  ...
  a: do
    try {
      ...
      workLoopSync();
      break;
    } catch (thrownValue$287) {
      handleThrow(root, thrownValue$287);
    }
  while (1);
...
function renderRootConcurrent(root, lanes) {
  ...
  a: do
    try {
      ...
      workLoopConcurrent();
      break;
    } catch (thrownValue$289) {
      handleThrow(root, thrownValue$289);
    }
  while (1);
  resetContextDependencies();
  ReactCurrentDispatcher.current = prevDispatcher;
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    executionContext |= 4;
    ReactCurrentOwner.current = null;
    var shouldFireAfterActiveInstanceBlur$293 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitTime = now();
    commitMutationEffects(root, finishedWork, lanes);
    shouldFireAfterActiveInstanceBlur$293 &&
      ((_enabled = !0),
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$294 = rootWithPendingPassiveEffects,
    ...
    try {
      ...
      (currentUpdatePriority = previousPriority),
        (ReactCurrentBatchConfig$1.transition = prevTransition),
        releaseRootPooledCache(root$294, remainingLanes);
    }
  }
  return !1;
}
...
function attemptSynchronousHydration(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$297 = fiber.stateNode;
      if (root$297.current.memoizedState.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$297.pendingLanes);
        0 !== lanes &&
          (upgradePendingLanesToSync(root$297, lanes),
          ensureRootIsScheduled(root$297),
          0 === (executionContext & 6) &&
            ((workInProgressRootRenderTargetTime = now$1() + 500),
            flushSyncWorkAcrossRoots_impl(!1)));
      }
...
var devToolsConfig$jscomp$inline_1772 = {
  ...
  bundleType: 0,
  version: "19.0.0-www-modern-dbb8ec8f",
...
(function (internals) {
  ...
  reconcilerVersion: "19.0.0-www-modern-dbb8ec8f"
});
...
exports.version = "19.0.0-www-modern-dbb8ec8f";
"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
  "function" ===

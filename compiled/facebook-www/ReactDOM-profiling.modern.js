...
function prepareToHydrateHostInstance(fiber) {
  ...
  type = props.children;
  ("string" !== typeof type && "number" !== typeof type) ||
    instance.textContent === "" + type ||
    (!0 !== props.suppressHydrationWarning &&
      ((updatePayload = instance.textContent),
      normalizeMarkupForTextOrAttribute(type),
      normalizeMarkupForTextOrAttribute(updatePayload)),
    (updatePayload = ["children", type]));
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1624 = "oninput" in document;
    if (!isSupported$jscomp$inline_1624) {
      var element$jscomp$inline_1625 = document.createElement("div");
      element$jscomp$inline_1625.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1624 =
        "function" === typeof element$jscomp$inline_1625.oninput;
    }
    JSCompiler_inline_result$jscomp$343 = isSupported$jscomp$inline_1624;
...
function setInitialProperties(domElement, tag, props) {
  switch (tag) {
          ...
          if (null != propValue)
            switch (propKey) {
              ...
              case "dangerouslySetInnerHTML":
                ...
                break;
              default:
                setProp(domElement, tag, propKey, propValue, !1, props);
            }
        }
      track(domElement);
        ...
        if (
          ...
          switch (propValue) {
            case "value":
              break;
            default:
              setProp(domElement, tag, propValue, propKey, !1, props);
          }
    ...
    case "textarea":
      ...
      listenToNonDelegatedEvent("invalid", domElement);
      for (var propKey$221 in props)
        if (
          props.hasOwnProperty(propKey$221) &&
          ((propKey = props[propKey$221]), null != propKey)
        )
          switch (propKey$221) {
            case "value":
              break;
            ...
            case "dangerouslySetInnerHTML":
              ...
              break;
            default:
              setProp(domElement, tag, propKey$221, propKey, !1, props);
          }
      track(domElement);
      postMountWrapper(domElement);
      return;
    case "option":
      for (var propKey$223 in props)
        if (
          props.hasOwnProperty(propKey$223) &&
          ((propKey = props[propKey$223]), null != propKey)
        )
          switch (propKey$223) {
            case "selected":
              domElement.selected =
              ...
              break;
            default:
              setProp(domElement, tag, propKey$223, propKey, !1, props);
          }
      null != props.value &&
    ...
    case "wbr":
    case "menuitem":
      for (var propKey$225 in props)
        if (
          props.hasOwnProperty(propKey$225) &&
          ((propKey = props[propKey$225]), null != propKey)
        )
          switch (propKey$225) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(formatProdErrorMessage(137, tag));
            default:
              setProp(domElement, tag, propKey$225, propKey, !1, props);
          }
      return;
  }
  ...
  for (node in props)
    props.hasOwnProperty(node) &&
      ...
      null != propValue &&
        setProp(domElement, tag, node, propValue, propKey, props));
}
function updateProperties(
  ...
  switch (tag) {
      ...
      for (lastProps = 0; lastProps < updatePayload.length; lastProps += 2) {
        ...
        switch (propKey) {
          ...
          case "dangerouslySetInnerHTML":
            ...
            break;
          default:
            setProp(domElement, tag, propKey, propValue, !1, nextProps);
        }
      }
    ...
    case "select":
      ...
      null != tag
        ...
        : updatePayload !== !!nextProps.multiple &&
          (null != nextProps.defaultValue
            ? updateOptions(
                domElement,
                !!nextProps.multiple,
  ...
  for (propValue = 0; propValue < updatePayload.length; propValue += 2)
    setProp(
      domElement,
      tag,
      updatePayload[propValue],
      updatePayload[propValue + 1],
      lastProps,
      nextProps
    );
}
    ...
    if (resourceRoot)
      switch (as) {
        case "style":
          ...
          var key$245 = getStyleKey(href),
            precedence = options.precedence || "default",
            resource = as.get(key$245);
          if (resource) break;
          var state = { loading: 0, preload: null };
          if (
            (resource = resourceRoot.querySelector(
              getStylesheetSelectorFromKey(key$245)
            ))
          )
            state.loading = 1;
          else {
            ...
            (options = preloadPropsMap.get(key$245)) &&
          ...
          as.set(key$245, resource);
          break;
        case "script":
          (as = getResourcesFromRoot(resourceRoot).hoistableScripts),
            (key$245 = getScriptKey(href)),
            (precedence = as.get(key$245)),
            precedence ||
              ((precedence = resourceRoot.querySelector(
                "script[async]" + key$245
              )),
              precedence ||
                ((href = {
                  src: href,
              ...
              as.set(key$245, precedence));
      }
    else if ("style" === as || "script" === as)
      if ((resourceRoot = getDocumentForPreloads())) {
        key$245 = escapeSelectorAttributeValueInsideDoubleQuotes(href);
        precedence = key$245 =
          'link[rel="preload"][as="' + as + '"][href="' + key$245 + '"]';
        switch (as) {
          case "style":
        ...
        preloadPropsMap.has(precedence) ||
          ...
          null === resourceRoot.querySelector(key$245) &&
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        setInitialProperties(instance$260, "link", key);
...
var devToolsConfig$jscomp$inline_1845 = {
  ...
  bundleType: 0,
  version: "18.3.0-www-modern-90d41e0b",
...
(function (internals) {
  ...
  reconcilerVersion: "18.3.0-www-modern-90d41e0b"
});
...
exports.version = "18.3.0-www-modern-90d41e0b";

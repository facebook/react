...
for (
  var i$jscomp$inline_2051 = 0;
  i$jscomp$inline_2051 < simpleEventPluginEvents.length;
  i$jscomp$inline_2051++
) {
  var eventName$jscomp$inline_2052 =
      simpleEventPluginEvents[i$jscomp$inline_2051],
    domEventName$jscomp$inline_2053 =
      eventName$jscomp$inline_2052.toLowerCase(),
    capitalizedEvent$jscomp$inline_2054 =
      eventName$jscomp$inline_2052[0].toUpperCase() +
      eventName$jscomp$inline_2052.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_2053,
    "on" + capitalizedEvent$jscomp$inline_2054
  );
}
...
if (
  "19.2.0-www-modern-47fd2f5e-20250812" !==
...
enableSchedulingProfiler &&
  ...
  (internals$jscomp$inline_2303.injectProfilingHooks = injectProfilingHooks));

      ...
      for (var root$32 = firstScheduledRoot; null !== root$32; ) {
        if (!onlyLegacy)
          if (0 !== syncTransitionLanes) {
            var pendingLanes = root$32.pendingLanes;
            if (0 === pendingLanes) var JSCompiler_inline_result = 0;
            else {
              var suspendedLanes = root$32.suspendedLanes,
                pingedLanes = root$32.pingedLanes;
            ...
            0 !== JSCompiler_inline_result &&
              ...
              performSyncWorkOnRoot(root$32, JSCompiler_inline_result));
          } else
            (JSCompiler_inline_result = workInProgressRootRenderLanes),
              (JSCompiler_inline_result = getNextLanes(
                root$32,
                root$32 === workInProgressRoot ? JSCompiler_inline_result : 0,
                null !== root$32.cancelPendingCommit ||
                  -1 !== root$32.timeoutHandle
              )),
              0 === (JSCompiler_inline_result & 3) ||
                checkIfRootIsPrerendering(root$32, JSCompiler_inline_result) ||
                ((didPerformSomeWork = !0),
                performSyncWorkOnRoot(root$32, JSCompiler_inline_result));
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$74 = !1;
    do {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$74 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$74 &&
...
function runActionStateAction(actionQueue, node) {
  ...
  if (node.isTransition) {
    ...
    try {
      ...
      onActionError(actionQueue, node, error$80);
    }
}
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$83 = enqueueUpdate(provider, fiber, lane);
        null !== root$83 &&
          (startUpdateTimerByLane(lane),
          scheduleUpdateOnFiber(root$83, provider, lane),
          entangleTransitions(root$83, provider, lane));
      ...
      enableTransitionTracing &&
        ...
        null !== showFallback &&
          ((nextFallbackChildren = enableTransitionTracing
            ? markerInstanceStack.current
            : null),
          (digest = nextPrimaryChildren.updateQueue),
          ...
          null === digest
            ...
            : digest === didSuspend
              ...
              : ((digest.transitions = showFallback),
                (digest.markerInstances = nextFallbackChildren)))),
      (nextPrimaryChildren.childLanes = getRemainingWorkInPrimaryTree(
        current,
        JSCompiler_temp,
        renderLanes
...
function beginWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    case 16:
      a: {
        var props = workInProgress.pendingProps,
          lazyComponent = workInProgress.elementType,
          init = lazyComponent._init;
        var Component = init(lazyComponent._payload);
        ...
        if ("function" === typeof Component)
          if (shouldConstruct(Component)) {
            ...
            var resolvedProps$103 = disableDefaultPropsExceptForClasses
              ? props
          ...
          if (void 0 !== Component && null !== Component) {
            ...
            if ($$typeof === REACT_FORWARD_REF_TYPE) {
              ...
              var resolvedProps$105 = disableDefaultPropsExceptForClasses
                ? props
                : resolveDefaultPropsOnNonClassComponent(Component, props);
          ...
          throw Error(formatProdErrorMessage(306, loggedComponent, ""));
        }
      }
    ...
    case 1:
      var Component$126 = workInProgress.type,
        resolvedProps$128 = resolveClassComponentProps(
          Component$126,
          workInProgress.pendingProps,
          workInProgress.elementType === Component$126
        );
      ...
      a: {
        ...
        if (prevState.isDehydrated) {
          ...
          if (workInProgress.flags & 256) {
            ...
            JSCompiler_inline_result$jscomp$0 = mountHostRootWithoutHydrating(
              current,
              workInProgress,
              nextChildren,
              renderLanes
            ...
            for (
              ...
              (node.flags = (node.flags & -3) | 4096), (node = node.sibling);
          }
        } else {
          resetHydrationState();
          if (nextChildren === prevChildren) {
            JSCompiler_inline_result$jscomp$0 = bailoutOnAlreadyFinishedWork(
              current,
              workInProgress,
              renderLanes
            );
    ...
    case 27:
      ...
      if (null === current && isHydrating) {
        var instance = (workInProgress.stateNode = resolveSingletonInstance(
          workInProgress.type,
          workInProgress.pendingProps,
          rootInstanceStackCursor.current
        ));
        ...
        isSingletonScope(workInProgress.type)
          ? ((previousHydratableOnEnteringScopedSingleton =
            ...
            (nextHydratableInstance = getNextHydratable(instance.firstChild)))
    ...
    case 5:
      if (null === current && isHydrating) {
        var nextInstance = nextHydratableInstance,
          JSCompiler_temp;
        if ((JSCompiler_temp = nextInstance)) {
        ...
        JSCompiler_temp || throwOnHydrationMismatch(workInProgress);
      }
      pushHostContext(workInProgress);
    ...
    case 6:
      if (null === current && isHydrating) {
        ...
        if ((JSCompiler_temp$jscomp$0 = nextInstance$jscomp$0)) {
    ...
    case 4:
      ...
      return workInProgress.child;
    case 11:
      var type$jscomp$1 = workInProgress.type,
        unresolvedProps$129 = workInProgress.pendingProps,
        resolvedProps$130 =
          disableDefaultPropsExceptForClasses ||
          workInProgress.elementType === type$jscomp$1
            ? unresolvedProps$129
            : resolveDefaultPropsOnNonClassComponent(
                type$jscomp$1,
                unresolvedProps$129
    ...
    case 9:
      ...
      return workInProgress.child;
    case 14:
      var type$131 = workInProgress.type,
        unresolvedProps$132 = workInProgress.pendingProps,
        resolvedProps$133 = disableDefaultPropsExceptForClasses
          ? unresolvedProps$132
          : resolveDefaultPropsOnNonClassComponent(
              type$131,
              unresolvedProps$132
    ...
    case 31:
      ...
      if (null === current)
          ...
          if ("hidden" === nextProps$jscomp$1.mode)
            ...
            if (nextInstance$jscomp$1) {
              ...
              var JSCompiler_inline_result$jscomp$1 =
                null !== hydratableInstance && "&" === hydratableInstance.data
                  ? hydratableInstance
                  : null;
              if (null !== JSCompiler_inline_result$jscomp$1) {
                workInProgress.memoizedState = {
                  dehydrated: JSCompiler_inline_result$jscomp$1,
                  treeContext:
                    null !== treeContextProvider
                      ? { id: treeContextId, overflow: treeContextOverflow }
                      : null,
              ...
              var JSCompiler_temp$jscomp$1 = JSCompiler_inline_result$jscomp$1;
            } else JSCompiler_temp$jscomp$1 = null;
            if (null === JSCompiler_temp$jscomp$1)
              throw throwOnHydrationMismatch(workInProgress);
          }
          workInProgress.lanes = 536870912;
          var JSCompiler_inline_result$jscomp$2 = null;
        } else
          JSCompiler_inline_result$jscomp$2 = mountActivityChildren(
            workInProgress,
            nextProps$jscomp$1
          );
      else {
        ...
        if (null !== prevState$jscomp$0) {
          var dehydrated = prevState$jscomp$0.dehydrated;
          pushDehydratedActivitySuspenseHandler(workInProgress);
          if (didSuspend)
            if (workInProgress.flags & 256) {
              workInProgress.flags &= -257;
            ...
            var hasContextChanged$101 =
              0 !== (renderLanes & current.childLanes);
            if (didReceiveUpdate || hasContextChanged$101) {
              var root$102 = workInProgressRoot;
              if (null !== root$102) {
                ...
                if (
                  ...
                  throw (
                    ((prevState$jscomp$0.retryLane = attemptHydrationAtLane),
              ...
              JSCompiler_inline_result$jscomp$3 = primaryChildFragment;
            }
          }
          JSCompiler_inline_result$jscomp$2 = JSCompiler_inline_result$jscomp$3;
        } else {
          ...
          JSCompiler_inline_result$jscomp$2 = primaryChildFragment$jscomp$0;
        }
      }
    ...
    case 24:
      ...
      if (null === current) {
        var cacheFromPool = peekCacheFromPool();
        if (null !== cacheFromPool)
          var JSCompiler_inline_result$jscomp$4 = cacheFromPool;
        else {
          var root = workInProgressRoot,
            freshCache = createCache();
          root.pooledCache = freshCache;
          freshCache.refCount++;
          null !== freshCache && (root.pooledCacheLanes |= renderLanes);
          JSCompiler_inline_result$jscomp$4 = freshCache;
        }
        var freshCache$jscomp$0 = JSCompiler_inline_result$jscomp$4;
        workInProgress.memoizedState = {
          parent: parentCache,
          cache: freshCache$jscomp$0
        };
        initializeUpdateQueue(workInProgress);
        pushProvider(workInProgress, CacheContext, freshCache$jscomp$0);
      } else {
      ...
      if (enableViewTransition) {
        ...
        if (null != pendingProps.name && "auto" !== pendingProps.name)
          ...
          if (null === instance$jscomp$2.autoName) {
            ...
            if (isHydrating) {
              var treeId = getTreeId();
              var name = "\u00ab" + identifierPrefix + "T" + treeId + "\u00bb";
            } else {
    ...
    if (0 !== (completedWork.mode & 2)) {
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$137.subtreeFlags & 65011712),
          (subtreeFlags |= treeBaseDuration$137.flags & 65011712),
...
for (
  var i$jscomp$inline_2036 = 0;
  i$jscomp$inline_2036 < simpleEventPluginEvents.length;
  i$jscomp$inline_2036++
) {
  var eventName$jscomp$inline_2037 =
      simpleEventPluginEvents[i$jscomp$inline_2036],
    domEventName$jscomp$inline_2038 =
      eventName$jscomp$inline_2037.toLowerCase(),
    capitalizedEvent$jscomp$inline_2039 =
      eventName$jscomp$inline_2037[0].toUpperCase() +
      eventName$jscomp$inline_2037.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_2038,
    "on" + capitalizedEvent$jscomp$inline_2039
  );
}
...
var isomorphicReactPackageVersion$jscomp$inline_2280 = React.version;
if (
  "19.2.0-www-modern-587cb8f8-20250506" !==
  isomorphicReactPackageVersion$jscomp$inline_2280
)
  throw Error(
    formatProdErrorMessage(
      527,
...
enableSchedulingProfiler &&
  ((internals$jscomp$inline_2282.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_2282.injectProfilingHooks = injectProfilingHooks));
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2870 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2870.isDisabled &&
    hook$jscomp$inline_2870.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2870.inject(
        internals$jscomp$inline_2282
      )),
        (injectedHook = hook$jscomp$inline_2870);
    } catch (err) {}
}

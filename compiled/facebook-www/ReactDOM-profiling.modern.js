...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    var transitions = workInProgressTransitions,
      root$79 = workInProgress.stateNode;
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$79.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$79.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
    root$79.incompleteTransitions.forEach(function (markerInstance) {
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$361 = isSupported$jscomp$inline_1573;
...
var devToolsConfig$jscomp$inline_1787 = {
  ...
  bundleType: 0,
  version: "19.0.0-www-modern-b45628ca",
...
(function (internals) {
  ...
  reconcilerVersion: "19.0.0-www-modern-b45628ca"
});
...
exports.version = "19.0.0-www-modern-b45628ca";
"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
  "function" ===

...
var internals$jscomp$inline_1443 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1444 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1444.isDisabled &&
    hook$jscomp$inline_1444.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1444.inject(
        internals$jscomp$inline_1443
      )),
        (injectedHook = hook$jscomp$inline_1444);
    } catch (err) {}
}

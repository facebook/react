...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      ...
      return trackUsedThenable(thenableState, usable, index$90);
    }
    if (
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$96 = enqueueUpdate$1(provider, fiber, lane);
        null !== root$96 &&
...
var HooksDispatcherOnMount = {
  ...
  useSyncExternalStore: function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    if (isHydrating) {
      ...
      includesBlockingLane(root$92, renderLanes) ||
  ...
  if (didBailout)
    for (var child$147 = completedWork.child; null !== child$147; )
      (newChildLanes |= child$147.lanes | child$147.childLanes),
        (subtreeFlags |= child$147.subtreeFlags & 14680064),
        (subtreeFlags |= child$147.flags & 14680064),

(() => {
  ...
  var __webpack_modules__ = {
    ...
    143: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        E: () => isWebWorkerContext
      });
      var webext_detect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4203);
      const isWebWorkerContext = () => "function" == typeof importScripts && !(0, webext_detect__WEBPACK_IMPORTED_MODULE_0__.BQ)().includes("background");
      isWebWorkerContext() ? self : window;
    },
    782: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        j: () => isContentOrPageScript
      });
      const isContentOrPageScript = () => "undefined" != typeof window && window.document;
    },
    7540: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        u: () => getErrorMessage
      });
      var zod__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4476), zod_validation_error__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2172), webext_detect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4203), _page_current_script__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3148);
      const getStackLog = error => {
        ...
        return functionNames.map((name => name.replace("at", "").trim())).join(":").substring(0, 500);
      };
      const getCurrentFilename = () => (0, webext_detect__WEBPACK_IMPORTED_MODULE_3__.H$)() ? function() {
        try {
          throw new Error;
        } catch (err) {
        ...
        return null;
      }() : (0, webext_detect__WEBPACK_IMPORTED_MODULE_3__.AA)() ? (0, _page_current_script__WEBPACK_IMPORTED_MODULE_0__.i)() : "src/services/get-error-message.ts";
      function getErrorMessage(error) {
        let message = "string" == typeof error ? error : function(maybeError) {
          if (maybeError instanceof zod__WEBPACK_IMPORTED_MODULE_1__.z.ZodError) return (0, 
          zod_validation_error__WEBPACK_IMPORTED_MODULE_2__.NQ)(maybeError);
        ...
        try {
          message += ` (${getCurrentFilename()})`, error instanceof Error && (message += ` (${getStackLog(error)})`);
        } catch (e) {
    ...
    2311: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      var apps_common_globals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(143);
      (0, apps_common_globals__WEBPACK_IMPORTED_MODULE_0__.E)() || document.currentScript;
    },
    3983: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        FS: () => dispatchOnPage,
        V5: () => listenPageEvent
      });
      var apps_common_globals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(143), apps_common_abort_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(882), _page_logging__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1894);
      ...
      function listenPageEvent(eventName, callback, {ignoreSignal = !1, wrapVersion = addVersionToEventNameByDefault} = {}) {
        ...
        document.addEventListener(listenerEventName, (async function(event) {
          try {
            ...
            console.error("Error in page event listener", error), (0, _page_logging__WEBPACK_IMPORTED_MODULE_2__.Vu)("page-communication", {
              error
            }), (0, apps_common_abort_controller__WEBPACK_IMPORTED_MODULE_1__.al)();
          }
        }), {
          signal: ignoreSignal ? void 0 : (0, apps_common_abort_controller__WEBPACK_IMPORTED_MODULE_1__.V1)(),
          capture: !0
        });
      }
      ...
      (0, apps_common_globals__WEBPACK_IMPORTED_MODULE_0__.E)();
    ...
    3148: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        i: () => getScriptId
      });
      var _context__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(782);
      const scriptId = globalThis?.document?.currentScript?.getAttribute("scriptid"), getScriptId = () => scriptId;
      let currentScriptAttributes;
      (0, _context__WEBPACK_IMPORTED_MODULE_0__.j)() && (currentScriptAttributes = document?.currentScript?.attributes);
    },
    1894: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        Vu: () => logFeatureError
      });
      var apps_common_globals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(143), _get_error_message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7540), _page_communication__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3983), _webworker_communication__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3044);
      let currentDomain;
      const log = (level, data, domain = currentDomain) => {
        ...
        (0, apps_common_globals__WEBPACK_IMPORTED_MODULE_0__.E)() ? (0, _webworker_communication__WEBPACK_IMPORTED_MODULE_3__.c)("Cyberhaven_Log", eventData) : (0, 
        _page_communication__WEBPACK_IMPORTED_MODULE_2__.FS)("Cyberhaven_Log", eventData);
        ...
        ((data, domain) => {
          ...
          errorMessage: (0, _get_error_message__WEBPACK_IMPORTED_MODULE_1__.u)(error).substring(0, 1e3),
          ...rest
        });
      };
    },
    3044: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        c: () => dispatchOnWebWorker
      });
    ...
    4203: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      __webpack_require__.d(__webpack_exports__, {
        AA: () => isWebPage,
        BQ: () => getContextName,
        H$: () => isContentScript
    ...
    2172: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
    ...
    4476: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      var util, objectUtil;
      __webpack_require__.d(__webpack_exports__, {
        z: () => z
      }), function(util) {
  ...
  function cloud_data_web_getAccountEmail() {
    return "_spPageContextInfo" in window ? window._spPageContextInfo?.userEmail || window._spPageContextInfo?.userLoginName || window._spPageContextInfo?.userPrincipalName : function() {
      let configText;
      try {
        ...
        configText) return JSON.parse(configText).userPrincipalName;
        ...
        if (preloadUserStorageId) sessionTrackingKey = "sessionTracking_" + JSON.parse(preloadUserStorageId); else {
          ...
          sessionTrackingKey = JSON.parse(sessionTracking).reduce((function(a, b) {
  ...
  (0, __webpack_require__(3983).V5)("Cyberhaven_GetAccountData", (() => ({
    email: cloud_data_web_getAccountEmail(),
    account_type: "sharepoint",
    ...window._OFFICE_FILE || getFileInfo()
  })));
  const getFileNameFromDom = () => function(expression, obj = document, root = document, resolver, type, result) {
    ...
    var xpr;
  }("//input[@name='filename']")?.[0]?.value, getFileInfo = () => {
    const params = new URLSearchParams(location.search), fileId = params.get("sourcedoc");
    return fileId ? {
      cloud_file_id: fileId.toLowerCase().replace("{", "").replace("}", ""),
      cloud_file_name: params.get("file") || getFileNameFromDom()
    } : {};
  };
})();
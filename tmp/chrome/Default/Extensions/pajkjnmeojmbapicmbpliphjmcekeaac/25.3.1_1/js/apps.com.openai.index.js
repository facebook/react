(() => {
  ...
  }), window.self === window.top && (service_communication_onMessage("get-page-data", measureTimeExecution("com.openai:get-page-data", (async () => {
  ...
  }))), injectScript("openai_cloud_data", "src/apps/com.openai/cloud_data.web.ts"));
})();
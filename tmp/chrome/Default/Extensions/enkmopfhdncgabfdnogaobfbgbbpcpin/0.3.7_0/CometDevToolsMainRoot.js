 ...
 * @format
 * @oncall ws_tools
 * @providesLegacy CometDevToolsMainRootImpl
 */__d("legacy:CometDevToolsMainRootImpl",["CometDevToolsPanelConnection"],(function $module_legacy_CometDevToolsMainRootImpl(global,require,importDefault,importNamespace,requireLazy,__DO_NOT_USE__module,__DO_NOT_USE__exports){
...
var devtools=window.chrome?
window.chrome.devtools:
window.browser.devtools;
...
manualServer:'our.internmc.facebook.com'},
...
throw new Error("No document body. This shouldn't happen");
}
...
link.appendChild(document.createTextNode('Comet Dev Tools: Feedback'));
link.target='_blank';
link.href='https://fb.workplace.com/groups/2026750480964651/';

var notice=document.createElement('h1');
notice.appendChild(
document.createTextNode(
'There was an error figuring out what to load here. '+
...
then(function then_$0(_ref){var hostnameSource=_ref.hostnameSource,manualServer=_ref.manualServer;
if(hostnameSource==='manual'){
return manualServer;
}else{

return'www.internalfb.com';
}
}).


then(function then_$0(hostname){
var versionMeta=document.querySelector(
"meta[name='extension_version'][content]");

var extensionVersion=versionMeta?
versionMeta.getAttribute('content'):
null;

var params=new URLSearchParams();
if(extensionVersion!=null){
params.set('extension_version',extensionVersion);
}



importNamespace("CometDevToolsPanelConnection").createPanelConnection(devtools.inspectedWindow.tabId);

var iframe=document.createElement('iframe');
iframe.src=
"https://"+hostname+"/intern/comet_dev_tools/main/?"+params.toString();
 ...
 * @format
 * @oncall ws_tools
 * @providesMeta CometDevToolsMainRoot
 * @requires CometDevToolsMainRootImpl

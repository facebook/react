...
We've also built a [starter kit](https://facebook.github.io/react/downloads/react-15.4.1.zip) which might be useful if this is your first time using React. It includes a webpage with an example of using React with live code.

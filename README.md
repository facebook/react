...
* [Add React to an Existing Project](https://reactjs.org/docs/add-react-to-a-website.html) to use as little or as much React as you need for your existing project or website.

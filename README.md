...
React documentation is [Creative Commons licensed](./docs/LICENSE-docs).

Examples provided in this repository and in the documentation are [separately licensed](./docs/LICENSE-examples).

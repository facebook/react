...
However, it acheives correctness by sometimes de-opting to synchronous mode, obviating async's benefits. This is an inherent limitation of storing state outside of React's managed state queue and rendering in response to a change event.

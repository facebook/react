...
export const HoverResponder: ReactDOMEventResponder = {
  displayName: 'Hover',
  targetEventTypes,
  getInitialState() {
    return {
...
export function useHoverResponder(ref: RefObject, props: HoverProps): void {
  React.unstable_useResponder(HoverResponder, ref, props);
}

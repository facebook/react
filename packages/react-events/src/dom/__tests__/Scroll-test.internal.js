...
function ScrollResponderTest({_ref, children, ...props}) {
  useScrollResponder(_ref, props);
  return children;
}
...
describe('Scroll event responder', () => {
  ...
  describe('disabled', () => {
    ...
    beforeEach(() => {
      ...
      ref = React.createRef();
      const element = (
        <ScrollResponderTest _ref={ref} disabled={true} onScroll={onScroll}>
          <div ref={ref} />
        </ScrollResponderTest>
      );
  ...
  describe('onScroll', () => {
    ...
    beforeEach(() => {
      ...
      ref = React.createRef();
      const element = (
        <ScrollResponderTest _ref={ref} onScroll={onScroll}>
          <div ref={ref} />
        </ScrollResponderTest>
      );
      ReactDOM.render(element, container);
  ...
  describe('onScrollDragStart', () => {
    ...
    beforeEach(() => {
      ...
      ref = React.createRef();
      const element = (
        <ScrollResponderTest _ref={ref} onScrollDragStart={onScrollDragStart}>
          <div ref={ref} />
        </ScrollResponderTest>
      );
      ReactDOM.render(element, container);
  ...
  describe('onScrollDragEnd', () => {
    ...
    beforeEach(() => {
      ...
      ref = React.createRef();
      const element = (
        <ScrollResponderTest _ref={ref} onScrollDragEnd={onScrollDragEnd}>
          <div ref={ref} />
        </ScrollResponderTest>
      );
      ReactDOM.render(element, container);

...
describe('Event responder: Press', () => {
  ...
  describe('nested Press responders', () => {
    describe('should not bubble to other Press responders', () => {
      it('for onPress', () => {
        const ref = React.createRef();
        const fn = jest.fn();
  ...
  it('should properly only flush sync once when the event systems are mixed', () => {
    ...
    function PressTest({children, onPress}) {
      usePressResponder(ref, {
        onPress,
      });
      return children;

...
describe('create-react-class-integration', () => {
  ...
  it('warns if getDerivedStateFromProps is not static', () => {
    ...
    expect(() =>
      ...
      'Warning: Foo: getDerivedStateFromProps() is defined as an instance method ' +
  ...
  it('warns if getDerivedStateFromError is not static', () => {
    ...
    expect(() =>
      ...
      'Warning: Foo: getDerivedStateFromError() is defined as an instance method ' +
        'and will be ignored. Instead, declare it as a static method.',
      {withoutStack: true},
    );
  });
  ...
  it('warns if getSnapshotBeforeUpdate is static', () => {
    ...
    expect(() =>
      ...
      'Warning: Foo: getSnapshotBeforeUpdate() is defined as a static method ' +

...
describe('Profiler', () => {
  describe('works in profiling and non-profiling bundles', () => {
    [true, false].forEach(enableSchedulerTracing => {
      [true, false].forEach(enableProfilerTimer => {
        describe(`enableSchedulerTracing:${enableSchedulerTracing ? 'enabled' : 'disabled'
          } enableProfilerTimer:${enableProfilerTimer ? 'enabled' : 'disabled'
          }`, () => {
            beforeEach(() => {
              jest.resetModules();
  ...
  [true, false].forEach(enableSchedulerTracing => {
    describe(`onRender enableSchedulerTracing:${enableSchedulerTracing ? 'enabled' : 'disabled'
      }`, () => {
        beforeEach(() => {
          jest.resetModules();
    ...
    describe(`onCommit enableSchedulerTracing:${enableSchedulerTracing ? 'enabled' : 'disabled'
      }`, () => {
        beforeEach(() => {
          jest.resetModules();
    ...
    describe(`onPostCommit enableSchedulerTracing:${enableSchedulerTracing ? 'enabled' : 'disabled'
      }`, () => {
        beforeEach(() => {
          jest.resetModules();

...
function commitOffscreenTransitionHide(offscreenFiber: Fiber) {
...
function commitOffscreenTransitionShow(offscreenFiber: Fiber) {
...
function commitOffscreenPassiveMountEffects(
  ...
  if (enableTransitionTracing) {
    ...
    if (isHidden) {
      ...
      commitOffscreenTransitionHide(finishedWork);
    } else {
      commitOffscreenTransitionShow(finishedWork);
    }
  }
}

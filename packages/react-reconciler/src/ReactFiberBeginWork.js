...
export default function<T, P, I, TI, HI, PI, C, CC, CX, PL>(
  ...
  function updateHostRoot(current, workInProgress, renderExpirationTime) {
    ...
    if (updateQueue !== null) {
      ...
      if (
        ...
        // root.
        resetHydrationState();
        reconcileChildrenAtExpirationTime(current, workInProgress, element, workInProgress.expirationTime);
      }
      memoizeState(workInProgress, state);
      return workInProgress.child;
    }
  ...
  function mountIndeterminateComponent(
    ...
    if (
      ...
      reconcileChildrenAtExpirationTime(current, workInProgress, value, workInProgress.expirationTime);
  ...
  function updateContextProvider(
    ...
    reconcileChildrenAtExpirationTime(current, workInProgress, newChildren, workInProgress.expirationTime);
    return workInProgress.child;
  }

...
export function getFragmentInstanceHostParent(fiber: Fiber): null | Fiber {
...
export function getFragmentInstanceSiblings(
  ...
  const parentHostFiber = getFragmentInstanceHostParent(fiber);
...
export function getHostNodeFromHostFiber(fiber: Fiber): Instance {
  switch (fiber.tag) {
    case HostComponent:

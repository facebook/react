...
describe('ReactOffscreen', () => {
  beforeEach(() => {
    ...
    ReactFeatureFlags.enableHiddenAPI = true;
    ReactFeatureFlags.runAllPassiveEffectDestroysBeforeCreates = true;
  });
  ...
  fit('Portals are hidden in hidden subtrees and shown in visible ones', async () => {

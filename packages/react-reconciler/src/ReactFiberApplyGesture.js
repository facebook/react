...
const CLONE_ENTER = 1; // Inside a reappearing offscreen but before the next host component.
const CLONE_UNHIDE = 2; // Like ENTER but we're already inside the entering View Transition.

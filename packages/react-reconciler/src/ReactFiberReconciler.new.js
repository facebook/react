...
export function attemptSynchronousHydration(fiber: Fiber): void {
  switch (fiber.tag) {
    ...
    case SuspenseComponent:
      ...
      const retryExpTime = InputDiscreteHydrationLane;
      markRetryTimeIfNotHydrated(fiber, retryExpTime);
      break;
  }
}

function markRetryTimeImpl(fiber: Fiber, retryLane: Lane) {
...
function markRetryTimeIfNotHydrated(fiber: Fiber, retryTime: Lane) {
...
export function attemptUserBlockingHydration(fiber: Fiber): void {
  ...
  markRetryTimeIfNotHydrated(fiber, lane);
}

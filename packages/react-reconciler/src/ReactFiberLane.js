...
const InputContinuousHydrationLane: Lane = /*           */ 0b000000000000000000000000100000;
const InputContinuousLanes: Lanes = /*                  */ 0b000000000000000000000011100000;
const InputContinuousUpdateRangeStart = 6;
const InputContinuousUpdateRangeEnd = 8;

export const DefaultHydrationLane: Lane = /*            */ 0b000000000000000000000100000000;
const DefaultLanes: Lanes = /*                          */ 0b000000000000000011111100000000;
const DefaultUpdateRangeStart = 9;
const DefaultUpdateRangeEnd = 14;

const TransitionShortHydrationLane: Lane = /*           */ 0b000000000000000100000000000000;
const TransitionShortLanes: Lanes = /*                  */ 0b000000000011111100000000000000;
const TransitionShortUpdateRangeStart = 15;
const TransitionShortUpdateRangeEnd = 20;

const TransitionLongHydrationLane: Lane = /*            */ 0b000000000100000000000000000000;
const TransitionLongLanes: Lanes = /*                   */ 0b000001111100000000000000000000;
const TransitionLongUpdateRangeStart = 21;
const TransitionLongUpdateRangeEnd = 25;

export const SelectiveHydrationLane: Lane = /*          */ 0b000010000000000000000000000000;
const SelectiveHydrationRangeEnd = 26;

// Includes all non-Idle updates
const UpdateRangeEnd = 26;
const NonIdleLanes = /*                                 */ 0b000011111111111111111111111111;

export const IdleHydrationLane: Lane = /*               */ 0b000100000000000000000000000000;
const IdleLanes: Lanes = /*                             */ 0b011100000000000000000000000000;

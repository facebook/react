...
- Remove `hermes-parser` dependency. ([@poteto](https://github.com/poteto) in [#34719](https://github.com/facebook/react/pull/34719))
- Update for Zod v3/v4 compatibility. ([@josephsavona](https://github.com/josephsavona) in [#34717](https://github.com/facebook/react/pull/34717))
- Remove `@babel/plugin-proposal-private-methods` dependency. ([@josephsavona](https://github.com/josephsavona) in [#34715](https://github.com/facebook/react/pull/34715))

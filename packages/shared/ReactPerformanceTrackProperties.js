  ...
  for (const key in object) {
    if (hasOwnProperty.call(object, key) && key[0] !== '_') {
      ...
      try {
        ...
        // Accessing this property threw an error. This can happen with proxies
        // like tRPC clients. Skip this property.
        continue;
      }
  ...
  for (const key in next) {
    ...
    if (key in prev) {
      ...
      try {
        ...
        // Accessing properties on the values threw an error. This can happen with proxies
        // like tRPC clients. Skip this property.
        continue;
      }
    } else {

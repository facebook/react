...
// because of the cyclic dependency on ReactNoop, we directly
// point to the renderer so when we actually call
// batchedUpdates/flushPassiveEffects, they'll be available
import RendererHelpers from './ReactNoop';

...
**If your Components tab is empty, refer to "The React Tab Shows Empty Tree" section below**.
...
Go to chrome://extensions. If you see "service worker (inactive)" in the React Developer Tools extension, try disabling and re-enabling the extension. This will restart the service worker. Then go to the page you want to inspect, close the DevTools, and reload the page. Open the DevTools again and you should see the React tab.

...
if (enablePluginEventSystem) {
  ...
  const functionThatReturnsTrue = function() {
    return true;
  };

  const functionThatReturnsFalse = function() {
    return false;
  };
   ...
   */
  const getPooledWarningPropertyDefinition = function(propName, getVal) {
  ...
  const releasePooledEvent = function(event) {
    const EventConstructor = this;
    invariant(
  ...
  const addEventPoolingTo = function(EventConstructor) {

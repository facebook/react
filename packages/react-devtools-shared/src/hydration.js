...
export function dehydrate(
  ...
  switch (type) {
    ...
    case 'array':
      isPathAllowlistedCheck = isPathAllowlisted(path);
      if (level >= LEVEL_THRESHOLD && !isPathAllowlistedCheck) {
      ...
      return data.map((item, i) =>
        dehydrate(
          ...
          path.concat([i]),
          isPathAllowlisted,
          isPathAllowlistedCheck ? 1 : level + 1,
        ),
      );

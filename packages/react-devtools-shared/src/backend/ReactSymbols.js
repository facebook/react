...
export const CONTEXT_CONSUMER_NUMBER = 0xeace;
export const CONTEXT_CONSUMER_SYMBOL_STRING = 'Symbol(react.context)';

export const CONTEXT_PROVIDER_NUMBER = 0xeacd;
export const CONTEXT_PROVIDER_SYMBOL_STRING = 'Symbol(react.provider)';

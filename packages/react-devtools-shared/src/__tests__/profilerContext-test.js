...
describe('ProfilerContext', () => {
  ...
  // @reactVersion <= 18.2
  // @reactVersion >= 18.0
  it('should navigate between commits when the keyboard shortcut is pressed (legacy render)', async () => {
    const Parent = () => <Child />;
    const Child = () => null;
  ...
  // @reactVersion >= 18
  it('should navigate between commits when the keyboard shortcut is pressed (createRoot)', async () => {
    const Parent = () => <Child />;
    const Child = () => null;

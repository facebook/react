...
export const THEME_STYLES: {[style: Theme | DisplayDensity]: any} = {
  light: {
    ...
    '--color-strict-mode-icon': '#ffffff',
    '--color-strict-mode-text': '#ffffff',
    '--color-strict-mode-compliant-background': '#37b777',
    '--color-strict-mode-non-compliant-background': '#eb3941',
    '--color-strict-mode-non-compliant-background-disabled': '#cfd1d5',
    '--color-strict-mode-text-disabled': '#777d88',
    '--color-strict-mode-toggle-background': 'rgba(0, 0, 0, 0.25)',
    '--color-strict-mode-toggle-foreground': '#ffffff',
  ...
  dark: {
    ...
    '--color-strict-mode-icon': '#ffffff',
    '--color-strict-mode-text': '#ffffff',
    '--color-strict-mode-compliant-background': 'rgba(0, 0, 0, 0.25)',
    '--color-strict-mode-non-compliant-background': '#eb3941',
    '--color-strict-mode-non-compliant-background-disabled': '#4f5766',
    '--color-strict-mode-text-disabled': '#777d88',
    '--color-strict-mode-toggle-background': 'rgba(0, 0, 0, 0.25)',
    '--color-strict-mode-toggle-foreground': '#ffffff',

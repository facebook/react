  ...
  return {
    ...
    transform(code, id, options) {
      ...
      async function transformClientModule(moduleAst: any, moduleId: string) {
        ...
        let newSrc = `import { registerClientReference } from 'react-server-dom-vite/server';\n`;
      ...
      function transformServerModule(
        ...
        let newSrc =
          `import { registerServerReference as createServerReference } from 'react-server-dom-vite/server';\n` +
          moduleCode +
          '\n\n;';

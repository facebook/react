...
function checkSelectPropTypes(props) {
  controlledValuePropTypes.checkPropTypes('select', props);
...
export function getHostComponentSelectProps(element: Element, props: Object) {
  return Object.assign({}, props, {
    value: undefined,
  });
}

export function initHostComponentSelectWrapperState(
  element: Element,
  props: Object,
) {
...
export function applyHostComponentSelectMountWrapper(
  element: Element,
  props: Object,
) {
  const node = ((element: any): SelectWithWrapperState);
...
export function restoreHostComponentSelectControlledState(
  element: Element,
  props: Object,
) {
  const node = ((element: any): SelectWithWrapperState);
...
export function applyHostComponentSelectUpdateWrapper(
  element: Element,
  props: Object,
) {
  const node = ((element: any): SelectWithWrapperState);

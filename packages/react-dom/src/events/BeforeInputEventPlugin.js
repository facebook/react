...
if (enablePluginEventSystem) {
   ...
   */
  const isKeypressCommand = function(nativeEvent) {
    return (
   ...
   * @return {object}
   */
  const getCompositionEventType = function(topLevelType) {
    switch (topLevelType) {
   ...
   * @return {boolean}
   */
  const isFallbackCompositionStart = function(topLevelType, nativeEvent) {
    return (
   ...
   * @return {boolean}
   */
  const isFallbackCompositionEnd = function(topLevelType, nativeEvent) {
    switch (topLevelType) {
      case TOP_KEY_UP:
   ...
   * @return {?string}
   */
  const getDataFromCustomEvent = function(nativeEvent) {
   ...
   * @return {boolean}
   */
  const isUsingKoreanIME = function(nativeEvent) {
   ...
   */
  const extractCompositionEvent = function(
    topLevelType,
    targetInst,
    nativeEvent,
    nativeEventTarget,
   ...
   */
  const getNativeBeforeInputChars = function(
   ...
   */
  const getFallbackBeforeInputChars = function(
    topLevelType: TopLevelType,
    nativeEvent,
  ) {
   ...
   */
  const extractBeforeInputEvent = function(
    topLevelType,
    targetInst,
    nativeEvent,
    nativeEventTarget,

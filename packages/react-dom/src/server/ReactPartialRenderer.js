          ...
          case REACT_EVENT_TARGET_TYPE: {
            if (enableEventAPI) {
              if (
                ...
                // We do not render the hit slop positioning anymore. Instead
                // we rely on hydration adding them in. The previous logic
                // had a bug where rendering a hit slop at SSR meant that

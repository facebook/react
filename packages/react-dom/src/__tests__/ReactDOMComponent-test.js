    ...
    it('should warn for unknown prop', () => {
      ...
      expect(() =>
        ...
        'Warning: Invalid value for prop `foo` on <div> tag. Either remove it ' +
          ...
          'it in the DOM. For details, see https://reactjs.org/blog/2017/09/08/dom-attributes-in-react-16.html#changes-in-detail' +
          '\n    in div (at **)',
      );
    });
    ...
    it('should group multiple unknown prop warnings together', () => {
      ...
      expect(() =>
        ...
        'Warning: Invalid values for props `foo`, `baz` on <div> tag. Either remove ' +
          ...
          'them in the DOM. For details, see https://reactjs.org/blog/2017/09/08/dom-attributes-in-react-16.html#changes-in-detail' +
          '\n    in div (at **)',
      );
    });
    ...
    it('should validate use of dangerouslySetInnerHTML', () => {
      expect(function() {
        ...
        '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. ' +
          'Please visit https://reactjs.org/docs/dom-elements for more information.',
      );
    });

  ...
  function unstable_runWithPriority() {
    try {
      ...
      if (error.message === "Should not already be working") {
        console.warn("Warning! Detected an issue with setState in componentDidMount when a breakpoint is set in Firefox. The error has been handled to prevent the application to crash");
        return;
      }
      throw error;
    }
